...
response.addHeader("Expires", "Thu, 01 Jan 1970 00:00:01 GMT");
    ...
    // List listTwo =(List) request.getAttribute("listTwo");
     List alltypeList =(List) request.getAttribute("alltypeList");
...
<html>
	<head>
		...
		<script language="JavaScript" type="text/javascript">		
  var listAction = "<%=rootPath%>/slaAudit.do?action=list";
  var delAction = "<%=rootPath%>/slaAudit.do?action=delete";
...
function search()
{
	mainForm.action = "<%=rootPath%>/slaAudit.do?action=list";
    mainForm.submit();
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 服务质量 >> 服务级别管理 >> SLA操作审计</td>
															...
															<table>
																...
																<td class="body-data-title" style="text-align: left;" colspan=2> 
																	...
																	%>
																			...
																			&nbsp; <b>SLA类型：</b>
																		<select id="reportType" name="slatype" style="width:160px" >
																			<option value="-1">不限</option>
																					<%
																		if(alltypeList!=null){
																		for (int i=0;i<alltypeList.size();i++) {
                                                                              String slaType=(String)alltypeList.get(i);
																		    %>
														...
														<td>
															...
															<tr>
																...
																<tr <%=onmouseoverstyle%>>
																	...
																	<td align="center" class="body-data-list">
																		<a href="#" style="cursor: hand" onclick="window.showModalDialog('<%=rootPath%>/slaAudit.do?action=read&id=<%=vo.getId()%>',window,',dialogHeight:400px;dialogWidth:600px')">
																		查看
																		</a></td>																									
																</tr>
																<%
