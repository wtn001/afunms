...
<script language="JavaScript" type="text/JavaScript">
 function query(){
	...
	var bidnum = document.getElementsByName("checkbox").length;
 	...
 	if(oids != 0)
 	{
 	 	mainForm.action = "<%=rootPath%>/perform.do?action=hostchocereport&startdate="+startdate+"&todate="+todate+"&ids="+oids, "newwindow", "height=500, width=600, toolbar= no, menubar=no, scrollbars=yes, resizable=yes, location=yes, status=yes"   	      
 	 mainForm.submit();
 	}
 	else{
 	alert("请选择设备");
