...
<!-- 右键菜单结束-->
				        								...
				        								<table id="detail-content-body" class="detail-content-body">
				        									<tr>
				        										<td>
		                    										...
		                    										<tr >
		                      											<td width="30%" height="26" align="left" nowrap  class=txtGlobal>&nbsp;设备标签:</td>
		                      											<td width="70%"><%=host.getAlias()%> [<a href="<%=rootPath%>/perform.do?action=ready_edit&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><img src="<%=rootPath%>/resource/image/editicon.gif" border=0>修改</a>]</td>
		                    										</tr>
		                    										<tr bgcolor="#F1F1F1">
		                      											<td width="30%" height="26" align="left" nowrap class=txtGlobal>&nbsp;系统名称:</td>
		                      											<td width="70%"><%=host.getSysName()%> [<a href="<%=rootPath%>/perform.do?action=ready_editsysgroup&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><img src="<%=rootPath%>/resource/image/editicon.gif" border=0>修改</a>]</td>
		                    										</tr>                    										
		                    										<tr >
		                    										...
		                    										<tr>
		                      											<td height="29" class=txtGlobal valign=center nowrap  >&nbsp;供应商信息:</td>
		                      											<td>
										       						<% if(supper != null){
										       						%>
																					...
																					<tr>
																						<td width="100%" align="left" valign="middle">
																							...
																							so.write("flashcontent01");
										       													...
										       													<tr>
										       														<td align=center><a href="<%=rootPath%>/monitor.do?action=netcpu&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>">查看详情</a>
										       													</td>
										       													</tr>
										     												</table>
										     											</td>
  ...
  <tr align="center"> 
    ...
    <td rowspan="2"  align="center" align="center">查看</td>
