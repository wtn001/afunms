...
<frameset rows="*" cols="32,*" frameborder="no" framespacing="0">
	<frame name="tabMenuFrame" SCROLLING="no" noresize id="tabMenuFrame"
		src="tabMenuFrame.jsp"></frame>
	<frame name="tabMenuContent" id="tabMenuContent"
		src="tabMenuContent.jsp?treeflag=0&rightFramePath=<%=rightFramePath%>">
	</frame>
</frameset>
</html>
