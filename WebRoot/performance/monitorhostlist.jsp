	...
	<head>
		...
		<script type="text/javascript">
			...
			var curpage= <%=jp.getCurrentPage()%>;
  			...
  			var listAction = "<%=rootPath%>/perform.do?action=monitorhostlist";
			...
			function doCancelManage(){  
  			...
  			function doSearch(){  
				mainForm.action = "<%=rootPath%>/perform.do?action=monitorhostlist";
     			mainForm.submit();
  			}
					        									    ...
					        									    if(list!=null&& list.size()>0){
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									            ...
					        									            <tr <%=onmouseoverstyle%>>
					        													...
					        													<td align="center" class="body-data-list"><%=monitorHostDTO.getIpAddress()%></td>
