...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
    ...
    var chk = checkinput("readcommunity","string","读共同体",30,false);
     
     if(chk)
     {
     	if (confirm("确定要修改吗?")){
        	mainForm.action = "<%=rootPath%>/perform.do?action=updatesnmp";
        	mainForm.submit();
        	window.close();
        }
     }
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">资源 >> 配置 >> 修改SNMP参数</td>
