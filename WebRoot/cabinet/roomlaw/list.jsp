...
<%
	...
	String menuTable = (String) request.getAttribute("menuTable");
	 Hashtable<Integer,User> userHash =(Hashtable<Integer,User> )request.getAttribute("userHash");
...
<html>
  ...
  var delAction = "<%=rootPath%>/roomlaw.do?action=delete";
  var listAction = "<%=rootPath%>/roomlaw.do?action=list";
...
//公共变量
   ...
   <script type="text/javascript">
	 function toAdd()
  {
     mainForm.action = "<%=rootPath%>/roomlaw.do?action=ready_add";
     mainForm.submit();
  }
 
	function toDetail(){
		window.open('<%=rootPath%>/cabinet/roomlaw/show.jsp?attachfiles='+filename);
	}
	
	function edit(){
		mainForm.action = "<%=rootPath%>/roomlaw.do?action=ready_edit&id=" + node;
		mainForm.submit();
	}
	function search()
{
	mainForm.action = "<%=rootPath%>/roomlaw.do?action=list";
    mainForm.submit();
 ...
 window.open('<%=rootPath%>/roomlaw.do?action=downloadReport&type=law&exportType='+exportType+'&cabinetid='+cabinetid+'&startdate='+startdate+'&todate='+todate+'&nowtime='+(new Date()),"_blank","toolbar=no,width=1,height=1,top=2000,left=3000,directories=no,status=no,menubar=no,alwaysLowered=yes");
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 3D机房 >> 机房管理 >> 机房管理制度 </td>
														...
														<td>
															<table>
																<tr>
																	...
																	<td align="center" class="body-data-title" width="9%">
																		上传人
																	</td>
																	<td align="center" class="body-data-title" width="11%">
																		附件
																	</td>
																...
																<tr<%=onmouseoverstyle%>>
																	...
																	<td align="center" class="body-data-list"><a href="#" onclick="window.open('<%=rootPath%>/cabinet/roomlaw/show.jsp?attachfiles=<%=vo.getFilename()%>')"><%=vo.getFilename()%></a></td>
																	...
																	<td align="center" class="body-data-list">
																		<img src="<%=rootPath%>/resource/image/status.gif"
																			border="0" width=15 oncontextmenu=showMenu('2','<%=vo.getId()%>','<%=vo.getFilename() %>','1111') title="右键菜单">
			       													</td>
																</tr>
																<%
																	}
