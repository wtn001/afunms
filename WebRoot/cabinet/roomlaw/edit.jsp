...
<%
  ...
  RoomLaw roomLaw=(RoomLaw)request.getAttribute("roomLaw");
  int id=0;
  String name="";
  int cabinetid=0;
  String description="";
  ...
  if(roomLaw!=null){
	  id=roomLaw.getId();
	  name=roomLaw.getName();
	  cabinetid=roomLaw.getCabinetid();
	  description=roomLaw.getDescription();
	  filename=roomLaw.getFilename();
  }
  %>
<html>
<head>
...
{  
 ...
 Ext.get("process").on("click",function(){
      ...
      if(chk1){   
        	...
        	mainForm.action = "<%=rootPath%>/roomlaw.do?action=edit";
        	mainForm.submit();
     }
 });	
});
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">3D机房 >> 机房管理 >> 机房管理制度 >> 编辑</td>
				        									...
				        									<tr>
				        										<td>
																	...
																	<tr>
																		...
																		<TD nowrap width="40%">&nbsp;<input type="text" id="filePath" name="filePath" maxlength="150" size="50" readonly="readonly" value="<%=filename %>"><input type="button" value="添加附件" onclick="showup()">
																			<font color="red">&nbsp;*</font>
																		</TD>
