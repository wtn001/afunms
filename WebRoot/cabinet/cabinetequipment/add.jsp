 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2&&chk3)
     {
        ...
        //msg.style.display="block";
         mainForm.action = "<%=rootPath%>/cabinetequipment.do?action=add";
         mainForm.submit();
     }  
       // mainForm.submit();
 });	
				...
				<td class="td-container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">3D机房 >> 机房配置管理 >> 机柜设备添加</td>
					...
					<TBODY>
						...
						<tr >						
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="cabinetname" id="cabinetname" maxlength="50" size="20" class="formStyle" readonly>
								<input type="hidden" name="cabinetid"  id="cabinetid" maxlength="50" size="20" class="formStyle">
								<input type="hidden" name="roomid" id="roomid" maxlength="50" size="20" class="formStyle">
								<font color="red">&nbsp;*</font>&nbsp;&nbsp;<a href="#" onclick="toAllAdd()">选择</a></TD>						
							<TD nowrap align="right" height="24" width="10%">U占用&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="unumbers" id="unumbers" maxlength="50" size="20" class="formStyle">
						...
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="nodename" id="nodename" maxlength="50" size="20" class="formStyle">
								<input type="hidden" name="nodeid" id="nodeid" maxlength="50" size="20" class="formStyle">
								<font color="red">&nbsp;*</font>&nbsp;&nbsp;<a href="#" onclick="setNode()">选择</a></TD>						
							<TD nowrap align="right" height="24" width="10%">设备描述&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="nodedescr" id="nodedescr" maxlength="50" size="20" class="formStyle">
								</TD>															
						</tr>
						<tr  id='community_tr'>				
							<TD nowrap align="right" height="24" width="10%">联系人&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="contactname" id="contactname" maxlength="50" size="20" class="formStyle">
								<input type="hidden" name="operid" id="operid" maxlength="50" size="20" class="formStyle">
								&nbsp;&nbsp;<a href="#" onclick="setUser()">选择</a></TD>						
							<TD nowrap align="right" height="24" width="10%">联系人电话&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="contactphone" id="contactphone" maxlength="50" size="20" class="formStyle">
								</TD>															
						</tr>
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							<TD nowrap align="right" height="24" width="10%">联系人电子邮箱&nbsp;</TD>				
							<TD nowrap width="40%" >&nbsp;
								<input type="text" name="contactemail" id="contactemail" maxlength="50" size="20" class="formStyle">
							</TD>			
							<TD nowrap align="right" height="24" width="10%">所属业务系统&nbsp;</TD>				
							<TD nowrap width="40%" >&nbsp;
								<input type="text" name="businessName" id="businessName" maxlength="50" size="20" class="formStyle">
								<input type="hidden" name="bid" id="bid" maxlength="50" size="20" class="formStyle">
