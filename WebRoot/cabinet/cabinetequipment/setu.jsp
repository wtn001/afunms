							...
							<td class="td-container-main-add">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">选择机柜U单元</td>
							  ...
							  <td style="align:center">
							  		<table style="width:50%;align:center">
							  			<tr bgcolor=gray>
							  				<td class="report-data-body-title" width=20% style="bgcolor:gray">U单元</td>
							  				<td class="report-data-body-title" width=60% bgcolor=gray>描述</td>
							  				<td class="report-data-body-title" width=20% bgcolor=gray>U单元</td>
							  			</tr>
							  			<%
							  			...
							  			<tr>
							  				...
							  				<td bgcolor=lightgray class="report-data-body-list" height="20" >&nbsp;&nbsp;&nbsp;&nbsp;第<%=i%>U单元</td>
							  				<td bgcolor=gray class="report-data-body-list" height="20" align=center><%=i%></td>
							  			</tr>
							  			<%
							  			}else{
							  			...
							  			<tr>
							  				...
							  				<td class="report-data-body-list" height="20" bgcolor=#3CB371><input type=checkbox name=checkbox value='<%=i%>' class=noborder >第<%=i%>U单元</td>
							  				<td class="report-data-body-list" height="20" align=center bgcolor=green><%=i%></td>
							  			</tr>
							  			<%
							  				}
