...
<html>
    ...
    function backList()
   {  
     mainForm.action = "<%=rootPath%>/cabinetbsreport.do?action=list";
     mainForm.submit();
    }
       function doQuery()
   {  
     mainForm.action = "<%=rootPath%>/cabinetbsreport.do?action=querylist";
     mainForm.submit();
    }
		</script>
	</head>
							...
							<tr>
								<td class="td-container-main-content">
									<table id="container-main-content"
										...
										<tr>
											<td>
												<table id="content-header" class="content-header" cellpadding="0" cellspacing="0">
													<tr>
											
														<td class="content-title" align="left">
															3D机房 &gt;&gt; 机房报表 &gt;&gt; 机柜使用报表
														</td>
														<td align="right">
													...
													<tr>										
														<td class="content-title" class="content-title">&nbsp;
