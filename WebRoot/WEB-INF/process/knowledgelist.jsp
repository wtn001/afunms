...
<html>
	<head>
		...
		<script language="JavaScript" type="text/javascript">
  var listAction = "<%=rootPath%>/controller/knowledgelist.action";
  ...
  function toFind()
  {
     mainForm.action = "<%=rootPath%>/controller/knowledgelist.action";
     mainForm.submit();
  }
															...
															<table>
																<tr>
																	...
																	<script language="javascript">
																		 ...
																		 new PCAS("categorycon","entitycon","subentitycon","<%=request.getAttribute("categorycon")%>","<%=request.getAttribute("entitycon")%>","<%=request.getAttribute("subentitycon")%>");
																	</script>
																	<td class="body-data-title" style="text-align: left;">
																		请输入查询关键字&nbsp;&nbsp;
