...
var listAction = "<%=rootPath%>/controller/processUserFinished.action";
</script>
<%} %>
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 流程管理 >> 流程任务 >> 已办流程 </td>
														...
														<td>
															<table>
																<tr>
         																 ...
         																 <td align="center" class="body-data-title">流程状态</td>
		...
		<%
	 	...
	 	if (jp.getList() != null)
	 	{
	 		...
	 		hpi=(HistoricProcessInstance)jp.getList().get(i);
				...
				<td align="center" class="body-data-list"><% if(hpi.getEndTime()==null) { 
				} else {out.print(DateFormat.TIME_FORMAT.format(hpi.getEndTime()));} %></td>
