										...
										<tr>
											<td>
												<table id="win-content-body" class="win-content-body">
														...
														<td>
															<table bgcolor="#ECECEC">
																<tr align="left" valign="center">
																	...
																	<td height="28" align="left" width="10%">
																		&nbsp;
																		<a href="javascript:hardware_report(4)"><img
																				name="selDay1" alt='导出word' style="CURSOR: hand"
																...
																<tr>
																	<td colspan="4">
																		<table>
																			<tr>
																				<td height="28" class="detail-data-body-title"
																				...
																				<td height="28" align="center">
																					<table>
																						...
																						<tr bgcolor="#FFFFFF">
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getAlias()%></td>
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getCategory()%></td>
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getType()%></td>
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getIpAddress()%></td>
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getEntityNumber()%></td>
																						</tr>
																						<%
																							}
																							}
																					...
																					<table>
																						...
																						<tr bgcolor="#FFFFFF">
																							...
																							<td height="28" align="center"
																								...
																								<table>
																									<tr>
																										<td align="left" class="detail-data-body-list"
																											width=80%>
																											磁盘名
																										</td>
																										<td align="left" class="detail-data-body-list"
																									...
																									<tr>
																										<td height="28" align="left"
																											class="detail-data-body-list" width=80%><%=numer.getName()%></td>
																										<td height="28" align="left"
																											class="detail-data-body-list" width=20%><%=numer.getCurrent()%></td>
																									</tr>
																									<%
																										}
																									%>
																							...
																							<td align="center" class="detail-data-body-list">
																								<table>
																									...
																									<tr>
																										<td align="left" class="detail-data-body-list"
																											width=80%><%=numer.getName()%></td>
																										<td align="left" class="detail-data-body-list"
																											width=20%><%=numer.getCurrent()%></td>
																									</tr>
																									<%
																										}
																					...
																					<table>
																						...
																						<tr bgcolor="#FFFFFF">
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getAlias()%></td>
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getDbtype()%></td>
																							<td height="28" align="center"
																								class="detail-data-body-list"><%=monitorNodeDTO.getIpAddress()%></td>
													...
													<tr>
														<td class="win-data-title" style="height: 39px;">
															<div align=center>
