...
function setClass(){
	document.getElementById('aixDetailTitle-4').className='detail-data-title';
	document.getElementById('aixDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('aixDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
	...
	<form id="mainForm" method="post" name="mainForm">
		...
		<table id="body-container" class="body-container">
            ...
            <tr bgcolor="#ECECEC" height=28>
              <%
		if(detailVect != null && layer.equals("two"))
		{
