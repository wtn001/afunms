...
//Node node = PollingEngine.getInstance().getNodeByCategory("dbs", Integer.parseInt(id));
//String alias = node.getAlias();
//String ip_ = node.getIpAddress();
%>
...
<table width=100% border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="content-title" align="left" height="29">
						&nbsp;
					</td>
        ...
        <tr> 
          <td><div align="center">
              <table cellpadding="0" cellspacing="0" width=98%>
              							<tr> 
                							<td width="100%" align="center"> 
												...
												<script type="text/javascript">
													var so = new SWFObject("<%=rootPath%>/flex/Oracle_Ping_month.swf?ipadress=<%=ip%>&id=<%=id%>&category=<%=category%>", "Oracle_Ping_month", "800", "250", "8", "#ffffff");
				...
				<tr width=100% height="5" bgcolor="#ffffff"><td></td></tr>
				</table>
    </form>
</body>
</html> 