...
function setClass(){
	document.getElementById('firewallDetailTitle-5').className='detail-data-title';
	document.getElementById('firewallDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('firewallDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
                                       ...
                                       <td width="20%" height="26" align=left valign=middle nowrap class=txtGlobal>&nbsp;IP地址:
											<%
												...
												<select name="ipalias<%=host.getIpAddress() %>">
													...
													<% 
													   for(int j=0 ;j<iplist1.size() ; j++){
																IpAlias voTemp = (IpAlias)iplist1.get(j); 
															%>
