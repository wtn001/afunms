...
<%
	...
	List routeList = new ArrayList();
		...
		if(iproutervector == null || iproutervector.size() == 0){
			iproutervector = (Vector)request.getAttribute("vector");	
		}
		//----ping值和响应时间begin
...
function setClass(){
	document.getElementById('firewallDetailTitle-4').className='detail-data-title';
	document.getElementById('firewallDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('firewallDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
...
<body id="body" class="body" onload="initmenu();">
  ...
  <tr align="center" bgcolor="#ECECEC" height="28"> 
    ...
    <td  width="18%" align="center">扫描时间</td>
             ...
             %>
            <tr bgcolor="#FFFFF" <%=onmouseoverstyle%>>
