...
function setClass(){
	document.getElementById('hpunixDetailTitle-5').className='detail-data-title';
	document.getElementById('hpunixDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('hpunixDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
