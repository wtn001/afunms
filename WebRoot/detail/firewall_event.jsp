...
function setClass(){
	document.getElementById('firewallDetailTitle-7').className='detail-data-title';
	document.getElementById('firewallDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('firewallDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
