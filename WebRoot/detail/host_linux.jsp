...
function setClass(){
	document.getElementById('linuxDetailTitle-10').className='detail-data-title';
	document.getElementById('linuxDetailTitle-10').onmouseover="this.className='detail-data-title'";
	document.getElementById('linuxDetailTitle-10').onmouseout="this.className='detail-data-title'";
}
