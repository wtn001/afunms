...
function order(para){
  ...
  {  
  	mainForm.id.value = <%=tmp%>;
     mainForm.action = "<%=rootPath%>/monitor.do?action=hostevent&flag=<%=_flag%>";
     mainForm.submit();
  }
   function opennewwin(){
    
     window.open("<%=rootPath%>/monitor.do?action=hosteventlist&nodetype=host&id=<%=tmp%>");
 }
</script>
...
function setClass(){
	document.getElementById('windowsDetailTitle-7').className='detail-data-title';
	document.getElementById('windowsDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('windowsDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
...
<IFRAME frameBorder=0 id=CalFrame marginHeight=0 marginWidth=0 noResize scrolling=no src="<%=rootPath%>/include/calendar.htm" style="DISPLAY: none; HEIGHT: 194px; POSITION: absolute; WIDTH: 148px; Z-INDEX: 100"></IFRAME>
  ...
  <tr bgcolor="#ECECEC" height="28">
    	...
    	<td align="center" class="detail-data-body-title"><strong>最近告警时间</strong></td>
