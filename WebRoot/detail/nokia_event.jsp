...
function setClass(){
	document.getElementById('nokiaDetailTitle-6').className='detail-data-title';
	document.getElementById('nokiaDetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('nokiaDetailTitle-6').onmouseout="this.className='detail-data-title'";
}
