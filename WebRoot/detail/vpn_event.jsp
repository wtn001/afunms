...
function setClass(){
	document.getElementById('vpnDetailTitle-7').className='detail-data-title';
	document.getElementById('vpnDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('vpnDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
