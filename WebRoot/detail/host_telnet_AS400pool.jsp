...
function setClass(){
	document.getElementById('AS400DetailTitle-2').className='detail-data-title';
	document.getElementById('AS400DetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('AS400DetailTitle-2').onmouseout="this.className='detail-data-title'";
}
													...
													<table class="detail-data-body">
											      		<tr>
											      			<td>
											      				<table>
											      					<tr>
											      						<td class="detail-data-body-title">系统池</td>
											      						<td class="detail-data-body-title">池名称</td>
																	 	<td class="detail-data-body-title">池大小</td>
																		<td class="detail-data-body-title">保留池大小</td>
																		<td class="detail-data-body-title">最大活动数</td>
											      					</tr>
											      					<%
											      						Hashtable hashtable= (Hashtable)ShareData.getSharedata().get(host.getIpAddress());
											      						if(hashtable!=null){
											      							List systemPoolList = (List)hashtable.get("SystemPool");
												      						if(systemPoolList!=null){
												      							for(int i = 0 ; i < systemPoolList.size() ; i++){
												      							Hashtable systemPool = (Hashtable)systemPoolList.get(i);
												      							%>
												      							<tr <%=onmouseoverstyle%>>
													      							<td class="detail-data-body-list"><%=systemPool.get("id")%></td>
													      							<td class="detail-data-body-list"><%=systemPool.get("name")%></td>
																			 		<td class="detail-data-body-list"><%=systemPool.get("size")%></td>
																					<td class="detail-data-body-list"><%=systemPool.get("reservedSize")%></td>
																					<td class="detail-data-body-list"><%=systemPool.get("maximumActiveThreads")%></td>
																				</tr>
												      							<%
												      							}
											      							}
