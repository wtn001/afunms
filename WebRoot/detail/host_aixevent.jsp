...
function setClass(){
	document.getElementById('aixDetailTitle-9').className='detail-data-title';
	document.getElementById('aixDetailTitle-9').onmouseover="this.className='detail-data-title'";
	document.getElementById('aixDetailTitle-9').onmouseout="this.className='detail-data-title'";
}
...
<div id="itemMenu" style="display: none";>
  ...
  <tr bgcolor="#ECECEC" height=28>
		...
		<td class="detail-data-body-title" align="center"><strong>登记时间</strong></td>
