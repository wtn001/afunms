...
<%@page import="com.afunms.application.model.DominoCache"%>
<%@page import="com.afunms.application.dao.DominoCacheDao"%>
...
<%
	...
	if ("0".equals(runmodel)) {
		...
		cache=(DominoCache)ipAllData.get("Cache");
	...
	pingvalue=pingdata.getThevalue();
      DominoCacheDao cacheDao=new DominoCacheDao();
	cache=(DominoCache)cacheDao.findByIp(ipaddress);
	//磁盘
										    ...
										    <table class="detail-data-body">
                                                ...
                                                <%if(cache!=null){ %>
										         <tr bgcolor="#FFFFFF">
			                                        ...
			                                        <td height=25 class="detail-data-body-list" align="center">存储器指令个数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheCommandCount() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">2</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器指令转换率(%)</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheCommandDisRate() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">3</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器指令成功率</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheCommandHitRate()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">4</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器指令大小</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheCommandSize()%></td> 
                                                </tr>
										         
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">5</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器数据库成功率</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheDbHitRate() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">6</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器Session个数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheSessionCount()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">7</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器Session转换率</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheSessionDisRate()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">8</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器Session成功率</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheSessionHitRate() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">9</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器Session大小</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheSessionSize() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">10</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器用户个数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheUserCount()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">11</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器用户转换率</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheUserDisRate() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">12</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器用户成功率</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheUserHitRate() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">13</td>
			                                        <td height=25 class="detail-data-body-list" align="center">存储器用户大小</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=cache.getCacheUserSize() %></td> 
                                                </tr>
										        <%} %>
                                            </table>
                                         </td>
