...
<%
    ...
    if(true){
		...
		if(ipAllData != null){
			...
			//得到IPMAC信息
			vector = (Vector)ipAllData.get("VPNInfor");
											...
											<table id="detail-data" class="detail-data">
											  ...
											  <tr>
                    							...
                    							<tr align="left" bgcolor="#ECECEC"> 
                      								<td align="left" height=25><blockquote><font color="#808080" size="1"><strong>VPN连接信息</strong></font></blockquote></td> &nbsp;&nbsp;&nbsp;
                      								</td>
                    							</tr>                  							
                    							<tr bgcolor="DEEBF7"> 
                      								<td colspan=2>
  												...
  												<tr align="center" bgcolor="#ECECEC"> 
  													<td  width="4%" align="center"><div>&nbsp;ID</div></td>
    													<td  width="12%" align="center"><div> VPN网络编号 </div></td>
    													<td  width="10%" align="center"><div> 打开网络连通次数 </div></td>
    													<td  width="12%" align="center"><div> 创建网络连通次数 </div></td>
    													<td  width="10%" align="center"><div> 被拒绝连通次数</div></td>
    													<td  width="10%" align="center"><div> 被终止连通次数 </div></td>
    													<td  width="10%" align="center"><div> VPN输入字节数 </div></td>
    													<td  width="8%" align="center"><div> VPN输出字节数 </div></td>
    													<td  width="13%" align="center"><div>VPN输入没有授权的包</div></td>
  												</tr>
             											<% Iterator it = vector.iterator();
             											int i = 0;
             												while (it.hasNext()) {
             													ArrayVPNInfor arrayVPNInfor = (ArrayVPNInfor)it.next(); ;
             													Date cc = arrayVPNInfor.getCollecttime().getTime();
             											%>
            											<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
            												<td height=28 class="detail-data-body-list" >&nbsp;&nbsp;
	            												<%=++i%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnId()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnTunnelsOpen()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnTunnelsEst()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnTunnelsRejected()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnTunnelsTerminated()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnBytesIn()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnBytesOut()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNInfor.getVpnUnauthPacketsIn()%></td>
            											</tr>
            											<%
