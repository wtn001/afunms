...
<%
	...
	if ("0".equals(runmodel)) {
		...
		if (ipAllData != null) {
			...
			if (cpuV != null && cpuV.size() > 0) {
				...
				cpudata = (CPUcollectdata) cpuV.get(0);
				cpuvalue = new Double(cpudata.getThevalue());
			}
			...
			//获取当前流量
			Vector allutilhdxVector = (Vector) ipAllData
					.get("allutilhdx");
	...
	if (allavgandmaxHash != null && allavgandmaxHash.size() > 0) {
	   ...
	   if (allavgandmaxHash.containsKey("minin")) {
			minin = (Integer) allavgandmaxHash.get("minin");
		}
		...
		if (allavgandmaxHash.containsKey("minout")) {
			minout = (Integer) allavgandmaxHash.get("minout");
		}
	}
	...
	double[] r_data1 = { new Double(responsevalue.replaceAll("%", "")),
			new Double(maxresponse.replaceAll("%", "")),
			new Double(avgresponse.replaceAll("%", "")) };
	...
	double[] data0 = { Double.valueOf(curin), Double.valueOf(avgin),
			Double.valueOf(maxin),Double.valueOf(minin) };//数据
	double[] data1 = { Double.valueOf(curout), Double.valueOf(avgout),
			Double.valueOf(maxout),Double.valueOf(minout)};
	String[] dataName = { "当前流速", "平均流速", "最大流速", "最小流速"};//每种数据对应的名称
	String[] labels1 = { "入口流速", "出口流速" };//数据的种类
	int[] color = { 0x7FFF00, 0xFFFF00, 0xFF0000,0xFF0000};//每种数据对应的颜色
	cbp.createCompareThreeBarPic(data0, data1, dataName, labels1,
			color, tm1, barwidth);
	StringBuffer dataStr1 = new StringBuffer();
	dataStr1.append("连通;").append(Math.round(realValue)).append(
			";false;7CFC00\\n");
	dataStr1.append("未连通;").append(100 - Math.round(realValue)).append(
			";false;FF0000\\n");
...
$(document).ready(function(){
	...
	$('#liusu').bind('click',function(){
			$('#liusu-detail').slideToggle('slow');
		});
	$('#neicun').bind('click',function(){
			$('#neicun-detail').slideToggle('slow');
		});
	$('#shancun').bind('click',function(){
			$('#shancun-detail').slideToggle('slow');
		});
					...
					<td class="td-container-main">
						<table id="container-main" class="container-main">
							<tr>
								<td class="td-container-main-detail">
									<table id="container-main-detail" class="container-main-detail">
										<tr>
											<td> 
											<jsp:include page="/topology/includejsp/sysinfo_net_top.jsp">
							...
							"")))%></td>
																																													<td
																																														class="detail-data-body-list"
																																														align=center><%=Math.round(Float.parseFloat(pingconavg
							.replaceAll("%", "")))%></td>
																																												</tr>
																																											</table>
																																										</td>
																																								...
																																								<table cellpadding="0"
																																									...
																																									<tr>
																																										<td align=center colspan=3><img
																																												src="<%=rootPath%>/resource/image/jfreechart/reportimg/<%=picip%>response.png"></td>
																																									</tr>
																																									<tr height=24>
																																							...
																																							<td valign=top>
																																								...
																																								<table cellpadding="0"
																																									...
																																									<tr>
																																										...
																																										<td align=center><img src="<%=rootPath%>/resource/image/jfreechart/reportimg/<%=picip%>cpumax.png"></td>
																																										<td align=center><img src="<%=rootPath%>/resource/image/jfreechart/reportimg/<%=picip%>cpuavg.png"></td>
																																									</tr>
																																									<tr height=24>
																																										<td valign=top align=center>
																																											<b>当前</b>
																																											...
																																											<table cellpadding="0"
																																												...
																																												<tr>
																																													...
																																													<td
																																														class="detail-data-body-list"
																																														align=center>
																																														<%if(cpudata == null || cpudata.getSubentity().equals("unknown")) {
																																					...
																																					<table cellpadding="1"
																																						...
																																						<tr height=20>
																																							<td align=right colspan=3>
																																								>>
																																								<a
																																									href="javascript:void(window.open('<%=rootPath%>/monitor.do?action=cpudetail&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>','CPU实时数据','top=180,left=300,height=550 ,width=720, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no'))">实时</a>
																																							</td>
																																						</tr>
																																					</table>
																																				</td>
																						...
																						<table cellpadding="0" cellspacing="0" width=48%>
																							<tr>
																								<td width="100%" align=center>
																									...
																									<script type="text/javascript">
																									var so = new SWFObject("<%=rootPath%>/flex/Area_flux.swf?ipadress=<%=host.getIpAddress()%>", "Area_flux", "346", "353", "8", "#ffffff");
																														...
																														<td style="background-color: #FFFFFF;">
																															<table id="add-content"
																																...
																																<tr>
																																	<td>
																																		<%
																																			double[] data = { Double.valueOf(curin),
																																						Double.valueOf(curout), Double.valueOf(maxin),
																																						Double.valueOf(maxout) , Double.valueOf(minin),
																																						Double.valueOf(minout), Double.valueOf(avgin),
																																						Double.valueOf(avgout) };

																																				int tempInt = 0;
																																				StringBuffer xmlStr = new StringBuffer();

																																				xmlStr.append("<chart><series>");
																																				xmlStr.append("<value xid='0'>").append(labels1[0]).append(
																																						"</value><value xid='1'>").append(labels1[1]).append(
																																						"</value>");
																																				...
																																				for (int i = 0; i < 4; i++) {
																																					...
																																					xmlStr.append("<graph gid='").append(i).append(
																																							"'><value xid='0'>" + data[tempInt] + "</value>");
																																					xmlStr.append("<value xid='1'>" + data[++tempInt]
																																							+ "</value>");
																																					xmlStr.append("</graph>");
																																					++tempInt;
																																				}
																																				...
																																				<td>
																																					<table cellpadding="1"
																																						...
																																						<tr>
																																							<td valign=top>
																																								<!-- 	<img
																																					src="<%=rootPath%>/resource/image/jfreechart/reportimg/<%=picip%>flow.png">
																																			-->
																																								<div id="amcharts_1302082910703">
																																								...
																																								<table cellpadding="0"
																																									...
																																									<tr>
																																										...
																																										<td
																																											...
																																											height="26" align=center>
																																											<%
																																											if (interfaceVector.size() == 0 || (interfaceVector.size() == 1 && ((Interfacecollectdata)interfaceVector.get(0)).getSubentity().equals("unknown"))) {
																																												%>
																																												&nbsp;--</td>
																																											<%} else{%>
																																									...
																																									<tr>
																																										<td colspan=4 align=right
																																											...
																																											>>
																																											<a
																																												href="javascript:void(window.open('<%=rootPath%>/monitor.do?action=interfacedetail&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>','内存实时数据','top=200,left=300,height=450 ,width=720, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no'))">实
																																												时</a>
																												...
																												if (memoryVector != null && memoryVector.size() > 0) {
																													...
																													for (int i = 0; i < memoryVector.size(); i++) {
																														...
																														sb.append("<value xid='").append(i).append("' color='")
																																.append(colorStr[i]).append(
																																		"'>" + memorycollectdata.getThevalue())
																																.append("</value>");
																										%>
																										<tr>
																											<td class="detail-data-body-list"
																												style="align: center">
																												<%if(memorycollectdata.getSubentity() == null || memorycollectdata.getSubentity().equals("unknown")) {
																													%>
																													&nbsp;未采集到数据</td>
																													<td class="detail-data-body-list"
																													style="align: center">
																						...
																						<table cellpadding="0" cellspacing="0" width=48%>
																							<tr>
																								<td width="100%" align=center>
																									...
																									<script type="text/javascript">
																									var so = new SWFObject("<%=rootPath%>/flex/Net_flash_Memory.swf?ipadress=<%=host.getIpAddress()%>", "Net_flash_Memory", "346", "250", "8", "#ffffff");
																									...
																									<table cellpadding="0" cellspacing="1"
																										...
																										<%
																											StringBuffer flash = new StringBuffer();
																												String netdata1 = "";
																												String[] colorStr1 = new String[] { "#33FF33", "#333399",
																														"#33CCFF", "#003366", "#33FF33", "#FF0033", "#9900FF",
																														"#FFFF00", "#0000FF", "#A52A2A", "#23f266" };

																												if (powervector != null && powervector.size() > 0) {
																													flash.append("<chart><series>");
																													for (int i = 0; i < powervector.size(); i++) {
																														Interfacecollectdata interfacedata = (Interfacecollectdata) powervector
																																.get(i);
																														if (!"Flash".equals(interfacedata.getCategory().trim()))
																															continue;
																														flash.append("<value xid='").append(i).append("'>")
																																.append("闪存模块" + interfacedata.getSubentity())
																																.append("</value>");

																													}

																													flash.append("</series><graphs><graph gid='0'>");
																													for (int i = 0; i < powervector.size(); i++) {
																														Interfacecollectdata interfacedata = (Interfacecollectdata) powervector
																																.get(i);
																														if (!"Flash".equals(interfacedata.getCategory().trim()))
																															continue;
																														flash.append("<value xid='").append(i).append(
																																"' color='").append(colorStr1[i]).append(
																																"'>" + interfacedata.getThevalue()).append(
																																"</value>");
																										%>
																										<tr>
																											<td class="detail-data-body-list"
																												style="align: center">
																												<%if(interfacedata.getSubentity().equals("unknown")) {
																													%>
																													&nbsp;未采集到数据</td>
																													<td class="detail-data-body-list"
																													style="align: center">
																													&nbsp;--</td>
																												<%} else {%>
																												&nbsp;闪存模块<%=interfacedata.getSubentity()%></td>
																											<td class="detail-data-body-list"
																												style="align: center">
																												&nbsp;<%=interfacedata.getThevalue()%></td>
																												<%}%>
																												
																										</tr>
																										<%
																											}
																													flash.append("</graph></graphs></chart>");
																													netdata1 = flash.toString();
																												} else {
																													netdata1 = "0";
																												}
																										%>
																																											...
																																											<table cellpadding="0"
																																												...
																																												<tr>
																																													<td width="100%"
																																														...
																																														<script
																																															type="text/javascript">
						                                                                                                                                       <% if(!netdata1.equals("0")){%>
						                                                                                                                                        var so = new SWFObject("<%=rootPath%>/amchart/amcolumn.swf", "ampie","400", "288", "8", "#FFFFFF");
						                                                                                                                                             so.addVariable("path", "<%=rootPath%>/amchart/");
						                                                                                                                                             so.addVariable("settings_file", escape("<%=rootPath%>/amcharts_settings/netmemory_settings.xml"));
						                                                                                                                                             so.addVariable("chart_data","<%=netdata1%>");
						                                                                                                                                             so.write("netfalsh");
						                                                                                                                                          <%}else{%>
						                                                                                                                                           var _div=document.getElementById("netfalsh");
																			                                                                                          var img=document.createElement("img");
																			                                                                                              img.setAttribute("src","<%=rootPath%>/resource/image/nodata.gif");
																			                                                                                              _div.appendChild(img);
																			                                                                                       <%}%>
