...
function setClass(){
	document.getElementById('AS400DetailTitle-8').className='detail-data-title';
	document.getElementById('AS400DetailTitle-8').onmouseover="this.className='detail-data-title'";
	document.getElementById('AS400DetailTitle-8').onmouseout="this.className='detail-data-title'";
}
													...
													<table class="detail-data-body">
											      		<tr>
											      			<td>
											      				<table>
											      					<tr>
											      						<td class="detail-data-body-title">ID</td>
											      						<td class="detail-data-body-title">Option</td>
																	 	<td class="detail-data-body-title">Feature</td>
																		<td class="detail-data-body-title">Description</td>
											      					</tr>
											      					<%
											      						...
											      						if(hashtable!=null){
											      							...
											      							System.out.println(hashtable.get("service"));
											      							if(hashtable.get("service") != null)serviceVector = (Vector)hashtable.get("service");
												      						if(serviceVector!=null){
												      							for(int i = 0 ; i < serviceVector.size() ; i++){
												      							Hashtable serviceHashtable = (Hashtable)serviceVector.get(i);
												      							%>
												      							<tr <%=onmouseoverstyle%>>
													      							<td class="detail-data-body-list"><%=serviceHashtable.get("ID")%></td>
													      							<td class="detail-data-body-list"><%=serviceHashtable.get("Option")%></td>
																			 		<td class="detail-data-body-list"><%=serviceHashtable.get("Feature")%></td>
																					<td class="detail-data-body-list"><%=serviceHashtable.get("Description")%></td>
																				</tr>
												      							<%
											      								}
											      							}
