...
function gotoFullScreen() {
  ...
  {  
     ...
     mainForm.action = "<%=rootPath%>/monitor.do?action=hostsyslog&flag=<%=_flag%>";
     mainForm.submit();
  }
...
function setClass(){
	document.getElementById('windowsDetailTitle-6').className='detail-data-title';
	document.getElementById('windowsDetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('windowsDetailTitle-6').onmouseout="this.className='detail-data-title'";
}
