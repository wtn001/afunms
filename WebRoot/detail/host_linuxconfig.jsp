...
<div id="itemMenu" style="display: none";>
  ...
  <tr align="center" bgcolor="#ECECEC"> 
    <td  width="20%" align="left" class="detail-data-body-title">处理器ID</td>
    <td  width="30%" align="left" class="detail-data-body-title">类型/主频</td>
    <td  width="30%" align="left" class="detail-data-body-title">cpu MHz</td>
    <td  width="20%" align="left" class="detail-data-body-title">二级缓存大小</td>
  </tr>
            ...
            %>            
                      ...
                      <table width="80%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      		<tr>
					<td height="28" align="left" bgcolor="#ECECEC" colspan=2 >&nbsp;&nbsp;<b>内存配置信息</b></td>
				</tr>
  <tr align="center" bgcolor="#ECECEC"> 
    <td  width="70%" align="center" class="detail-data-body-title">类型</td>
    <td  width="30%" align="center" class="detail-data-body-title">大小</td>
  </tr>
            ...
            <td class="detail-data-body-list" align="center">&nbsp;<%=TotalSwapMemorySize%></td>
                      ...
                      <table width="80%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      		<tr>
					<td height="28" align="left" bgcolor="#ECECEC" colspan=2>&nbsp;&nbsp;<b>用户信息</b></td>
				</tr>
  <tr align="center" bgcolor="#ECECEC"> 
    <td  width="20%" align="center" class="detail-data-body-title">名称</td>
    <td  width="20%" align="center" class="detail-data-body-title">用户组</td>
  </tr>
