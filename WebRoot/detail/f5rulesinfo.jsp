...
int cpuper = Double.valueOf(cpuvalue).intValue();
  ...
  //else
     ...
     userlogin = (Vector)request.getAttribute("vector");
...
function setClass(){
	document.getElementById('f5DetailTitle-2').className='detail-data-title';
	document.getElementById('f5DetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('f5DetailTitle-2').onmouseout="this.className='detail-data-title'";
}
...
<tr> 
			...
			<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
                        <tbody> 
          					...
          					<td align=center width=10%>策略名称</td>
          					<td align=center width=60%>策略内容</td>
            					<td align=center width=10%>策略配置来源</td>
                    ...
                    <%
                    	if(userlogin != null && userlogin.size()>0){
                    		...
                    		for(int k=0;k<userlogin.size();k++){
                    			Hashtable login = (Hashtable)userlogin.get(k);
								//String[] str = (String[])vlans.get(k);
							String cfg = (String)login.get("loginip");
                    %>                                           										                        								
                    		<tr height=25 align="center" valign="center"  bgcolor="#FFFFFF" <%=onmouseoverstyle%>> 
                    			<td><%=(String)login.get("index")%></td>
                      			<td align="center">&nbsp;&nbsp;<%=(String)login.get("username")%></td>
								
                      			<%if(cfg.equals("0")){%>
								<td align="center" bgcolor=green>USERCFG</td>
								<%}else if(cfg.equals("1")){%>
                      			<td align="center" bgcolor=yellow>BASECFG</td>
                   <%
								}
                   		}
                   	}
