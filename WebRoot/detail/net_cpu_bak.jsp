...
SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		...
		if(ipAllData != null){
			...
			//System.out.println("size ###################### "+memoryVector.size());
			//得到系统启动时间
		...
		<table width="100%" border=0 cellpadding=0 cellspacing=0>
					...
					<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				...
                  				<tr>
            							...
            							<table width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=netcpu&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><font color="#FFFFFF">性能信息</font></a></div></td>
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
           ...
           <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <table width="1" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td width="450" height="23">&nbsp;<b><font color="#FFFFFF">cpu利用率 
			...
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                    ...
                    %>                                           										                        								
                    		<tr height=25 align="left" valign="center" bgcolor="#F1F1F1"> 
                      			<td width=250 valign="center">&nbsp;&nbsp;内存当前利用率-[内存:<%=(String)interfacedata.getEntity()%>]</td>
                      			<td width=100 align=right valign="center">&nbsp;&nbsp;<%=(String)interfacedata.getThevalue()%>%</td>
                      			<td width=250 valign="center" align="left" >
                      				<table border=1 height=15 width=150 bgcolor=#ffffff>
                      				<tr>
                      					<td width="<%=(String)interfacedata.getThevalue()%>%" bgcolor="#00ff00"></td>
                      					<td width="<%=100-(Integer.parseInt((String)interfacedata.getThevalue()))%><%=interfacedata.getUnit()%>" bgcolor=#ffffff></td>
                      				</tr>
                      				</table>
                      			</td>                    		
                   ...
                   %>
                    		<tr height=25 align="left" valign="center"> 
                      			<td width=250 valign="center">&nbsp;&nbsp;内存当前利用率-[内存:<%=(String)interfacedata.getEntity()%>]</td>
                      			<td width=100 align=right valign="center">&nbsp;&nbsp;<%=(String)interfacedata.getThevalue()%><%=interfacedata.getUnit()%></td>
                      			<td width=250 valign="center" align="left">
                      				<table border=1 height=15 width=150>
                      				<tr>
                      					<td width="<%=(String)interfacedata.getThevalue()%>%" bgcolor="#00ff00"></td>
            ...
            <table width="1" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td width="450" height="23">&nbsp;<b><font color="#FFFFFF">综合流速 
                        &gt;&gt;<a style="cursor:hand" onclick="toOpen()"><font color="#FFFFFF">查看日报表</font></a>
                        &gt;&gt;<a style="cursor:hand" onclick="toOpen()"><font color="#FFFFFF">查看月报表</font></a></font></b>
                        </td>
                      <td width="300" height="23" align=right><font color="#FFFFFF"><!--平均:<%=cpuavg%>  &nbsp;&nbsp;最大:<%=str2%>-->&nbsp;</font>
                      </td>                        
                    </tr>
                    <tr> 
                      <td colspan=2><i> 
                        <table width="742" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC" align=center>
                            	<img src='<%=rootPath%>/<%=imgurl.get("allutilhdx").toString()%>?temp=<%=Math.random()%>'>
                            </td>
