											      			...
											      			<td>
											      				<table>
											      					<tr>
											      						...
											      						<td class="detail-data-body-title">Type</td>
											      					...
											      					<%
											      						...
											      						if(hashtable!=null){
											      							...
											      							System.out.println(hashtable.get("network"));
											      							if(hashtable.get("network") != null)networkVector = (Vector)hashtable.get("network");
												      						if(networkVector!=null){
												      							for(int i = 0 ; i < networkVector.size() ; i++){
													      							Hashtable networkHashtable = (Hashtable)networkVector.get(i);
													      							String url = "";
													      							if(networkHashtable.get("Status").equals("Operational")){
												      							...
												      							%>
												      							<tr <%=onmouseoverstyle%>>
													      							<td class="detail-data-body-list"><%=networkHashtable.get("Resource")%></td>
													      							<td class="detail-data-body-list"><%=networkHashtable.get("Type")%></td>
																			 		<td class="detail-data-body-list"><%=networkHashtable.get("Status")%></td>
																					<td class="detail-data-body-list"><%=networkHashtable.get("Text")%></td>
