...
SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		...
		if(ipAllData != null){
			...
			if(ipAllData.get("memory") != null)
				memoryVector = (Vector)ipAllData.get("memory");
			fanVector = (Vector)ipAllData.get("fan");
	...
	<tr>
		...
		<table width="100%" border=0 cellpadding=0 cellspacing=0>
					...
					<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				...
                  				<tr>
										...
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian.gif">
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=netenv&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><font color="#FFFFFF">环境信息</font></a></div></td>	
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
           ...
           <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                   <%String str1 = "",str2="",cpuavg="";
                  if(hash.get("cpu")!=null){
                          str1 = (String)hash.get("cpu");
                  }
                  if(max.get("cpu")!=null){
                          str2 = (String)max.get("cpu");
                  }
                  if(max.get("cpuavg")!=null){
                          cpuavg = (String)max.get("cpuavg");
                  }                  
                  //System.out.println(imgurl.get("cpu").toString());
                  %>
              <tr> 
                <td valign="top">
                <table width="1" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td width="450" height="23" background="images/yemian_16.gif">&nbsp;<b><font color="#FFFFFF">cpu利用率 
                        &gt;&gt;<a  style="cursor:hand" onclick="openwin('day','cpu','utilization','utilization')"><font color="#FFFFFF">查看日报表</font></a>
                        &gt;&gt;<a  style="cursor:hand" onclick="openwin('month','cpu','utilization','utilization')"><font color="#FFFFFF">查看月报表</font></a></font></b>
                        </td>
                      <td width="300" height="23" align=right><font color="#FFFFFF"><!--当前利用率:<%=str1%>  &nbsp;&nbsp;-->平均:<%=cpuavg%>  &nbsp;&nbsp;最大:<%=str2%>&nbsp;</font>
                      </td>                        
                    </tr>
                    <tr> 
                      <td colspan=2><i> 
                        <table width="742" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC" align=center><img src="<%=rootPath%>/<%=imgurl.get("cpu").toString()%>"></td>
                          </tr>
                        </table>
                        </i></td>
                    </tr>
                    ...
                    <tr> 
                      ...
                      <br>
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                        <tbody>
                    		<tr algin="left" valign="center">                      														
                    ...
                    %>                                           										                        								
                    		<tr height=25 align="left" valign="center" bgcolor="#F1F1F1"> 
                      			<td width=200 valign="center">&nbsp;&nbsp;CPU当前利用率-[CPU:<%=(String)acpu.get(0)%>]</td>
                      			<td width=100 align=right valign="center">&nbsp;&nbsp;<%=(String)acpu.get(1)%>%</td>
                      			<td width=300 valign="center" align="left" >
                      				<table border=1 height=15 width=150 bgcolor=#ffffff>
                      				<tr>
                      					<td width="<%=(String)acpu.get(1)%>%" bgcolor="#00ff00"></td>
			...
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                        <tbody>
                    		<tr algin="left" valign="center">                      														
                      			<td height="28" colspan=3 align="left" bordercolor="#D1DDF5" bgcolor="#D1DDF5" class="txtGlobalBold">&nbsp;内存模块性能监视</td>
                    		</tr>                          
                    <%
                    	//if(memoryVector != null && memoryVector.size()>0){
                    		for(int k=0;k<memoryVector.size();k++){
                    			Memorycollectdata interfacedata = (Memorycollectdata)memoryVector.get(k);
                    			if(interfacedata == null)continue;
                    			if(k%2 == 0){	
                    %>                                           										                        								
                    		<tr height=25 align="left" valign="center" bgcolor="#F1F1F1"> 
                      			<td width=200 valign="center">&nbsp;&nbsp;内存当前利用率-[内存:<%=(String)interfacedata.getEntity()%>]</td>
                      			<td width=100 align=right valign="center">&nbsp;&nbsp;<%=(String)interfacedata.getThevalue()%>%</td>
                      			<td width=300 valign="center" align="left" >
                      				<table border=1 height=15 width=150 bgcolor=#ffffff>
                      				<tr>
                      					<td width="<%=(String)interfacedata.getThevalue()%>%" bgcolor="#00ff00"></td>
                      					<td width="<%=100-(Integer.parseInt((String)interfacedata.getThevalue()))%>%" bgcolor=#ffffff></td>
                      				</tr>
                      				</table>
                      			</td>                    		
			...
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                    ...
                    %>                                           										                        								
                    		<tr height=25 align="left" valign="center" bgcolor="#F1F1F1"> 
                      			<td width=200 valign="center">&nbsp;&nbsp;温度当前值-[温度:<%=(String)interfacedata.getEntity()%>]</td>
                      			<td width=100 align=right valign="center">&nbsp;&nbsp;<%=(String)interfacedata.getThevalue()%> 摄氏度</td>
                      			<td width=300 valign="center" align="left" >
                      			</td>                    		
			...
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                        <tbody>
                    		<tr algin="left" valign="center">                      														
                      			<td height="28" colspan=2 align="left" bordercolor="#D1DDF5" bgcolor="#D1DDF5" class="txtGlobalBold">&nbsp;电源模块状态监视</td>
                    		</tr>                          
                    <%
                    		for(int k=0;k<powerVector.size();k++){
                    			Interfacecollectdata interfacedata = (Interfacecollectdata)powerVector.get(k);
                    			String valuestr="正常";
                    			if(interfacedata.getThevalue().equals("0"))valuestr="<font color=red>异常</font>";
                    			if(k%2 == 0){	
                    %>                                           										                        								
                    		<tr height=25 align="left" valign="center" bgcolor="#F1F1F1"> 
                      			<td width=70% valign="left">&nbsp;&nbsp;电源当前状态-[电源:<%=(String)interfacedata.getSubentity()%>]</td>
                      			<td width=30% align=left valign="center">&nbsp;&nbsp;<%=valuestr%></td>
                      			</td>                    		
			...
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                        <tbody>
                    		<tr algin="left" valign="center">                      														
                      			<td height="28" colspan=2 align="left" bordercolor="#D1DDF5" bgcolor="#D1DDF5" class="txtGlobalBold">&nbsp;风扇模块状态监视</td>
                    		</tr>                          
                    <%
                    		for(int k=0;k<fanVector.size();k++){
                    			Interfacecollectdata interfacedata = (Interfacecollectdata)fanVector.get(k);
                    			String valuestr="正常";
                    			if(interfacedata.getThevalue().equals("0"))valuestr="<font color=red>异常</font>";
                    			if(k%2 == 0){	
                    %>                                           										                        								
                    		<tr height=25 align="left" valign="center" bgcolor="#F1F1F1"> 
                      			<td width=70% valign="left">&nbsp;&nbsp;风扇当前状态-[风扇:<%=(String)interfacedata.getSubentity()%>]</td>
                      			<td width=30% align=left valign="center">&nbsp;&nbsp;<%=valuestr%></td>
                      			</td>                    		
