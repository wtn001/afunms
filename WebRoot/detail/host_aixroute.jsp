...
<%@page import="com.afunms.detail.service.routerInfo.RouterInfoService"%>
	...
	List routelist = null;
   	...
   	if("0".equals(runmodel)){
		...
		try {
			...
			//得到路由列表
		    RouterInfoService routerInfoService = new RouterInfoService(nodedto.getId()+"",nodedto.getType(),nodedto.getSubtype()); 
		    routelist = routerInfoService.getAllRouterInfo();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
...
<html>
	<head>
		...
		<script>
			...
			function setClass(){
				document.getElementById('aixDetailTitle-8').className='detail-data-title';
				document.getElementById('aixDetailTitle-8').onmouseover="this.className='detail-data-title'";
				document.getElementById('aixDetailTitle-8').onmouseout="this.className='detail-data-title'";
			}
