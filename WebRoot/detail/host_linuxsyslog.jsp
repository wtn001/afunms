...
function setClass(){
	document.getElementById('linuxDetailTitle-6').className='detail-data-title';
	document.getElementById('linuxDetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('linuxDetailTitle-6').onmouseout="this.className='detail-data-title'";
}
...
<%
	int index = 0;
  	java.text.SimpleDateFormat sdf2 = new java.text.SimpleDateFormat("MM-dd HH:mm");
