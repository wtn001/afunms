...
<table border="0" id="table1" cellpadding="0" cellspacing="0" width=100%>
                  				...
                  				<tr>
										...
										<!--<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=hostservice&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><font color="#397dbd">服务信息</font></a></div></td>-->
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=hostevent&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><font color="#397dbd">告警信息</font></a></div></td>															
                								<td align=right>&nbsp;&nbsp;</td>
              								</tr>
            							</table>
  ...
  <tr align="center" bgcolor="#F1F1F1"> 
    ...
    <td  width="15%" align="left">二级缓存速度</td>
            ...
            <td >&nbsp;</td>
            <td ><%=cpuconfig.getProcessorId()%></td>
            <td ><%=cpuconfig.getName()%></td>
            <td ><%=cpuconfig.getL2CacheSize()%></td>
            <td ></td>
            </tr>
            <%}
            }
  ...
  <tr align="center" bgcolor="#F1F1F1"> 
    ...
    <td  width="30%" align="center">大小</td>
            ...
            <tr bgcolor="DEEBF7" <%=onmouseoverstyle%>>
            <td >物理内存</td>
            <td>&nbsp;<%=TotalVisibleMemorySize%></td>
            </tr>
            <tr  bgcolor="DEEBF7" <%=onmouseoverstyle%>>
            <td>Swap内存</td>
            <td>&nbsp;<%=TotalSwapMemorySize%></td>
            </tr>           
                        </table>
                      <br>                             							
  ...
  <tr align="center" bgcolor="#F1F1F1"> 
    ...
    <td  width="20%" align="left">用户组</td>
             ...
             %>
            <tr bgcolor="DEEBF7" <%=onmouseoverstyle%>>
            <td >&nbsp;<%=(String)user.getThevalue()%></td>
            <td > &nbsp;<%=(String)user.getSubentity()%></td>
            </tr>
            <%}
            }
            %>            
