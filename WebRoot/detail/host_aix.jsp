...
function setClass(){
	document.getElementById('aixDetailTitle-10').className='detail-data-title';
	document.getElementById('aixDetailTitle-10').onmouseover="this.className='detail-data-title'";
	document.getElementById('aixDetailTitle-10').onmouseout="this.className='detail-data-title'";
}
