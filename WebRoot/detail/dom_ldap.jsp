...
<%
	...
	Domino domino = (Domino) PollingEngine.getInstance().getDominoByID(
	...
	if ("0".equals(runmodel)) {
		//采集与访问是集成模式
		Hashtable ipAllData = (Hashtable) ShareData.getDominodata()
				.get(ipaddress);
	...
	try {
		ConnectUtilizationhash = hostmanager.getCategory(ipaddress,
				"DomPing", "ConnectUtilization", starttime1, totime1);
	...
	try {
		...
		if (ConnectUtilizationhash != null
				&& ConnectUtilizationhash.get("avgpingcon") != null) {
	...
	//服务器物理内存平均最大值
	Hashtable sermemMaxAvg = (Hashtable) request
			.getAttribute("serMemMaxAvg");
	...
	//平台物理内存平均最大值
	Hashtable platmemMaxAvg = (Hashtable) request
			.getAttribute("platMemMaxAvg");
								...
								<td class="td-container-main-detail">
									<table id="container-main-detail" class="container-main-detail">
										<tr>
											<td>
												<jsp:include
													page="/topology/includejsp/middleware_domino.jsp">
													...
													<tr>
														<td>
															<table class="detail-data">
																...
																%>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																		1
																	</td>
																	<td height=25 class="detail-data-body-list"
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundQue()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundActive()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundActiveSSL()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundBytesReseived()%></td>
																</tr>
																...
																<tr bgcolor="#FFFFFF">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundBytesSent()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundPeak()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundPeakSSL()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundTotal()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapInboundTotalSSL()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapBadHandShake()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapThreadsBusy()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapThreadsIdle()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapThreadsInPool()%></td>
																</tr>
																<tr bgcolor="#FFFFFF">
																	<td height=25 class="detail-data-body-list"
																		align="center">
																	...
																	<td height=25 class="detail-data-body-list"
																		align="center"><%=ldap.getLdapTHreadsPeak()%></td>
																</tr>
																<%
																	}
																%>
