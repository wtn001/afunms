										...
										<td>
										    <table class="detail-data-body">
										         <tr bgcolor="#FFFFFF"> 
				                                    ...
				                                    <td height="28"  align="center" class="detail-data-body-title">指标值</td> 
                                                </tr>
                                                <%if(dominoServer!=null){ %>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">1</td>
			                                        <td height=25 class="detail-data-body-list" align="center">服务器名称</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getName()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">2</td>
			                                        <td height=25 class="detail-data-body-list" align="center">服务器标题</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getTitle()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">3</td>
			                                        <td height=25 class="detail-data-body-list" align="center">位数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getArchitecture()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">4</td>
			                                        <td height=25 class="detail-data-body-list" align="center">监视启动时间</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getStarttime()%></td> 
                                                </tr>
										         
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">5</td>
			                                        <td height=25 class="detail-data-body-list" align="center">CPU类型</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getCputype() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">6</td>
			                                        <td height=25 class="detail-data-body-list" align="center">CPU个数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getCpucount() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">7</td>
			                                        <td height=25 class="detail-data-body-list" align="center">端口号</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getPortnumber()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">8</td>
			                                        <td height=25 class="detail-data-body-list" align="center">IMAP状态</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getPortnumber() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">9</td>
			                                        <td height=25 class="detail-data-body-list" align="center">LDAP状态</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getLdapstatus() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">10</td>
			                                        <td height=25 class="detail-data-body-list" align="center">POP3状态</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getPop3status()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">11</td>
			                                        <td height=25 class="detail-data-body-list" align="center">SMTP状态</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getSmtpstatus() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">12</td>
			                                        <td height=25 class="detail-data-body-list" align="center">可用索引</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getAvailabilityIndex() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">13</td>
			                                        <td height=25 class="detail-data-body-list" align="center">掉线的会话数目</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getSessionsDropped()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">14</td>
			                                        <td height=25 class="detail-data-body-list" align="center">任务数量</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getTasks()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">15</td>
			                                        <td height=25 class="detail-data-body-list" align="center">一分钟的交易数量</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getTransPerMinute() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">16</td>
			                                        <td height=25 class="detail-data-body-list" align="center">服务启动后在线用户数峰值</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getUsersPeak()%></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">17</td>
			                                        <td height=25 class="detail-data-body-list" align="center">每小时对Domino的请求数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=dominoServer.getRequestsPer1Hour()%></td> 
                                                </tr>
