...
function setClass(){
	document.getElementById('gatewayDetailTitle-5').className='detail-data-title';
	document.getElementById('gatewayDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('gatewayDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
