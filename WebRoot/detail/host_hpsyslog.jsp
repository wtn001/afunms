...
function setClass(){
	document.getElementById('hpunixDetailTitle-4').className='detail-data-title';
	document.getElementById('hpunixDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('hpunixDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
