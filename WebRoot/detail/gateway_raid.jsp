...
<%
	...
	if ("0".equals(runmodel)) {
		...
		if (ipAllData != null) {
			...
			raidVector = (Vector) ipAllData.get("raid");
			//得到系统启动时间
		...
		if (memoryList != null && memoryList.size() > 0) {
			for (int i = 0; i < memoryList.size(); i++) {
				...
				raidVector.add(memorycollectdata);
			}
		}
...
function setClass(){
	document.getElementById('gatewayDetailTitle-3').className='detail-data-title';
	document.getElementById('gatewayDetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('gatewayDetailTitle-3').onmouseout="this.className='detail-data-title'";
}
																...
																<tr bgcolor="#ECECEC">
																	<td>
																		...
																		<tr style="background-color: #ECECEC;" height=28>	
											            					...
											            					<td align=center width=60%>报错信息</td>
											            				</tr>  
																			<%
																				if (raidVector != null && raidVector.size() > 0) {
																					for (int i = 0; i < raidVector.size(); i++) {
																						Interfacecollectdata interfacedata = (Interfacecollectdata) raidVector.get(i);
																						String statue = "";
																						if(interfacedata.getThevalue().equals("1")){
																						    statue = "driveHealthy";
																						} else if(interfacedata.getThevalue().equals("2")){
																						    statue = "driveFailure";
																						} else if(interfacedata.getThevalue().equals("3")){
																						    statue = "driveRebuild";
																						}
																			%>
																			<tr height=25 align="center" valign="center"  bgcolor="#FFFFFF" <%=onmouseoverstyle%>> 
												                    			<td align="center">&nbsp;&nbsp;<%=(String)interfacedata.getSubentity()%></td>
												                      			<td align="center">&nbsp;&nbsp;<%=statue%></td>
												                      			<td align="center">&nbsp;&nbsp;<%=(String)interfacedata.getBak()%></td>
												                      		</tr>
																			<%
																					}
																				}
