...
function setClass(){
	document.getElementById('sunDetailTitle-10').className='detail-data-title';
	document.getElementById('sunDetailTitle-10').onmouseover="this.className='detail-data-title'";
	document.getElementById('sunDetailTitle-10').onmouseout="this.className='detail-data-title'";
}
