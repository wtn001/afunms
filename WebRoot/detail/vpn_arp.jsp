...
function setClass(){
	document.getElementById('vpnDetailTitle-2').className='detail-data-title';
	document.getElementById('vpnDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('vpnDetailTitle-2').onmouseout="this.className='detail-data-title'";
...
//Ext.MessageBox.wait('数据加载中，请稍后.. ');
//mainForm.action = "<%=rootPath%>/vpntelnetconf.do?action=bkpCfg&ipaddress=<%=host.getIpAddress()%>&page=vnparp&id="+<%=tmp %>;
//mainForm.submit();
