...
function setClass(){
	document.getElementById('vmwareDetailTitle-0').className='detail-data-title';
	document.getElementById('vmwareDetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('vmwareDetailTitle-0').onmouseout="this.className='detail-data-title'";
}
...
<!-- 右键菜单结束-->
	<form id="mainForm" method="post" name="mainForm">
   	...
   	<tr>
										<td align=right> 
											<jsp:include page="/topology/includejsp/systeminfo_vmware.jsp">
