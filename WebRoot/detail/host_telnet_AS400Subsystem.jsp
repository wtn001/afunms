...
<%@page import="com.ibm.as400.access.Subsystem"%>
...
<%
  	...
  	String flagTemp = (String)request.getAttribute("flag");
...
function searchJobs(path){
	mainForm.action = '<%=rootPath%>/monitor.do?action=AS400JobsInSubsystemDetail&id=<%=tmp%>&flag=<%=flagTemp%>' + '&jobSubsystem=' + path;
	mainForm.submit();
}
