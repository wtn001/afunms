...
function setClass(){
	document.getElementById('AS400DetailTitle-9').className='detail-data-title';
	document.getElementById('AS400DetailTitle-9').onmouseover="this.className='detail-data-title'";
	document.getElementById('AS400DetailTitle-9').onmouseout="this.className='detail-data-title'";
}
 ...
 <tr   bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
    ...
    %>
      <td style="border-left:1px solid #EEEEEE;border-bottom:1px solid #EEEEEE;" bgcolor=red align=center><%=level%>&nbsp;</td>
       ...
       <td class="detail-data-body-list"><%=rtime2%></td>
