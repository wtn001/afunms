...
function changeOrder(para){
  	location.href="<%=rootPath%>/topology/network/vpnview.jsp?id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>&orderflag="+para;
}  
...
function setClass(){
	document.getElementById('vpnDetailTitle-1').className='detail-data-title';
	document.getElementById('vpnDetailTitle-1').onmouseover="this.className='detail-data-title'";
																																					...
																																					<table cellpadding="1"
																																						...
																																						<tr height=20>
																																							<td align=right colspan=3>
																																								>>
																																								<a
																																									href="javascript:void(window.open('<%=rootPath%>/monitor.do?action=cpudetail&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>','CPU实时数据','top=180,left=300,height=450 ,width=720, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no'))">实时</a>
																																							</td>
																																						</tr>
																																					</table>
																																				</td>
																																	...
																																	<td>
																																		<%
																																			double[] data = { Double.valueOf(curin),
																																						...
																																						Double.valueOf(maxout), Double.valueOf(avgin),
