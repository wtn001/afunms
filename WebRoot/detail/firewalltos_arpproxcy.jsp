...
<% 
	...
	double avgpingcon = (Double)request.getAttribute("pingconavg");
  	...
  	//else
     	...
     	arpproxcys = (Vector)request.getAttribute("vector");
					...
					<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				...
                  				<tr>
										...
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian.gif">
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=firewallarpproxcy&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>&trustflag=0"><font color="#FFFFFF">ARPProxy</font></a></div></td>
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
           ...
           <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <table width="100%" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td width="50%" height="23">&nbsp;<b><font color="#FFFFFF">>> ARP proxy信息</b></td> 
                    </tr>
                    <tr> 
                      <td align=center>
			<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
                        <tbody> 
          					...
          					<td align=center>MAX IP</td>
            					<td align=center>MIN IP</td>
            					<td align=center>ARP硬件地址</td>
            					<td align=center>proxy状态</td>
            				</tr>                          
                    <%
                    	if(arpproxcys != null && arpproxcys.size()>0){
                    		for(int k=0;k<arpproxcys.size();k++){
                    			Hashtable arp = (Hashtable)arpproxcys.get(k);
                    %>                                           										                        								
                    		<tr height=25 align="left" valign="center" class="othertr"  <%=onmouseoverstyle%>> 
                    			<td><%=(String)arp.get("index")%></td>
                      			<td width=10% valign="center">&nbsp;&nbsp;<%=(String)arp.get("maxip")%></td>
                      			<td width=30% valign="center">&nbsp;&nbsp;<%=(String)arp.get("minip")%></td>
                      			<td width=30% valign="center">&nbsp;&nbsp;<%=(String)arp.get("hwaddress")%></td>
                      			<td width=30% valign="center">&nbsp;&nbsp;<%=(String)arp.get("proxystatus")%></td>
                   <%
                   		}
                   	}
                   %>                     		                   										                 										                      								
