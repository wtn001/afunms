...
function setClass(){
	document.getElementById('scounixDetailTitle-5').className='detail-data-title';
	document.getElementById('scounixDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('scounixDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
