...
<%
	...
	if ("0".equals(runmodel)) {
		...
		mail=(DominoMail)ipAllData.get("Mail");
	...
	pingvalue=pingdata.getThevalue();
	DominoEmailDao emailDao=new DominoEmailDao();
	mail=(DominoMail)emailDao.findByIp(ipaddress);
	//磁盘
										    ...
										    <table class="detail-data">
                                                ...
                                                <%if(mail!=null){ %>
										         <tr bgcolor="#FFFFFF">
			                                        ...
			                                        <td height=25 class="detail-data-body-list" align="center">无法邮递的邮件数目</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailDead() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">2</td>
			                                        <td height=25 class="detail-data-body-list" align="center">等待传送给其他服务器的邮件数目</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailWaiting() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">3</td>
			                                        <td height=25 class="detail-data-body-list" align="center">等待传送给其他服务器的邮件数目</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailWaitingRecipients() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">4</td>
			                                        <td height=25 class="detail-data-body-list" align="center">当前邮递速率（Bytes/s）</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailDeliverRate() %></td> 
                                                </tr>
										         
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">5</td>
			                                        <td height=25 class="detail-data-body-list" align="center">当前传送速率（Bytes/s）</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailTransferRate() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">6</td>
			                                        <td height=25 class="detail-data-body-list" align="center">最大邮递线程数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailDeliverThreadsMax() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">7</td>
			                                        <td height=25 class="detail-data-body-list" align="center">邮递线程总数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailDeliverThreadsTotal() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">8</td>
			                                        <td height=25 class="detail-data-body-list" align="center">最大传送线程数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailTransferThreadsMax() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">9</td>
			                                        <td height=25 class="detail-data-body-list" align="center">传送线程总数</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailTransferThreadsTotal() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">10</td>
			                                        <td height=25 class="detail-data-body-list" align="center">邮件平均大小</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailAvgSize() %></td> 
                                                </tr>
										         <tr bgcolor="#FFFFFF">
                                                    <td height=25 class="detail-data-body-list" align="center">11</td>
			                                        <td height=25 class="detail-data-body-list" align="center">邮件平均分发时间</td>
				                                    <td height=25 class="detail-data-body-list" align="center"><%=mail.getMailAvgTime() %></td> 
                                                </tr>
										        <%} %>
                                            </table>
                                         </td>
