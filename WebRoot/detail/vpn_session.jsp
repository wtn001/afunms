...
<%
    ...
    if(true){
		...
		if(ipAllData != null){
			...
			//得到IPMAC信息
			vector = (Vector)ipAllData.get("Session");
											...
											<table id="detail-data" class="detail-data">
											  ...
											  <tr>
                    							...
                    							<tr align="left" bgcolor="#ECECEC"> 
                      								<td align="left" height=25><blockquote><font color="#808080" size="1"><strong>Session信息</strong></font></blockquote></td> &nbsp;&nbsp;&nbsp;
                      								</td>
                    							</tr>                  							
                    							<tr bgcolor="DEEBF7"> 
                      								<td colspan=2>
  												...
  												<tr align="center" bgcolor="#ECECEC"> 
  													<td  width="5%" align="center"><div>&nbsp;ID</div></td>
    													<td  width="8%" align="center"><div> 会话总数 </div></td>
    													<td  width="10%" align="center"><div> 登录成功次数 </div></td>
    													<td  width="12%" align="center"><div> 注销成功次数 </div></td>
    													<td  width="10%" align="center"><div> 登录失败次数 </div></td>
    													<td  width="12%" align="center"><div> 输入字节总数 </div></td>
    													<td  width="12%" align="center"><div> 输出字节总数 </div></td>
    													<td  width="10%" align="center"><div> 最大会话总数</div></td>
    													<td  width="10%" align="center"><div> 登录出错 </div></td>
    													<td  width="10%" align="center"><div> 登录封锁 </div></td>
  												</tr>
             											<% Iterator it = vector.iterator();
             											int i = 0;
             												while (it.hasNext()) {
             													ArrayVPNSession arrayVPNSession = (ArrayVPNSession)it.next(); ;
             											%>
            											<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
            												<td height=28 class="detail-data-body-list" >&nbsp;&nbsp;
	            												<%=++i%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getNumSessions()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getSuccessLogin()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getSuccessLogout()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getFailureLogin()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getTotalBytesIn()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getTotalBytesOut()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getMaxActiveSessions()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getErrorLogin()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=arrayVPNSession.getLockOutLogin()%></td>
            											</tr>
            											<%
