...
<table border="0" id="table1" cellpadding="0" cellspacing="0" width=100%>
			...
			<tr>
					...
					<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				...
                  				<tr>
										...
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
											...
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=firewallroute&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><font color="#FFFFFF">路由表信息</font></a></div></td>	
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                    <tr align="left" bgcolor="397dbd"> 
                      <td height="23" background="images/yemian_16.gif"><b><font color="#FFFFFF">&nbsp;路由表信息&nbsp;&nbsp;</font></b></td>
                    </tr>
                    <tr bgcolor="DEEBF7"> 
                      <td>
  ...
  <tr align="center"> 
    ...
    <td  width="10%" align="left">目标地址</td>
    <td  width="10%" align="left">下一跳</td>
    <td  width="10%" align="left">路由类型</td>
    <td  width="10%" align="left">路由协议</td>
    <td  width="10%" align="left">子网掩码</td>
  </tr>
            ...
            <td ><%=iproutertype[Integer.parseInt(iprouter.getType().longValue()+"")]%></td>
            <td ><%=iprouterproto[Integer.parseInt(iprouter.getProto().longValue()+"")]%></td>
