...
function setClass(){
	document.getElementById('hpunixDetailTitle-1').className='detail-data-title';
	document.getElementById('hpunixDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('hpunixDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
