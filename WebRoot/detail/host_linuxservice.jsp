...
<%
	...
	String[] processItemch={"进程名称","进程个数","进程类型","cpu时间","CPU占用率","内存占用量","内存占用率","当前状态"};
...
function setClass(){
	document.getElementById('linuxDetailTitle-5').className='detail-data-title';
	document.getElementById('linuxDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('linuxDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
																	...
																	<td align=center>
																		<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
																					<tr bgcolor="#ECECEC" height=28 align="center">
																						...
																						<td width=60% class="detail-data-body-title">
																							名称
																						</td>
																						<td width=35% class="detail-data-body-title">
																							状态
																						</td>
																					</tr>
																					<%
														           					...
														           					%>
																					<tr height=28 <%if(!phash.get("status").toString().endsWith("未启用")){%>bgcolor="#ECECEC"<%} %> >
																								<td class="detail-data-body-list">
																										<%=m+1%>
																								</td>
														            				<td class="detail-data-body-list">
																										<%=(String)phash.get("name")%>
																								</td>
																						<td class="detail-data-body-list">
																							<%=(String)phash.get("status")%>
																						</td>
