...
<%
  	...
  	System.out.println(jobSubsystem);
...
function setClass(){
	document.getElementById('AS400DetailTitle-5').className='detail-data-title';
	document.getElementById('AS400DetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('AS400DetailTitle-5').onmouseout="this.className='detail-data-title'";
}
...
function search(){
	document.getElementById("id").value="<%=tmp%>";
	mainForm.action = '<%=rootPath%>/monitor.do?action=AS400JobsInSubsystemDetail';
	mainForm.submit();
}
...
function initSearchCondition(){
	...
	document.getElementById("jobSortField").value = "<%=jobSortField%>";
	document.getElementById("jobSortType").value = "<%=jobSortType%>";
	document.getElementById("jobSubsystem").value = "<%=jobSubsystem%>";
}
...
<div id="itemMenu" style="display: none";>
	...
	<form id="mainForm" method="post" name="mainForm">
		...
		<input type=hidden name="jobSubsystem" id="jobSubsystem">
																...
																<table height="30">
																	<tr>
										      							...
										      							<td class="detail-data-body-title">
											      							<input type="button" onclick="javascript:history.back(1)" value="返  回">
										      							</td>
										      						</tr>
										      					</table>
										      				</td>
											      			...
											      			<td>
											      				<table>
											      					<tr height="25">
											      						...
											      						<td class="detail-data-body-title"><a href="#" onclick="sort('name' , '<%=jobSortType%>')">名称</a><img id="name-img" style="display: none;"></td>
											      						<td class="detail-data-body-title"><a href="#" onclick="sort('user' , '<%=jobSortType%>')">子系统</a><img id="user-img" style="display: none;"></td>
											      					...
											      					<%
											      						if(jobList!=null){
											      							...
											      							<tr <%=onmouseoverstyle%>>
												      							...
												      							<td class="detail-data-body-list"><%=jobForAS400.getSubsystem()%></td>
