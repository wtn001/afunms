		...
		<table width="100%" border=0 cellpadding=0 cellspacing=0>
                  				...
                  				<tr>
            							...
            							<table width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<div align="center"><a href="<%=rootPath%>/detail/dispatcher.jsp?id=net<%=tmp%>"><font color="#397dbd">连通率</font></a></div></td>
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
											<div align="center"><a href="<%=rootPath%>/detail/hostutilhdx.jsp?id=<%=tmp%>"><font color="#397dbd">流速信息</font></a></div></td>
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian.gif">
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=hostcpu&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><font color="#FFFFFF">性能信息</font></a></div></td>	
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
                    ...
                    <tr align="left" bgcolor="397dbd"> 
                      ...
                      <!-- 
                        ...
                        &gt;&gt;<a style="cursor:hand"  onclick="openwin('month','cpu','utilization','utilization')"><font color="#FFFFFF">查看月报表</font></a></font></b>
                         -->
                         &gt;&gt;<a style="cursor:hand"  onclick="cpuReportByMinute();"><font color="#FFFFFF">查看日报表</font></a>
                        &gt;&gt;<a style="cursor:hand"  onclick="cpuReportByMinute();"><font color="#FFFFFF">查看月报表</font></a></font></b>
                        </td>
                      <td width="300" height="23" background="images/yemian_16.gif" align=right>
                      <font color="#FFFFFF"> 
                        &nbsp;&nbsp;CPU平均:<%=avgcpu%>&nbsp;&nbsp;CPU最大值:<%=cpumax%></font>
                        </td>                        
                    </tr>
                    <tr> 
                      <td colspan=2><i> 
                        <table width="742" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC" align=center><img src='<%=rootPath%>/<%=imgurl.get("cpu").toString()%>?temp=<%=Math.random()%>'></td>
                          </tr>
                        </table>
                        </i></td>
                    </tr>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td valign="top">
                	<table width="100%" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td  height="23" background="images/yemian_16.gif">&nbsp;<b><font color="#FFFFFF">内存利用率 
                      <!--  
                        &gt;&gt;<a  style="cursor:hand" onclick="openwin('day','memory','','')"><font color="#FFFFFF">查看日报表</font></a> &gt;&gt;
                        <a  style="cursor:hand" onclick="openwin('month','memory','','')"><font color="#FFFFFF">查看月报表</font></a></font></b>&nbsp;&nbsp;</td>
                        -->
                         &gt;&gt;<a style="cursor:hand"  onclick="memoryReportByMinute();"><font color="#FFFFFF">查看日报表</font></a>
                        &gt;&gt;<a style="cursor:hand"  onclick="memoryReportByMinute();"><font color="#FFFFFF">查看月报表</font></a></font></b>
                    </tr>
                    <tr> 
                      <td><i> 
                        <table  border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC"><img src="<%=rootPath%>/<%=imgurl.get("memory").toString()%>"></td>
                          </tr>
                        </table>
                        </i></td>
                    </tr>
            <tr> 
              <td width="100%" align="center"> 
                <table width="90%" border="1" cellspacing="1" cellpadding="3" class="lrtbdarkborder">
                  <tr> 
                    <td width="21%">内存名</td>
                    <%
      ...
      <%}%>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <table width="100%" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td width="90%" height="23">&nbsp;<b><font color="#FFFFFF">磁盘利用率 
                        </td>
                    </tr>
                    <tr> 
                      <td><i> 
                        <table width="90%" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC"><img src="<%=rootPath%>/<%=imgurl.get("disk").toString()%>"></td>
                          </tr>
                        </table>
                        </i></td>
                    </tr>
            <tr> 
              <td width="100%" align="center"> 
                <table width="96%" border="1" cellspacing="1" cellpadding="3" class="lrtbdarkborder">
                  <tr> 
                    <td width="20%">磁盘名</td>
            	  <% 
                    ...
                    <td width="10%"><%=item%></td>
                    <%}%>
                   <td width="20%"><%=diskItemch[4]%>&nbsp;<!--<input type="button" onclick="show_disk()" class=button value="查看历史">--></td>
                  </tr>
                 <%
