...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=rootPath%>/js/detail/host/as400detail.js"></script> 
		<script type="text/javascript" src="<%=rootPath%>/dwr/interface/AS400RemoteService.js"></script>
