...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=rootPath%>/js/detail/host/aixdetail.js"></script> 
		<script type="text/javascript" src="<%=rootPath%>/dwr/interface/AixRemoteService.js"></script>
