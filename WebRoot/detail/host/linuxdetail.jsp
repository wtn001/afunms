...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=rootPath%>/js/detail/host/linuxdetail.js"></script> 
		<script type="text/javascript" src="<%=rootPath%>/dwr/interface/LinuxRemoteService.js"></script>
