...
<%
	List<DBBackup> dbBackupList = (List<DBBackup>) request
			.getAttribute("list");
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 系统管理 >> 数据库维护 >> 数据库备份列表 </td>
														...
														<td>
															<table>
																...
																<tr <%=onmouseoverstyle%>>
																	...
																	<td align="center" class="body-data-list"><%=dbBackup.getFilename()%></td>
																	<td align="center" class="body-data-list"><%=dbBackup.getTime()%></td>
																	<td align="center" class="body-data-list">
																		<input type="button" value="导入文件" onclick=startload("<%=dbBackup.getFilename()%>")>
																	</td>
																</tr>
																<%
																	}
