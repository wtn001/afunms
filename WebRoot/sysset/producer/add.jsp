...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/producer.do?action=add";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
...
<body id="body" class="body" onload="initmenu();">
	...
	<form id="mainForm" method="post" name="mainForm">
		...
		<table id="body-container" class="body-container">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 >>资源管理 >> 设备厂商添加</td>
			...
			<TD nowrap width="40%">&nbsp;<input type="text" name="producer" size="30" class="formStyle"><font color="red">&nbsp;*</font></TD>															
			<TD nowrap align="right" height="24">企业OID&nbsp;</TD>				
			<TD nowrap width="40%">&nbsp;<input type="text" name="oid" size="20" class="formStyle"></TD>						
			</tr>
			<tr>
		    <TD nowrap align="right" height="24">企业网站&nbsp;</TD>				
            <TD nowrap>&nbsp;<input type="text" name="website" size="30" class="formStyle"></TD>
