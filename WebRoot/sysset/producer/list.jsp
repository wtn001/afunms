											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 系统管理 >> 资源管理 >> 设备厂商 </td>
														...
														<td>
															<table>
																...
																<tr<%=onmouseoverstyle%>>
																	...
																	<td align="center" class="body-data-list"><%=vo.getProducer()%></td>
																	<td align="center" class="body-data-list"><%=vo.getEnterpriseOid()%></td>
																	<td align="center" class="body-data-list"><%=vo.getWebsite()%></td>
																	<td align="center" class="body-data-list">
																		<a
																			href="<%=rootPath%>/producer.do?action=ready_edit&id=<%=vo.getId()%>">
