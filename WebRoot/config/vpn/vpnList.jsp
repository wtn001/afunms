								...
								<td background="<%=rootPath%>/common/images/right_t_02.jpg"
									...
									<table width="100%" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="content-title">资源 >> VPN管理 >> VPN监视列表</td>
									...
									<table id="example" class="tablesorter" cellspacing="1"
										...
										<tbody>
											...
											<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>
												...
												<td align="center" height=25>&nbsp;<img src="<%=rootPath%>/resource/image/status.gif" border="0" width=15 oncontextmenu=showMenu('2','<%=vo.getId()%>','') alt="右键操作"></td>
											</tr>
