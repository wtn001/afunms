	...
	<head>
		...
		<script type="text/javascript">
			...
			function submitip(){
					var eventTextvalue = '';
					var eventValue = '';
				window.opener.document.getElementById("<%=id%>").value=radiochk();
	 			window.close();
			}
		</script>
	</head>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="content-title">网络设备 IP列表</td>
		        											...
		        											<table cellspacing="0" border="1" bordercolor="#ababab">
		        												...
		        												<%
			        												...
			        												for (int i = 0; i < list.size(); i++) {
																		...
																		if(host!=null)deviceName=host.getAlias();
			        													%>
			        													<tr <%=onmouseoverstyle%>>
											        						 
											        						<td align='center'>
											        							<input type="radio"  class="noborder" name="id" value="<%=vo.getId()%>"/>
																			</td>
																			<td align='center'>
											        							<%=i+1%>
																			</td>
