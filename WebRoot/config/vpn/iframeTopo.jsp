...
v\: * {
	behavior: url(#default#VML);
		...
		<script type="text/javascript" src="<%=rootPath%>/js/vpn/topology.js"></script>
		...
		<link href="<%=rootPath%>/resource/css/vpn_topo_style.css" rel="stylesheet" type="text/css">
		<script>
			var url="<%=rootPath%>/vpnAjaxManager.ajax?action=showvpnmap&type=<%=type%>&r="+Math.random();
	...
	<body oncontextmenu="return false" onclick='down()'>
	<table >
	  <tr align=center valign=top>
	     ...
	     <td width="100">
	      ...
	      <td width="100">
	        <input type="button" value="保存拓扑图" onclick="save('<%=rootPath%>','<%=type%>')" style="width: 70"
			class=btn_mouseout onmouseover="this.className='btn_mouseover'"
			onmouseout="this.className='btn_mouseout'"
			onmousedown="this.className='btn_mousedown'"
			onmouseup="this.className='btn_mouseup'" />
		...
		<div id="board" style="position:relative;left:5px;top:43px;border:1px dashed blue;width:960px;height:1030px;">
		</div>
		<script>
            showTopology(url);
       </script>
