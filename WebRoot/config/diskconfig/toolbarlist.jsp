									...
									<table id="container-main-content" class="container-main-content">
		        						...
		        						<tr>
		        							<td>
													...
													<tr>
														<td>
															...
															<tr>
					    											...
					    											<td width="5%" align="center" class="body-data-title"><strong>短信</strong></td>
					    											...
					    											<td width="5%" align="center" class="body-data-title"><strong>短信</strong></td>
					      											<th width='10%' align="center" class="body-data-title">报表显示操作</th>
    											...
    											<%
    												String reportflag = "<a href="+rootPath+"/disk.do?action=update&id="+vo.getId()+"&reportflag=0&flag=1>取消显示于报表</a>";
    												if(vo.getReportflag()==0){
    													reportflag="<a href="+rootPath+"/disk.do?action=update&id="+vo.getId()+"&reportflag=1&flag=1>显示于报表</a>";
    												}
    											%>
    											<td  class="body-data-list"><%=reportflag%></td>
