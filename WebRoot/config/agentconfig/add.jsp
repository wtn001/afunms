...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/agent.do?action=add";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
																	...
																	<td>
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD>
																					<input type="text" name="agentname" id="agentname" size="40">
																				</TD>
																			</tr>
																			<tr>
																				<TD nowrap align="right" height="24" width="40%">
																				...
																				<TD>
																					<input type="text" name="ipaddress" id="ipaddress" size="40">
																				</TD>
																			</tr>
																			<tr style="background-color: #ECECEC;">
																				<TD nowrap align="right" height="24" width="40%">
																				...
																				<TD>
																					<input type="text" name="agentdesc" id="agentdesc" size="40">
																				</TD>
																			</tr>
																			<tr>
