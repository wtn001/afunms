...
<%
   ...
   Employee vo = (Employee)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk3&&chk4)
     {
     	   mainForm.action = "<%=rootPath%>/employee.do?action=update";
           mainForm.submit();
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
						<tr>
							...
							<TD align="right" height="20">姓名&nbsp;</TD>				
							<TD align="left">
						...
						<tr>
							...
							<td  align="left">&nbsp;<%=view.getPositionBox(vo.getPosition())%></td>
						</tr>
						<tr style="background-color: #ECECEC;">
							...
							<td  align="left">&nbsp;<input name="mobile" value="<%=SysUtil.ifNull(vo.getMobile())%>" type="text" size="16" class="formStyle"></td>
						</tr>
						<tr>
