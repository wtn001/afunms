...
<% 
  ...
  EnvConfig fan = (EnvConfig)request.getAttribute("vo");
  String id = fan.getId()+"";
  Host host = (Host)PollingEngine.getInstance().getNodeByIP(fan.getIpaddress());
  String alias="";
...
<title>风扇模块修改 -> <%=fan.getName()%></title>
...
<input type=hidden name="ipaddress" value="<%=fan.getIpaddress()%>">
			...
			<tr>
			  	...
			  	<td height=380 bgcolor="#FFFFFF" valign="top" align=center>	
					...
					<table width="80%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				<tr>
                    					<td width="619" height="25" class=tableMasterHeaderAlone style="HEIGHT: 25px" colspan=2><div align="center"><b><font color="#FFFFFF">资源管理 >> 设备维护 >>修改风扇模块>> <%=fan.getName()%></font></b></div></td>
                  				</tr>
                  				<tr>
                  				...
                  				<tr>	
                  					...
                  					<TD nowrap width="40%">&nbsp;<%=fan.getIpaddress()%></TD>
                				</tr>
                				<tr>
                  					<TD nowrap align="right" height="24" width="10%"> 风扇模块:&nbsp;</TD>
                  					<TD nowrap width="40%">&nbsp;<%=fan.getName()%></TD>
                				</tr>
								
                                <tr>
                  					<TD nowrap align="right" height="24" width="10%"> 阀值:&nbsp;</TD>
                  					<TD nowrap width="40%">&nbsp;
                  					<input type="text" name="alarmvalue" id="alarmvalue" maxlength="50" size="20" class="formStyle" value="<%=fan.getAlarmvalue()%>">
                  					</TD>
                				</tr> 
                				 <tr>
                  					<TD nowrap align="right" height="24" width="10%"> 告警次数:&nbsp;</TD>
                  					<TD nowrap width="40%">&nbsp;
                  					<input type="text" name="alarmtimes" id="alarmtimes" maxlength="50" size="20" class="formStyle" value="<%=fan.getAlarmtimes()%>">
                  					</TD>
                				</tr> 
