...
<script language="JavaScript">
	...
	{ 
		Ext.get("process").on("click",function(){
    		...
    		mainForm.action = "<%=rootPath%>/mediaPlayer.do?action=add";
    		mainForm.submit();
 		});
	});
											...
											<table id="add-content" class="add-content">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">自动化 >> 自动化控制 >> 执行演示视频管理 >> 添加视频</td>
				        						...
				        						<tr>
													...
													<tr >
														...
														<td nowrap width="40%">
															&nbsp;
															<input type="text" id="aaa" size="20" readonly="readonly"><input type="button" value="添加附件" onclick="showup()">
															<font color="red">&nbsp;*</font>
														</td>
													</tr>
													<tr style="background-color: #ECECEC;">
