...
setTimeout(function(){
 ...
 Ext.get("backup").on("click",function(){
        ...
        mainForm.action = "<%=rootPath%>/vpntelnetconf.do?action=bkpCfg";
        mainForm.submit();
 });
});
...
//-- nielin modify at 2"C:/Documents and Settings/Administrator/Application Data/Microsoft/Internet Explorer/Quick Launch/显示桌面.scf"010-01-04 end ----------------
