...
<html>
	<head>
		...
		<link href="<%=rootPath%>/resource/<%=com.afunms.common.util.CommonAppUtil.getSkinPath() %>css/global/global.css"
			rel="stylesheet" type="text/css" />
		<% 	System.out.println("JSP     -------------"+com.afunms.common.util.CommonAppUtil.getSkinPath());  %>
		...
		<script type="text/javascript">
			...
			function modifyForBatch()
			{
	  		...
	  		function compareFile(){  
     			...
     			window.open("<%=rootPath%>/vpntelnetconf.do?action=compareFile&filename="+filename +"&baskcheckbox="+strs ,"_blank", "height=650, width=1240, top=20, left=10");
			...
			if(data.result==0){
			 if(confirm("你确定要更改基线吗？")) 
              location.href="<%=rootPath%>/vpntelnetconf.do?action=editBaseLine1&id="+id+"&ip=<%=ip%>"+"&type=<%=type%>"; 
             } else{ 
              alert(data.result); 
							...
							<tr>
								<td class="td-container-main-content">
									<table id="container-main-content"
										class="container-main-content" width="100%">
										<tr>
											<td>
												<table id="content-header" class="content-header" width="100%">
													<tr>
										...
										<tr>
											<td>
												<table id="content-body" class="content-body" width="100%">
													...
													<tr>
														<td>
															<table cellspacing="0" border="1" bordercolor="#ababab" width="100%">
										...
										<tr>
											<td>
												<table id="content-footer" class="content-footer" width="100%">
													<tr>
														<td>
															...
															</table></br><center><input type="button" value="关 闭" style="width: 50"
																onclick="window.close()"></center></br>
														</td>
													</tr>
												</table>
											</td>
