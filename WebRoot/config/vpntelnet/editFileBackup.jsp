...
<%@page import="com.afunms.config.model.TimingBackupCondition"%>
...
　　$text=$("#advance_tab tr input:text");
  ...
  $('#textVal').val(arrayObj2); 
    ...
    if(chk1)
    {
    	...
    	mainForm.action = "<%=rootPath%>/vpntelnetconf.do?action=modifyFileBackup&id=<%=timingBackupTelnetConfig.getId()%>";
    	mainForm.submit();
    }
 });
