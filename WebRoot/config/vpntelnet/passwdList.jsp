...
<%
  ...
  List<Huaweitelnetconf> list_vo = dao.loadAll();
  Hashtable<String,Integer> map = new Hashtable<String,Integer>();
  if(list_vo != null && list_vo.size()>0){
     Huaweitelnetconf voo = null;
...
<html>
	<head>
		...
		<script type="text/javascript">
			var listAction = "<%=rootPath%>/vpntelnetconf.do?action=passwdList";
			...
			*/
			...
			function telnetModify()
			{
			    ...
			    $.ajax({
			       type:"POST",
			       dataType:"json",
			       url:"<%=rootPath%>/networkDeviceAjaxManager.ajax?action=verifyUpdate",
			       data:"id="+node+"&ipaddress="+ipaddress,
			       success:function(data){
			          if(data.result == "超级用户登录失败！"||data.result==("用户登录失败")||data.result == "连接失败"){
			             alert(data.result);
			          }else{
		...
		<table border="1" width="100%" height="100%" bgcolor="#F1F1F1"
			...
			<tr>
				<td style="cursor: default; border: outset 1;" align="center"
					onclick="parent.telnetModify()">修改密码</td>
			</tr>
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 资源 >> 设备维护 >> 远程设备密码修改列表</td>
															...
															<table width="100%" cellpadding="0" cellspacing="1">
																<tr>
																	...
																	<td bgcolor="#ECECEC" width="40%" align='right'>
																		...
																		<a href="#" onclick="modifypwForBatch()">批量修改密码</a>&nbsp;
		        										...
		        										<td>
		        											<table cellspacing="0" border="1" bordercolor="#ababab">
		        												<tr height=28 style="background:#ECECEC" align="center" class="content-title">
		        													...
		        													<td align="center" width="15%">登录方式</td>
