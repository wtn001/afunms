				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
						<tr>
							...
							<TD nowrap>&nbsp;<input type="password" name="password" size="40" class="formStyle" value="<%=vo.getPassword() %>"><font color="red">&nbsp;*</TD>	
						</tr>
						<tr>	
							...
							<TD nowrap>&nbsp;<input type="password" name="supassword" size="40"  class="formStyle" value="<%=vo.getSupassword() %>">	<font color="red">&nbsp;* </font>													</TD>	
						</tr>
						
						<tr style="background-color: #ECECEC;">
							<TD nowrap align="right" height="24">ip地址&nbsp;</TD>				
							<TD nowrap>&nbsp;<input name="ipaddress" type="text" size="20" class="formStyle" value="<%=vo.getIpaddress() %>"><input type="button" value="选择网络设备" onclick="showup()"><font color="red">&nbsp;* </font></TD>								
