...
<%@page import="com.afunms.config.model.CfgCmdFile"%>
...
<%
  ...
  String scriptType=(String)request.getAttribute("scriptType");
...
<html>
	<head>
		...
		<script type="text/javascript">
			function submitip(){		
				var filePath = document.getElementsByName("checkbox");
				var backStr = "";
				for(var i=0;i<filePath.length; i++){
					if(filePath[i].checked){
						backStr = backStr + filePath[i].value + ",";
					}				
				}
				parent.opener.document.getElementById("<%=scriptType %>").value=backStr;
				window.close();
			}
		</script>
	</head>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">请选择命令脚本</td>
