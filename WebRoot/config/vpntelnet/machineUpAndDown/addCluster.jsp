...
{  
 ...
 Ext.get("addCluster").on("click",function(){
       
          	Ext.MessageBox.wait('数据加载中，请稍后.. ');
        	mainForm.action = "<%=rootPath%>/serverUpAndDown.do?action=addCluster";
        	mainForm.submit();
																	...
																	<td>
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD nowrap width="40%" >&nbsp;
																					<input type="text" id="name" name="name" maxlength="50" size="28" class="formStyle">
																					
																				</TD>
																				<TD nowrap align="right" height="24" width="10%">&nbsp;服务器组操作系统</TD>		
