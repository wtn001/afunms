...
function toMovement(){
  ...
  function toStatic(){
  	...
  	window.open (path, '静态效果', 'height=330, width=400, top=110,left=220, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
  }
  function toAdd()
  {
		...
		<form id="mainForm" method="post" name="mainForm">
			<table id="body-container" class="body-container">
				<tr>
                    ...
                    <td class="layout_title"><b> 机房仿真 >> 应急关机管理 >> 主机配置管理 <b></td>
        			...
        			<tr>
					           ...
					           <!-- <a href="#" onclick="toAddCluster()">添加到集群</a>
									<a href="#" onclick="toStatic()">静态效果</a>
					           			<a href="#" onclick="toMovement()">动态效果</a>-->
				...
				<table cellspacing="1" cellpadding="0" width="100%" >
					...
					<th width='5%' class="body-data-title">&nbsp;<INPUT type="checkbox" class=noborder name="checkall" onclick="javascript:chkall()"></th>
    					<th width='5%' class="body-data-title">序号</th>
      					<th width='15%' class="body-data-title">名称</th>
      					<th width='10%' class="body-data-title">IP地址</th>	
      					<th width='10%' class="body-data-title">服务器类型</th>
      					<th width='17%' class="body-data-title">远程机器状态</th> 
      					<th width='17%' class="body-data-title">最后一次操作时间</th>    
      					<th width='16%' class="body-data-title">所属服务器组</th>    
    					<th width='5%' class="body-data-title">操作</th>
</tr>
<%
	if(machineList.size() > 0){
    		for(int i=0;i<machineList.size();i++){
...
%>
       <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> class="microsoftLook">
		...
		<td height=25 align=center><span id="name<%=vo.getId() %>"><%=vo.getClusterName() %></span>&nbsp;<span title='修改所属服务器组'><a href="#" onclick="openNewWindow(<%=vo.getId() %>)"><img src="<%=rootPath%>/resource/image/editicon.gif" border=0></a></span></td>
