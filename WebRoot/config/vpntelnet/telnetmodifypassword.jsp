...
<%
  ...
  Huaweitelnetconf mo=(Huaweitelnetconf)request.getAttribute("vpntelnetconf");
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
						...
						<tr>
							...
							<TD nowrap>&nbsp;<input name="defaultpromtp" type="text" size="40" class="formStyle" value="<%=mo.getDefaultpromtp() %>" readonly="readonly"><font color="red">&nbsp;* </font></TD>								
