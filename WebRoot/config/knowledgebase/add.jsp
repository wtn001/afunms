...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk4 = checkinput("titles","string","标题",50,false);
     var chk5 = checkinput("contents","string","内容",5000,false);
     var chk6 = checkinput("userid","string","用户",30,false);
     //var chk5 = checkinput("bak","string","备注",200,false);
     
      if(chk1&&chk2&&chk3&&chk4&&chk5&&chk6)
     {      
            Ext.MessageBox.wait('数据加载中，请稍后.. ');
        	mainForm.action = "<%=rootPath%>/knowledgebase.do?action=add";
        	mainForm.submit();
     }
 });	
...
function initmenu()
{
	...
	*/
			function showup(){
					CreateWindow("<%=rootPath%>/config/knowledgebase/up.jsp");
				}
		</script>
																	...
																	<td>
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr  style="background-color: #ECECEC;">
																				<TD nowrap align="center" height="24" width="5%">
																					当前用户为&nbsp;
																				</TD>
																				<TD>
																					&nbsp;&nbsp;&nbsp;<input type="text" name="userid" value="<%=x.getName()%>" readonly="readonly" width="15px">
																				</TD>
																			</tr>
																			
																			<tr>
																				<TD  nowrap align="center" height="24" width="10%">
																					类别&nbsp;
																					</td>
																					<td>
																					&nbsp;&nbsp;&nbsp;<select name="category"></select><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			<tr style="background-color: #ECECEC;">
																				<TD  nowrap align="center" height="24" width="10%">
																					...
																					<td>
																					&nbsp;&nbsp;&nbsp;<select name="entity"></select><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>	
																				<tr>
																				<TD  nowrap align="center" height="24" width="10%">
																					...
																					<td>
																					&nbsp;&nbsp;&nbsp;<select name="subentity"></select><font color="red">&nbsp;*</font>
																				</TD>
																				<script language="javascript" defer>
																					new PCAS("category","entity","subentity","","","");
																				</script>
																			<tr style="background-color: #ECECEC;">
																				<TD nowrap align="center" height="24" width="5%">
																					标题&nbsp;
																				...
																				<TD nowrap width="33%">
																					&nbsp;&nbsp;&nbsp;<input type="text" name="titles" size="70"><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			<tr>	
																				<TD nowrap align="center" height="24" width="5%">
																				...
																				<TD nowrap width="33%">
																					&nbsp;&nbsp;&nbsp;<textarea rows="10" cols="80" name="contents"></textarea><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD nowrap width="40%">
																					&nbsp;&nbsp;&nbsp;<input type="text" id="aaa" size="20" readonly="readonly"><input type="button" value="添加附件"
																						onclick="showup()"><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			<tr>
