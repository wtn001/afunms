...
<html>
	...
	*/		
	function toAdd(){
		mainForm.action = "<%=rootPath%>/agentnode.do?action=add&id=<%=agentid%>";
		mainForm.submit();
	}
	function toDelete(){
	  if(confirm('是否确定删除这条记录?')) {
		mainForm.action = "<%=rootPath%>/agentnode.do?action=delete&id=<%=agentid%>";
		mainForm.submit();
		}
	}
</script>
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 系统管理 >> AgentID分配 >> AgentID分配列表 </td>
		        											...
		        											<table>
																...
																<tr<%=onmouseoverstyle%>>
																	<td align="center" class="body-data-list">
																		<INPUT type="checkbox" value="<%=agentnode.getNodeid()%>" name="checkbox" onclick="">
																		<%=i+1%>
																	</td>
																	<td align="center" class="body-data-list">
