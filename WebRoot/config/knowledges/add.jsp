...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/knowledge.do?action=add";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
...
{	
	...
	<!-- 三级级联菜单 数据从表nms_alarm_indicators中查取 -->
		...
		<script type="text/javascript">
			function showup(){
				CreateWindow("<%=rootPath%>/config/knowledges/up.jsp");
			}
				//触发下载页面
		</script>
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr>
																				...
																				<TD  nowrap align="right" height="24" width="10%">
																					...
																					<td>
																					<select name="subentity"></select><br>
																				</TD>
																			...
																			<tr>
																				...
																				<TD nowrap width="40%">
																					&nbsp;您上传的文件是：<input type="text" id="aaa" size="20" readonly="readonly"><input type="button" value="添加附件"
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD>
																					&nbsp;
																					<input type="text" name="bak" size="80">
																				</TD>
																			</tr>
