			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="content_title"><span style="font-weight: 700">服务质量>>服务级别管理>>SLA设备属性列表</span></td>
														...
														<table>
															<tr>
        														...
        														<%if(deviceType.equalsIgnoreCase("h3c")){
        															%>
        															<td class="detail-data-body-title" width="15%">管理名</td>
        															<td class="detail-data-body-title" width="15%">操作标识</td>
        															<%
														    	...
														    	<td class="detail-data-body-title" width="5%">操作</td>
														    </tr>
															<%
