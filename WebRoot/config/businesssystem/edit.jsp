...
<%
    BusinessSystem vo = (BusinessSystem) request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1)
     {
        	...
        	mainForm.action = "<%=rootPath%>/businesssystem.do?action=update";
        	mainForm.submit();
																	...
																	<td>
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD nowrap width="40%">
																					...
																					<input type="text" name="name"
																						value="<%=vo.getName()%>" width="60%" size="80">
																					<font color="red">&nbsp;*</font>
																				</TD>
																			...
																			<TD nowrap align="right" height="24">
																				...
																				<TD nowrap>
																					&nbsp;&nbsp;&nbsp;
																					<textarea rows="3" cols="80" name="descr"><%=vo.getDescr()%></textarea>
																					<font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			...
																			<tr>
																				...
																				<TD nowrap>
																					...
																					<input type="text" name="contactname"
																						value="<%=vo.getContactname()%>" width="60%" size="80">
																					<font color="red">&nbsp;*</font>
																				</TD>
																			...
																			<TD nowrap align="right" height="24">
																				...
																				<TD nowrap>
																					...
																					<input type="text" name="contactphone"
																						value="<%=vo.getContactphone()%>" width="60%" size="80">
																					<font color="red">&nbsp;*</font>
																				</TD>
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD nowrap colspan="3">
																					...
																					<input type="text" name="contactemail"
																						value="<%=vo.getContactemail()%>" width="60%" size="80">
																					<font color="red">&nbsp;*</font>
																				</TD>
																				<td>
																			</tr>
																			...
																			<tr style="background-color: #ECECEC;">
																				<TD nowrap colspan="4" align=center>
																					<br>
																					<input type="button" value="修改" style="width: 50"
																						id="process" onclick="#">
																					&nbsp;&nbsp;
