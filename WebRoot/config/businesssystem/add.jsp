 ...
 Ext.get("process").on("click",function(){
    ...
    // var chk3 = checkinput("subentity","string","指标",50,false);
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/businesssystem.do?action=add";
        	mainForm.submit();
     }
 });	
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr>
																				<TD  nowrap align="right" height="24" width="10%">
																					...
																					<td width="40%">
																					&nbsp;&nbsp;&nbsp;<input type="text" name="name" size="70"><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			<tr style="background-color: #ECECEC;">
																				<TD  nowrap align="right" height="24" width="10%">
																					...
																					<td>
																					&nbsp;&nbsp;&nbsp;<textarea rows="3" cols="80" name="descr"></textarea><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>	
																				<tr>
																				<TD  nowrap align="right" height="24" width="10%">
																				...
																				<TD nowrap width="33%">
																					&nbsp;&nbsp;&nbsp;<input type="text" name="contactname" size="70"><font color="red">&nbsp;*</font>
																				</TD>
																			<tr style="background-color: #ECECEC;">
																				<TD nowrap align="right" height="24" width="5%">
																					联系人电话&nbsp;
																				</TD>
																				<TD nowrap width="33%">
																					&nbsp;&nbsp;&nbsp;<input type="text" name="contactphone" size="70"><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			<tr>	
																				<TD nowrap align="right" height="24" width="5%">
																				...
																				<TD nowrap width="33%">
																					&nbsp;&nbsp;&nbsp;<input type="text" name="contactemail" size="70"><font color="red">&nbsp;*</font>
																				</TD>
																			</tr>
																			<tr>
