...
<html>
  ...
  var listAction = "<%=rootPath%>/fdb.do?action=list";
											...
											<td colspan="2">
												<table cellspacing="1" cellpadding="0" width="100%">
													<tr class="microsoftLook0" height=25>
														<th width='5%' class="body-data-title"><INPUT type="checkbox" class=noborder name="checkall" onclick="javascript:chkall()">序号</th>
														<th width='15%' class="body-data-title">网络设备(ip)</th>
														<th width='10%' class="body-data-title">类型</th>
														<th width='10%' class="body-data-title">子类型</th>
														<th width='5%' class="body-data-title">端口</th>
														<th width='15%' class="body-data-title">转发IP</th>
														<th width='20%' class="body-data-title">MAC</th>
														<th width='20%' class="body-data-title">更新时间</th>
														<!-- 
