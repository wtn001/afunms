...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/macconfig.do?action=importExcel";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 &gt;&gt; Mac配置&gt;&gt; 导入Excel</td>
				        										...
				        										<td>
				        											<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
								                        						...
								                        						<select id="discrictid" size="1" name='discrictid' style='width:155px;'>
															                        ...
															                        <% 
															                          if(null !=list)
															                          {
															                             ...
															                             {
															                               DistrictConfig vo=(DistrictConfig)list.get(i);
																		...
																		<tr>
																			...
																			<br><input type="button" value="确 定" style="width:50" id="process" onclick="#">&nbsp;&nbsp;
