...
<html>
  ...
  var listAction = "<%=rootPath%>/device.do?action=listDevice";
  ...
  function toDelete(){
	 ...
	 if(k==0){
      ...
      if(confirm('是否删除选中设备?')) {
           mainForm.action = "<%=rootPath%>/device.do?action=delete";
           mainForm.submit();
         }
  }
														...
														<td>
															<table>
																...
																<tr>
																	...
																	<td align="left" class="body-data-list"><%=vo.getCity()%></td>
																	
																	<td align="left" class="body-data-list"><%=vo.getRoadInfo()%></td>
																	<td align="center" class="body-data-list">
																		<%=vo.getAffiliation()%>
																	</td>
																	...
																	<td align="center" class="body-data-list"><%=vo.getLatitude()%></td>
