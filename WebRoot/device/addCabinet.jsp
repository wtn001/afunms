 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2&&chk3&&chk4&&chk5&&chk7&&chk8&&chk9)
     {
        ...
        Ext.MessageBox.wait('数据加载中，请稍后.. '); 
         ...
         mainForm.action = "<%=rootPath%>/device.do?action=saveCabinet";
         mainForm.submit();
     }  
				...
				<td class="td-container-main">
					...
					<TBODY>
						...
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="city" maxlength="50" size="20" class="formStyle">
								<font color="red">&nbsp;</font>&nbsp;&nbsp;</TD>						
							<TD nowrap align="right" height="24" width="10%">路口信息&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="roadInfo" maxlength="150" size="40" class="formStyle">
								<font color="red">&nbsp;</font></TD>															
						</tr>
						...
						<tr  id='community_tr'>				
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="affiliation" maxlength="50" size="20" class="formStyle">
								<font color="red">&nbsp;</font></TD>						
							<TD nowrap align="right" height="24" width="10%">所属辖区&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="belong" maxlength="50" size="20" class="formStyle">
								</TD>															
						</tr>
						...
						<tr style="background-color: #ECECEC;" id='securityLevel_tr' >
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="latitude" name="latitude" maxlength="50" size="20" class="formStyle">
								<font color="red">&nbsp;</font>
							</TD>						
							<TD nowrap  align="right" height="24" width="10%">纬度&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="longitude" name="longitude" maxlength="50" size="20" class="formStyle">
								<font color="red">&nbsp;</font>
							</TD>
						</tr>
						...
						<tr id='v3_ap_tr' >
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="rackNumber" name="rackNumber" maxlength="100" size="30" class="formStyle">
								<font color="red">&nbsp;</font>
							</TD>
						</tr>
