...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var bidnum = document.getElementsByName("tomcatcheckbox").length;
     var k=0;
     for(var p = 0 ; p <bidnum ; p++){
		if(document.getElementsByName("tomcatcheckbox")[p].checked ==true){
			k=k+1;
		}
	}
															...
															<tr>
				        										<td>
				        											...
				        											<table id="report-data-body" class="report-data-body">
													        			<tr height=28>
																	    	<td width="10%" class="report-data-body-title">&nbsp;&nbsp;<INPUT type="checkbox" class=noborder name="checkall" id = "checkall" onclick="javascript:chkall()">序号</td>
																	        <td width="15%" class="report-data-body-title"><strong>名称</strong></td>
																	        <td width="15%" class="report-data-body-title"><strong>IP地址</strong></td>
																	    	<td width="10%" class="report-data-body-title"><strong>端口号</strong></td>
																		</tr>
																		<%
																			int rc = 0;
