...
<body id="body" class="body" onload="initmenu();">
	...
	<input type=hidden name="orderflag">
							...
							<td class="td-container-main-report">
								<table id="container-main-report" class="container-main-report">
                					...
                					<td>
                						...
                						<table>
  									<tr>
  										<td>主机服务器CPU利用率报表&nbsp;&nbsp;时间段:&nbsp;<%=(String)request.getAttribute("starttime")%>&nbsp;至&nbsp;<%=(String)request.getAttribute("totime")%>
  										</td>
  									
                      								<td align=right valign=top>&nbsp;&nbsp;
                      								
														<a href="<%=rootPath%>/hostreport.do?action=createdocCpu"><img name="selDay1" alt='导出word' style="CURSOR: hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18 border="0">导出WORD</a>&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="<%=rootPath%>/hostreport.do?action=downloadcpureport&startdate=<%=startdate%>&todate=<%=todate%>" target="_blank"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>&nbsp;&nbsp;&nbsp;&nbsp;
                      								<a href="<%=rootPath%>/hostreport.do?action=createpdfCpu"><img name="selDay1" alt='导出PDF' style="CURSOR: hand" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0">导出PDF</a>&nbsp;&nbsp;&nbsp;&nbsp;
                      										&nbsp;&nbsp;
                      								</td> 
                      							</tr>
                      							</table>
    	...
    	<td align=center bgcolor=white width=20%>IP地址</td>
		  <td align=center bgcolor=white width=20%>设备名称</td>
		  <td align=center bgcolor=white width=15%>操作系统</td>
    	<td align=center bgcolor=white width=20%>
    		<input type="button"  name="button3" styleClass="button" onclick="changeOrder('cpuavg')" value="平均值(%)">
    		</td>
    	<td align=center bgcolor=white width=20%>
    		<input type="button"  name="button3" styleClass="button" onclick="changeOrder('cpumax')" value="最大值(%)">
    	</td>
   												</tr>
