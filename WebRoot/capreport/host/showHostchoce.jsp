...
function query(){
 	...
 	mainForm.action="<%=rootPath%>/hostreport.do?action=downloadselfhostchocedoc&startdate="+startdate+"&todate="+todate+"&ids="+oids;
	mainForm.submit();  
 	}
}
  function doQuery()
...
<table id="body-container" class="body-container">
	...
	&nbsp;&nbsp;<input type="button" name="mprocess" value="导出" onclick="query()">
				</td>
									</tr>
        								</table>
										</td>
						    ...
						    if (allreporthash != null && allreporthash.size() > 0) {
								...
								while (keys.hasNext()) {
									...
									if (memAvgHash.get("PhysicalMemory") != null) {
                                     ...
                                     if(string4==null)string4="0";
                                     if(string5==null)string5="0";
                                     if(string6==null)string6="0";
									String value1 = "0";
									String name = "";
									String Utilization = "";
