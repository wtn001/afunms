...
function query(){
	 mainForm.action = "<%=rootPath%>/hostreport.do?action=find&hostflag=2";
     mainForm.submit();
																					...
																					<tr>
																						<td>
																							开始日期
																								...
																								&nbsp;<img id=imageCalendar2 align=absmiddle width=34 height=21 src="<%=rootPath%>/include/calendar/button.gif" border=0></a> 所属业务<input type=text readonly="readonly" onclick='setBid("bidtext" , "bid");' id="bidtext" name="bidtext" size="25" maxlength="25" value="">
