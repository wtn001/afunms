...
function query()
  {  
     mainForm.action = "<%=rootPath%>/hostreport.do?action=find&hostflag=5";
     mainForm.submit();
  }
</script>
...
<body id="body" class="body" onload="initmenu();">
	...
	<input type=hidden name="eventid">
    	...
    	<td width="10%" class="report-data-body-title">&nbsp;&nbsp;<INPUT type="checkbox" class=noborder name="checkall" onclick="javascript:chkall()">序号</td>
        <td width="30%" class="report-data-body-title"><strong>IP地址</strong></td>
        <td width="30%" class="report-data-body-title"><strong>设备名称</strong></td>
    	<td width="30%" class="report-data-body-title"><strong>操作系统</strong></td>
   </tr>
<%
    	HostNode node = null;
