...
function disk_ok()
{
	...
	mainForm.action = "<%=rootPath%>/hostreport.do?action=showDiskReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('hostReportPerformTitle-2').className='detail-data-title';
	document.getElementById('hostReportPerformTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('hostReportPerformTitle-2').onmouseout="this.className='detail-data-title'";
}
					...
					<tr>
						<td>
							...
							<%
				       			...
				       			%>
				       			<tr>
						       		<td align=center><br><br><b>所在的服务器没有被监视或所在的服务器磁盘信息未采集<br><br></td>
						       	</tr>
						       	<%
						       		}else{
						       	%>
													...
													<table bgcolor="#ECECEC" width="100%">
														<tr align="left" valign="center"> 
															<td height="28" align="left" width="50%">
																...
																<input type="button" name="doprocess" value="确定" onclick="disk_ok()">
															</td>
															<td height="28" align="left" width="10%">
																<a href="javascript:disk_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORD</a>
															</td>
															<td height="28" align="left" width="10%">
																<a href="javascript:disk_excel_report()"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>
															</td>
															<td height="28" align="left" width="10%">&nbsp;
																<a href="javascript:disk_pdf_report()"><img name="selDay1" alt='导出word' style="CURSOR: hand" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0">导出PDF</a>
															</td>
														</tr>
													</table>
						       					</td>
							       			...
							       			<tr align="left" valign="center"> 
			             						<td height="28" align="left" border="0">
													...
													<table cellspacing="0" align="center" width="90%" id="diskDetailTable">					
														<tr>
															<td height="26" width="20%"><b>磁盘使用情况</td>
															<td height="26" width="20%"><b>磁盘名</td>
															<td height="26" width="20%"><b>总容量</td>
															<td height="26" width="20%"><b>已用容量</td>
															<td height="26" width="20%"><b>利用率</td>
														</tr>
														<%
														...
														<%
					 									...
					 									%>
													</table><br><br><center><input type=button value="关闭窗口" onclick="window.close()"></center></div></br>
			             						</td>
											</tr>
						       			</table>
						       		</td>
