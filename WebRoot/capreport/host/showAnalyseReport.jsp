...
function analyse_ok()
{
	...
	mainForm.action = "<%=rootPath%>/hostreport.do?action=showAnalyseReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('hostReportPerformTitle-5').className='detail-data-title';
	document.getElementById('hostReportPerformTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('hostReportPerformTitle-5').onmouseout="this.className='detail-data-title'";
}
											...
											<tr>
						       					<td>
													<table bgcolor="#ECECEC">
														...
														<td height="28" align="left">
															<a href="javascript:analyse_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORD</a>
														</td>
														<td height="28" align="left">
