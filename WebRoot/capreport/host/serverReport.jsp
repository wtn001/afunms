...
if((ids.length<=0|| ids.length == "")&&(id.length<=0|| id.length == "")){
 ...
 window.open('<%=rootPath%>/netreport.do?action=downloadReport&type=host&exportType='+exportType+'&id='+id+'&ids='+ids+'&startdate='+startdate+'&todate='+todate+'&beginHour='+beginHour+'&endHour='+endHour+'&nowtime='+(new Date()),"_blank","toolbar=no,width=1,height=1,top=2000,left=3000,directories=no,status=no,menubar=no,alwaysLowered=yes");
																				...
																				<div>
																					<table bgcolor="#ECECEC">
																						<tr align="left" valign="middle">
																					     ...
																					     结束日期<input type="text" id="mytodate" name="todate" value="<%=todate%>" size="10" />
