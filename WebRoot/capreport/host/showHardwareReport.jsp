...
function hardware_ok()
{
	...
	mainForm.action = "<%=rootPath%>/hostreport.do?action=showHardwareReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('hostReportPerformTitle-3').className='detail-data-title';
	document.getElementById('hostReportPerformTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('hostReportPerformTitle-3').onmouseout="this.className='detail-data-title'";
}
											...
											<tr>
						       					<td>
													<table bgcolor="#ECECEC">
														...
														<td height="28" align="left">
															<a href="javascript:hardware_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORD</a>
														</td>
														<td height="28" align="left">
											...
											<tr>
							       			...
							       			<tr align="left" valign="center"> 
			             						<td height="28" align="left" border="0">
													...
													<br><br><center><input type=button value="关闭窗口" onclick="window.close()"></center></div></br>
			             						</td>
											</tr> 
						       			</table>
						       		</td>
