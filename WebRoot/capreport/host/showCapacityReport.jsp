...
function capacity_word_report()
{
mainForm.action = "<%=rootPath%>/hostreport.do?action=downloadCapacityReport&ipaddress=<%=ipaddress%>&str=1";
	mainForm.submit();
}
function capacity_excel_report()
{
mainForm.action = "<%=rootPath%>/hostreport.do?action=downloadCapacityReport&ipaddress=<%=ipaddress%>&str=0";
	mainForm.submit();
}
function capacity_pdf_report()
{
mainForm.action = "<%=rootPath%>/hostreport.do?action=downloadCapacityReport&ipaddress=<%=ipaddress%>&str=4";
	mainForm.submit();
}
function capacity_ok()
{
	...
	mainForm.action = "<%=rootPath%>/hostreport.do?action=showCapacityReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
function capacity_cancel()
{
window.close();
}
function query(){
...
function setClass(){
	document.getElementById('hostReportPerformTitle-1').className='detail-data-title';
	document.getElementById('hostReportPerformTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('hostReportPerformTitle-1').onmouseout="this.className='detail-data-title'";
}
		...
		<tr>
						       					...
						       					<td>
													<table bgcolor="#ECECEC">
														...
														<td height="28" align="left">
															...
															<input type="button" name="doprocess" value="确定" onclick="capacity_ok()">
														</td>
														<td height="28" align="left">
															<a href="javascript:capacity_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORD</a>
														</td>
														<td height="28" align="left">
															<a href="javascript:capacity_excel_report()"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>
														</td>
														<td height="28" align="left">&nbsp;
															<a href="javascript:capacity_pdf_report()"><img name="selDay1" alt='导出word' style="CURSOR: hand" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0">导出PDF</a>
														</td>
														</tr>  
													</table>
						       					</td>
			...
			<tr>
				<td align="center">
					...
					<br><br><input type=button value="关闭窗口" onclick="window.close()"></div></br>
				</td>
			</tr>
		</table>
			             						</td>
