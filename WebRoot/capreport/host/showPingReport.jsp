...
{
	mainForm.action = "<%=rootPath%>/hostreport.do?action=downloadPingReport&ipaddress=<%=ipaddress%>&str=1";
	mainForm.submit();
}
function ping_excel_report()
{
	mainForm.action = "<%=rootPath%>/hostreport.do?action=downloadPingReport&ipaddress=<%=ipaddress%>&str=0";
	mainForm.submit();
}
function ping_pdf_report()
{
	mainForm.action = "<%=rootPath%>/hostreport.do?action=downloadPingReport&ipaddress=<%=ipaddress%>&str=4";
	mainForm.submit();
}
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/hostreport.do?action=showPingReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('hostReportPerformTitle-0').className='detail-data-title';
	document.getElementById('hostReportPerformTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('hostReportPerformTitle-0').onmouseout="this.className='detail-data-title'";
}
