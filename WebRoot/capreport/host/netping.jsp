					...
					<br>
						<table cellSpacing="1" cellPadding="0" width="100%" border="0">	
              					<tr> 
                					...
                					<td width="100" background="<%=rootPath%>/resource/image/anjian.gif">
								<div align="center"><a href="<%=rootPath%>/netreport.do?action=list"><font color="#FFFFFF">连通率报表</font></a></div></td>	
                					<td width="100" background="<%=rootPath%>/resource/image/anjian_1.gif">
								<div align="center"><a href="<%=rootPath%>/netreport.do?action=eventlist"><font color="#397dbd">事件报表</font></a></div></td>		
                					<td width="100" background="<%=rootPath%>/resource/image/anjian_1.gif">
								<div align="center"><a href="<%=rootPath%>/netreport.do?action=netmultilist"><font color="#397dbd">综合报表</font></a></div></td>			
                					<td>&nbsp;</td>
              					</tr>
              					</table>
              				</td>
											...
											<a href="<%=rootPath%>/netreport.do?action=downloadpingreport&startdate=<%=startdate%>&todate=<%=todate%>" target="_blank"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>&nbsp;&nbsp;&nbsp;&nbsp;
  											...
  											<table   cellSpacing="1"  cellPadding="0" border=0 bgcolor=black width=100%>
  												...
  												<tr  class="firsttr">
		  											...
		  											<td align=center bgcolor=white width=25%>操作系统</td>
