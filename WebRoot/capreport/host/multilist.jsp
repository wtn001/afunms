...
function query()
  {  
     mainForm.action = "<%=rootPath%>/hostreport.do?action=find&hostflag=6";
     mainForm.submit();
  }
</script>
...
<body id="body" class="body" onload="initmenu();">
	...
	<input type=hidden name="eventid">
																					...
																					<tr>
																						<td>
																							开始日期
																								...
																								&nbsp;&nbsp;<input type="button" name="doprocess" value="生成报表" onclick="exeReport()">
																						</td>
																					</tr>
																				</table>
																			</td>
    	...
    	<td class="report-data-body-title" width="10%" rowspan=2>&nbsp;&nbsp;<INPUT type="checkbox" class=noborder name="checkall" onclick="javascript:chkall()">序号</td>
        <td class="report-data-body-title" width="15%" rowspan=2><strong>IP地址</strong></td>
        <td class="report-data-body-title" width="15%" rowspan=2><strong>设备名称</strong></td>
    	<td class="report-data-body-title" width="20%" rowspan=2><strong>操作系统</strong></td>
    	<td class="report-data-body-title" width="40%" align=center colspan="5"><strong>生成报表</strong></td>
   </tr>
  <tr class="microsoftLook0" height=28>
    <td class="report-data-body-title" align=center  width="8%">EXCEL综合</td>
    <td class="report-data-body-title" align=center  width="8%">WORD综合</td>
    <td class="report-data-body-title" align=center  width="8%">PDF综合</td>
    <td class="report-data-body-title" align=center  width="8%">WORD分析</td>
    <td class="report-data-body-title" align=center  width="8%">PDF分析</td>
  </tr>
...
%>
 ...
 <tr bgcolor="#ffffff" <%=onmouseoverstyle%> class="microsoftLook" height=25>
	...
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_excel.gif" width=18 border="0" onclick=openwin(0,"downloadselfhostreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>  
      <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_word.gif" width=18 border="0" onclick=openwin(1,"downloadselfhostreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
       <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0" onclick=openwin(4,"downloadselfhostreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>  
       <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_word.gif" width=18 border="0" onclick=openwin(2,"downloadselfhostreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>  
       <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0" onclick=openwin(3,"downloadselfhostreport","<%=node.getIpAddress()%>") target="_blank">      
      </td> 
