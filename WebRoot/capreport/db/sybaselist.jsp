...
function openwin(str,operate,ip) 
{
 ...
 function exeReport(){
 	...
 	window.open ("<%=rootPath%>/dbreport.do?action=downloadmultisybasereport2&startdate="+startdate+"&todate="+todate+"&ids="+oids, "newwindow", "height=500, width=600, toolbar= no, menubar=no, scrollbars=yes, resizable=yes, location=yes, status=yes")    	      
...
function setClass(){
	document.getElementById('dbReportTitle-4').className='detail-data-title';
	document.getElementById('dbReportTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('dbReportTitle-4').onmouseout="this.className='detail-data-title'";
}
...
function query()
  {  
     mainForm.action = "<%=rootPath%>/dbreport.do?action=find&dbflag=6";
     mainForm.submit();
  }
...
%>
 ...
 <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> class="microsoftLook" height=25>
	...
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_excel.gif" width=18 border="0" onclick=openwin(2,"createSybaseCldReport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
        <td class="report-data-body-list" align=center>     
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_word.gif" width=18 border="0" onclick=openwin(0,"createSybaseCldReport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
        <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0" onclick=openwin(1,"createSybaseCldReport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
        <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_word.gif" width=18 border="0" onclick=openwin(3,"downloadsybaseselfreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
       <td class="report-data-body-list" align=center>      
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0" onclick=openwin(4,"downloadsybaseselfreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
 </tr>
 <%}
