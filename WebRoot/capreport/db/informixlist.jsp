...
function exeReport(){
 	...
 	window.open ("<%=rootPath%>/dbreport.do?action=downloadmultiinformixreport&startdate="+startdate+"&todate="+todate+"&ids="+oids, "newwindow", "height=500, width=600, toolbar= no, menubar=no, scrollbars=yes, resizable=yes, location=yes, status=yes")    	      
...
function setClass(){
	document.getElementById('dbReportTitle-5').className='detail-data-title';
	document.getElementById('dbReportTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('dbReportTitle-5').onmouseout="this.className='detail-data-title'";
}
...
function query()
  {  
     mainForm.action = "<%=rootPath%>/dbreport.do?action=find&dbflag=7";
     mainForm.submit();
  }
</script>
...
%>
 ...
 <tr bgcolor="#ffffff" <%=onmouseoverstyle%> class="microsoftLook" height=25>
	...
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_excel.gif" width=18 border="0" onclick="document.getElementById('b<%=i+1%>').checked = true;exeReport();" target="_blank">      
        ...
        <td class="report-data-body-list" align=center>     
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_word.gif" width=18 border="0" onclick=openwin(0,"createInformixCldReport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
        <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0" onclick=openwin(1,"createInformixCldReport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
        <td class="report-data-body-list" align=center>       
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_word.gif" width=18 border="0" onclick=openwin(3,"downloadinforselfreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
       <td class="report-data-body-list" align=center>      
	&nbsp;&nbsp;<img  name="submitss" src="<%=rootPath%>/resource/image/export_pdf.gif" width=18 border="0" onclick=openwin(4,"downloadinforselfreport","<%=node.getIpAddress()%>") target="_blank">      
      </td>
 </tr>
 <%}
