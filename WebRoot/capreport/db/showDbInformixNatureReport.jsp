...
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/informix.do?action=informixManagerNatureReportQuery&ipaddress=<%=ip%>&id=<%=session.getAttribute("id")%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
