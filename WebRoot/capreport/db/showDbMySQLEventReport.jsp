...
function setClass(){
	document.getElementById('dbMysqlReportPerformTitle-3').className='detail-data-title';
	document.getElementById('dbMysqlReportPerformTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('dbMysqlReportPerformTitle-3').onmouseout="this.className='detail-data-title'";
}
