...
function ping_ok(){
	...
	mainForm.action = "<%=rootPath%>/db2.do?action=db2ManagerCldReportQuery&ipaddress=<%=ip%>&id=<%=session.getAttribute("id")%>&startdate="+starttime+"&todate="+endtime+"&status="+status+"&level1="+level1;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('db2ReportPerformTitle-2').className='detail-data-title';
	document.getElementById('db2ReportPerformTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('db2ReportPerformTitle-2').onmouseout="this.className='detail-data-title'";
}
