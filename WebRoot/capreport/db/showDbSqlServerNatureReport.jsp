...
{
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createSServerSelfReport&ipaddress=<%=ip%>&str=1";
	mainForm.submit();
}
function ping_excel_report()
{
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createSServerSelfReport&ipaddress=<%=ip%>&str=0";
	mainForm.submit();
}
function ping_pdf_report()
{
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createSServerSelfReport&ipaddress=<%=ip%>&str=2";
	mainForm.submit();
}
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/sqlserver.do?action=SqlServerManagerNatureRepQuery&ipaddress=<%=ip%>&id=<%=session.getAttribute("id")%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('dbReportPerformTitle-1').className='detail-data-title';
	document.getElementById('dbReportPerformTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('dbReportPerformTitle-1').onmouseout="this.className='detail-data-title'";
}
																		...
																		<% 
																			...
																			if (names == null)
																				...
																				for (int i = 0; i < names.size(); i++) {
																					...
																					String size = data.get("sizes").toString();
																					String usedsize = "";
