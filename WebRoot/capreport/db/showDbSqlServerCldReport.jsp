...
function ping_ok(){
	...
	mainForm.action = "<%=rootPath%>/sqlserver.do?action=SqlServerManagerCldRepQuery&ipaddress=<%=ip%>&id=<%=session.getAttribute("id")%>&startdate="+starttime+"&todate="+endtime+"&status="+status+"&level1="+level1;
	mainForm.submit();
}
