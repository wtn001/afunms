...
function setClass(){
	document.getElementById('dbMysqlReportPerformTitle-1').className='detail-data-title';
	document.getElementById('dbMysqlReportPerformTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('dbMysqlReportPerformTitle-1').onmouseout="this.className='detail-data-title'";
}
