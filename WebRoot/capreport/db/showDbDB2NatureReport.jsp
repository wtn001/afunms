...
<%	
    ...
    spaceInfo	= (Hashtable)request.getAttribute("spaceInfo");
    ...
    //System.out.println("avgpingcon =  "+avgpingcon+"rootPath =  "+rootPath+"newip =  "+newip+"ip =  "+ip+"spaceInfo =  "+spaceInfo);
...
{
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createDB2SelfReport&ipaddress=<%=ip%>&str=1";
	mainForm.submit();
}
function ping_excel_report()
{
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createDB2SelfReport&ipaddress=<%=ip%>&str=0";
	mainForm.submit();
}
function ping_pdf_report()
{
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createDB2SelfReport&ipaddress=<%=ip%>&str=2";
	mainForm.submit();
}
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/db2.do?action=db2ManagerNatureReportQuery&ipaddress=<%=ip%>&id=<%=session.getAttribute("id")%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('db2ReportPerformTitle-1').className='detail-data-title';
	document.getElementById('db2ReportPerformTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('db2ReportPerformTitle-1').onmouseout="this.className='detail-data-title'";
}
															...
															<tr>
																<td>
																	<table width="100%" border="0" cellspacing="0"cellpadding="0">
																		...
																		<% 
  																		java.util.Iterator iterator = spaceInfo.keySet().iterator();
																		...
																		<tr height="28" bgcolor="#FFFFFF">
																			...
																			<td class="application-detail-data-body-list"align=center>&nbsp;<%=SYSCATSPACE%></td>
																			<td class="application-detail-data-body-list"align=center>&nbsp;<%=totalspac%></td>
																			<td class="application-detail-data-body-list"align=center>&nbsp;<%=usablespac %></td>
																			<td class="application-detail-data-body-list"align=center>&nbsp;<%=usableper %></td>
																		</tr>
																		<% 		}
																			}
																		}
