...
function setClass(){
	document.getElementById('dbMysqlReportPerformTitle-2').className='detail-data-title';
	document.getElementById('dbMysqlReportPerformTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('dbMysqlReportPerformTitle-2').onmouseout="this.className='detail-data-title'";
}
