...
function ping_excel_report(){
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createInformixCldReport&ipaddress=<%=ip%>&str=2";
	mainForm.submit();
}
function ping_word_report(){
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createInformixCldReport&ipaddress=<%=ip%>&str=0";
	mainForm.submit();
}
function ping_pdf_report(){
	mainForm.action = "<%=rootPath%>/dbreport.do?action=createInformixCldReport&ipaddress=<%=ip%>&str=1";
	mainForm.submit();
}
function ping_ok(){
	...
	mainForm.action = "<%=rootPath%>/informix.do?action=informixManagerCldReportQuery&ipaddress=<%=ip%>&id=<%=session.getAttribute("id")%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
																	...
																	<td align=center colspan=2>
																		...
																		<table width="90%" border="0" cellpadding="3"
																			...
																			<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>
																				...
																				<td class="application-detail-data-body-list"><%=tablesVO.get("seqscans")%></td>
																				<td class="application-detail-data-body-list"><%=tablesVO.get("total_sorts")%></td>
																				<td class="application-detail-data-body-list"><%=tablesVO.get("dsksorts")%></td>
																			</tr>
																				<%
														                       		}
														                       	}
																				...
																				<td align=center>
																					...
																					<table width="90%" border="0" cellpadding="3"
																						...
																						<tr bgcolor="397dbd" height=28>
																							...
																							<td width="15%"
																								class="application-detail-data-body-title">
																								<strong>物理读取（镜像）数</strong>
																							</td>
																							<td width="13%"
																								class="application-detail-data-body-title">
																								<strong>读取（镜像）的页数</strong>
																							</td>
																							<td width="15%"
																								class="application-detail-data-body-title">
																								<strong>物理写入（镜像）数</strong>
																							</td>
																							<td width="15%"
																								class="application-detail-data-body-title">
																								<strong>写入（镜像）的页数</strong>
																							</td>
																						</tr>
																						<%
																						...
																						<tr bgcolor="FFFFFF" <%=onmouseoverstyle%> height=25> 
																	                       <td><%=tablesVO.get("chunknum")%></td>
																	                       <td><%=tablesVO.get("reads")%></td>
																	                       <td ><%=tablesVO.get("pagesread")%></td>
																	                       <td ><%=tablesVO.get("writes")%></td>                       
																	                       <td ><%=tablesVO.get("pageswritten")%></td>
																	                       <td ><%=tablesVO.get("mreads")%></td>
																	                       <td ><%=tablesVO.get("mpagesread")%></td>                       
																	                       <td ><%=tablesVO.get("mwrites")%></td>
																	                       <td ><%=tablesVO.get("mpageswritten")%></td>                       
																				         </tr>
																						<%
																                       		}
																                       	}
