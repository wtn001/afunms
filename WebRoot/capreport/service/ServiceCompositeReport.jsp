...
<%@page import="com.afunms.application.model.WebConfig"%>
...
<html>
	<head>
		<%
			...
			Hashtable reporthash = (Hashtable) session
					.getAttribute("reporthash");
			WebConfig con = (WebConfig) reporthash.get("webconfig");
		%>
...
{
	mainForm.action = "<%=rootPath%>/servicecapreport.do?action=downloadWebCompReport&ipaddress=<%=ipaddress%>&str=0";
	mainForm.submit();
}
function ping_excel_report()
{
	mainForm.action = "<%=rootPath%>/servicecapreport.do?action=downloadWebCompReport&ipaddress=<%=ipaddress%>&str=1";
	mainForm.submit();
}
function ping_pdf_report()
{
	mainForm.action = "<%=rootPath%>/servicecapreport.do?action=downloadWebCompReport&ipaddress=<%=ipaddress%>&str=2";
	mainForm.submit();
}
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/web.do?action=showCompositeReport&ipaddress=<%=ipaddress%>&id=<%=id%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
														...
														<td height="28" align="left" border="0">
															...
															<table border="1" width="90%">
																...
																<tr>
																	<td colspan="4" align="center">
																		<img
																			src="<%=rootPath%>/resource/image/jfreechart/<%=newip%>delayConnect.png" />
																	</td>
																</tr>
																<tr>
																	<td colspan="4" align="center">
																		<img
																			src="<%=rootPath%>/resource/image/jfreechart/<%=newip%>pageConnect.png" />
																	</td>
																</tr>
																<tr>
																	<td colspan="4" align="center">
																		<img
																			src="<%=rootPath%>/resource/image/jfreechart/<%=newip%>changeConnect.png" />
																	</td>
																</tr>
