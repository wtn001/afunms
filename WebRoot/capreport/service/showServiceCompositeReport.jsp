...
reporthash=(Hashtable)session.getAttribute("reporthash");
List<String> comInfoList=(List<String>)reporthash.get("comInfo");
...
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/<%=type%>.do?action=showCompositeReport&ipaddress=<%=ipaddress%>&id=<%=id%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
