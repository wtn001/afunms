											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 报表 >> 报表订阅 >> 订阅设置 >> 设置一览 </td>
															...
															<table>
																<tr>
																	...
																	<td class="body-data-title" style="text-align: right;">
																		...
																		<INPUT type="button" value="删    除" onclick=" return doDelete()">
														                &nbsp;&nbsp;&nbsp;
											  						</td>
																</tr>
															</table>
		        										...
		        										<td>
		        											<table>
		        												<tr>
		        													...
		        													<td align="center" class="body-data-title" width="11%"><a href="#" onclick="">报表接收人</a><%=nameImg%></td>
		        													<td align="center" class="body-data-title" width="5%"><a href="#" onclick="">所属业务</a><%=categoryImg%></td>
		        													<td align="center" class="body-data-title" width="8%"><a href="#" onclick="">设备列表</a><%=ipaddressImg%></td>
		        													<td align="center" class="body-data-title" width="6%"><a href="#" onclick="">报表生成时间</a><%=pingImg%></td>
		        													<td align="center" class="body-data-title" width="6%"><a href="#" onclick="">编辑</a><%=pingImg%></td>
		        												</tr>
		        												<%
		        													if(list!=null)
		        													{
		        												...
		        												%>
		        													<tr <%=onmouseoverstyle%>>
					        											...
					        											<td align="center" class="body-data-list">
					        												<img src="<%=rootPath%>/resource/image/status.gif" border="0" width=15 oncontextmenu=showMenu('2','<%=vo.getConfig().getId()%>','') alt="右键操作">
					        											</td>
