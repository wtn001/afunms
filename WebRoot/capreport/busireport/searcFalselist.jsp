	...
	<head>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			setTimeout(function(){
			 ...
			 Ext.get("process").on("click",function(){
				...
				mainForm.action="<%=rootPath%>/businessReport.do?action=searchfalse&jp=1";
				mainForm.submit();        
		...
		<script type="text/javascript">
			var curpage= <%=jp.getCurrentPage()%>;
  			...
  			var listAction = "<%=rootPath%>/businessReport.do?action=searchfalse";
		...
		<script language="JavaScript">
			...
			*/
			...
			function createReport(){
				CreateWindow( "<%=rootPath%>/businessReport.do?action=createReport&startdate="+ "<%=startdate%>" +"&todate=" + "<%=todate%>" );
			}
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 报表 &gt;&gt; 业务报表浏览 &gt;&gt; CICS错误日志列表</td>
		        											...
		        											%>
		        												<tr <%=onmouseoverstyle%>>
			        												<td align="center" class="body-data-list"><INPUT type="checkbox" name="checkbox" ><%=i+jp.getStartRow()%></td>
			       													<td align="center" class="body-data-list"><font color="red"><%=valueList.get(1)%></font></td>
			       													<td align="center" class="body-data-list"><%=valueList.get(0)%></td>
		       													</tr>
		        											<%
		        											}
		        										}
