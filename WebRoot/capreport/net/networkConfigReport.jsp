...
{
	mainForm.action = "<%=rootPath%>/netreport.do?action=downloadConfigReport&ipaddress=<%=ipaddress%>&str=1";
	mainForm.submit();
}
function network_config_ok()
{
	//var prewindow = window.open("<%=rootPath%>/hostreport.do?action=downloadCompositeReport&ipaddress=<%=ipaddress%>&str=1","hello","width=600,height=400");
	var prewindow = window.open("<%=rootPath%>/netreport.do?action=showNetworkConfigReport&ipaddress=<%=ipaddress%>","hello","width=600,height=400,scrollbars=yes");
		...
		<div id="loading">
			<div class="loading-indicator">
				<img src="<%=rootPath%>/js/ext/lib/resources/extanim64.gif" width="32" height="32" style="margin-right: 8px;" align="middle" />Loading...</div>
					...
					&nbsp;&nbsp;<input type="button" name="doprocess" value="确定" onclick="network_config_ok()">
