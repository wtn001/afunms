...
function network_ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/netreport.do?action=showPingReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
...
function setClass(){
	document.getElementById('netReportPerformTitle-0').className='detail-data-title';
	document.getElementById('netReportPerformTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('netReportPerformTitle-0').onmouseout="this.className='detail-data-title'";
}
</script>
			...
			<td>
				<table id="container-main-win" class="container-main-win">
					<tr>
						...
						<tr bgcolor="">
							<td colspan="12" align="center" style="font-size: 20"><br><b>网络设备连通率报表<br><br></td>
						</tr>
