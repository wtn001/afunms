...
function network_event_report()
{
	mainForm.action = "<%=rootPath%>/netreport.do?action=downloadEventReport&ipaddress=<%=ipaddress%>&str=1";
	mainForm.submit();
}
function network_event_ok()
{
	...
	var prewindow = window.open("<%=rootPath%>/netreport.do?action=showEventReport&ipaddress=<%=ipaddress%>&startdate="+starttime+"&todate="+endtime,"hello","width=800,height=400,scrollbars=yes,resizable=yes");
		...
		<div id="loading">
			<div class="loading-indicator">
				<img src="<%=rootPath%>/js/ext/lib/resources/extanim64.gif" width="32" height="32" style="margin-right: 8px;" align="middle" />Loading...</div>
					...
					<input type="button" name="doprocess" value="取消" onclick="network_event_cancel()">
</form>
</div>
