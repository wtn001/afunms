...
function network_composite_ok()
{
	...
	mainForm.action = "<%=rootPath%>/netreport.do?action=showCompositeReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
...
function setClass(){
	document.getElementById('netReportPerformTitle-2').className='detail-data-title';
	document.getElementById('netReportPerformTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('netReportPerformTitle-2').onmouseout="this.className='detail-data-title'";
}
