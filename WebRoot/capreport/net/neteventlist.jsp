...
function queryBid()
  {  
     mainForm.action = "<%=rootPath%>/netreport.do?action=find&netflag=2";
     mainForm.submit();
  }
</script>
...
<body id="body" class="body" onload="initmenu();">
	...
	<input type=hidden name="eventid">
																					...
																					<tr>
																						<td>
																							开始日期
                                                                                                ...
                                                                                                <input type="button" name="submitss" value="查询" onclick="queryBid()">
        ...
        <td class="report-data-body-title" width="30%"><strong>IP地址</strong></td>
        <td class="report-data-body-title" width="30%"><strong>设备名称</strong></td>
    	<td class="report-data-body-title" width="30%"><strong>操作系统</strong></td>
   </tr>
<%
    	HostNode node = null;
