...
<%@page import="com.afunms.schedule.model.Position"%>
...
<html>
  ...
  var delAction = "<%=rootPath%>/schedule.do?action=deletePosition";
  ...
  function toAdd()
  {
      window.location = "<%=rootPath%>/schedule/position/add.jsp";
  }
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title">&nbsp;日常办公 &gt;&gt; 排班计划 &gt;&gt; 地点设置 </td>
		        										...
		        										<td>
		        											<table>
		        												<tr>
		        													...
		        													<td align="center" class="body-data-title" width="30%">描述</td>
		        													<td align="center" class="body-data-title" width="30%">编辑</td>
		        												</tr>
		        												<%
					        									    Position vo = null;
																	for (int i = 0; i < rc; i++) {
																		vo = (Position) list.get(i);
					        									            ...
					        									            <tr <%=onmouseoverstyle%>>
					        													...
					        													<td align="center" class="body-data-list">
																					<a href="<%=rootPath%>/schedule.do?action=editPosition&id=<%=vo.getId()%>"><img src="<%=rootPath%>/resource/image/editicon.gif" border="0" /></a>
																				</td>
				        													</tr>
					        									            <% 
					        									            	}
