...
<!-- 这里用来定义需要显示的右键菜单 -->
	...
	<form id="mainForm" method="post" name="mainForm" action="schedule.do?action=savePosition">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">日常办公 &gt;&gt; 排班计划 &gt;&gt; 地点添加</td>
				   ...
				   <table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
					<TBODY>
						...
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap>&nbsp;
								<input type="text" name="description" maxlength="50" size="20" class="formStyle">
							</TD>						
						</tr>
						<tr>
