...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk2 = checkinput("description","string","描述",50,false);

     if(chk1&&chk2)
     {
        mainForm.action = "<%=rootPath%>/schedule.do?action=updatePosition";
        mainForm.submit();
     }
       // mainForm.submit();
 });	
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
						...
						<tr style="background-color: #ECECEC;">						
							<TD nowrap align="right" height="24" width="45%">描述&nbsp;</TD>				
							<TD nowrap>&nbsp;
								<input type="text" name="description" maxlength="50" size="20" class="formStyle" value="<%=vo.getDescription()==null?"":vo.getDescription() %>">
							</TD>						
						</tr>
															<tr>
