		...
		<form id="mainForm" method="post" name="mainForm">
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 性能 >> 扫描端口 </td>
		   ...
		   { 													%>
		        												<tr>
			        												...
			        												<td align="center" class="body-data-title"><input type="button" onclick="savePortScan()" value="保存至数据库"></td>
		        									...
		        									<tr>
		        										<td>
		        											<table>
		        												<tr>
		        													<td align="center" class="body-data-title">&nbsp;<INPUT type="checkbox" name="checkall" onclick="javascript:chkall()">序号</td>
					        									        ...
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									            ...
					        									            if(isScannedList!=null&& isScannedList.size()>0){
					        									            	for(int j = 0 ; j < isScannedList.size() ; j++){
							        									            ...
							        									            %>
							        									            <tr <%=onmouseoverstyle%>>
							        													<td align="center" class="body-data-list"><INPUT type="checkbox" value="<%=portConfig.getId()%>" name="checkbox" onclick="javascript:chkall()"><%=row%></td>
