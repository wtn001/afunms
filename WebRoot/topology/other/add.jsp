...
Ext.get("process").on("click",function(){
     ...
     if(chk1)
     {
        ...
        mainForm.action = "<%=rootPath%>/other.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
...
<body id="body" class="body" onload="initmenu();">
	...
	<form id="mainForm" method="post" name="mainForm">
		...
		<table id="body-container" class="body-container">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">资源 >> 其他设备管理 >> 添加</td>
			...
			<TD nowrap width="40%">&nbsp;<input type="text" id="name"  name="name" size="20" class="formStyle"><font color='red'>*</font></TD>															
			...
			<TD nowrap width="40%">&nbsp;<input type="text" id="alias" name="alias" size="20" class="formStyle" ></TD>				
	        </tr>
			<tr style="background-color: #ECECEC;">
