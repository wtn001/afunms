...
<script language="javascript">	
  ...
  var listAction = "<%=rootPath%>/cfgfile.do?action=nodelist&ipaddress=<%=host.getIpAddress()%>";
																				...
																				<table cellPadding=0 cellspacing="0" align=center>
										                							<tr>
										      											<td width="100%" align="left" valign="middle">
										      												<table  cellpadding=0 cellspacing="0" width=80% align=center>
										          													<tr>
										            														<td height="11" align="center">今天的可用率</td>
										          													</tr>
										          													<tr>
																					...
																					<tr>
																						<td width="100%" align="left" valign="middle">
																							<table cellpadding=0 cellspacing="0" width=80% align=center>
										       													<tr>
										         														<td height="11" align="center">CPU利用率</td>
										       													</tr>
										     													<tr>
										       													...
										       													<tr>
										       														<td align=center><a href="<%=rootPath%>/monitor.do?action=hostcpu&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>">查看详情</a>
										       													</td>
										       													</tr>
										     												</table>
										     											</td>
