...
%>
   																		<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> class="microsoftLook">  
    																			...
    																			<td  align='center' style="cursor:hand"><a href="javascript:void(null)" onClick='window.open("<%=rootPath%>/topology/netnodecfgfile/cfgfiledetail.jsp?id=<%=vo.getId()%>","cfgfiledetail", "height=600, width= 800, top=300, left=100")'><%=vo.getName()%></a></td>
