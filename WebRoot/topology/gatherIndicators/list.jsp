														...
														<td>
															<table>
																<tr>
																	...
																	<td class="body-data-title" style="text-align: right;">
																		<a href="#"
																			onclick="window.open('<%=rootPath%>/nodeGatherIndicators.do?action=list&nodeid=173&type=db&subtype=Oracle')">设备采集指标列表</a>&nbsp;&nbsp;&nbsp;
																...
																<tr>
																	<td class="body-data-list">
																		<INPUT type="checkbox" name="checkbox"
																			value="<%=gatherIndicators.getId()%>"><%=jp.getStartRow() + i%></td>
