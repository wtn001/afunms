...
<input type=hidden name="radio" value="<%=id%>">
			...
			<TD nowrap width="80%">
			   &nbsp; <input type="hidden" name="link_name" size="30" class="formStyle" value="<%=link_name%>" >
			   <input type="text" name="link_alias_name" size="30" class="formStyle" value="<%=linkAliasName%>">
			</TD>
			</tr>
			<!--  
			<tr>						
