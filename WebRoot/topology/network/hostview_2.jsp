...
function pingReportByMinute(){
  ...
  function responseTimeReportByMinute(){
	window.open("<%=rootPath%>/monitor.do?action=hostresponsetime_report&id=<%=tmp%>&timeType=minute","newWindow","height=300, width=800, top=0, left= 200,screenX=0,screenY=0");
  }
