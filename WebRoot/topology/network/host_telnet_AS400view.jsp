...
function setClass(){
	document.getElementById('AS400DetailTitle-0').className='detail-data-title';
	document.getElementById('AS400DetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('AS400DetailTitle-0').onmouseout="this.className='detail-data-title'";
}
