	...
	<tr>
		...
		<td>
			<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none align=center border=1 algin="center">
				<tr>
					<td height="28" align="left" bordercolor="#397DBD" bgcolor="#397DBD" class="txtGlobalBold" colspan=4>&nbsp;&nbsp;<font color=#ffffff>倒入设备 >> 修改个人设置</font></td>
				</tr>
				<tr>					
...
<tr>
  ...
  <td><font color="#008000"><b><%=okstr%></b></font>&nbsp;&nbsp;</td>
</tr>
</table>						
					</td>
				</tr>
