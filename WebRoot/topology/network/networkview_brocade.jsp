...
<%@page import="com.afunms.application.model.BrocadeInterface"%>
...
<%
	...
	System.out.println("nodedto=="+nodedto.getSubtype());
   	String ipaddress = host.getIpAddress();
	...
	Hashtable ipAllData = (Hashtable)ShareData.getSharedata().get(host.getIpAddress());
	if(ipAllData != null){
		if(ipAllData.containsKey("interfaceList")){
			interfaceList = (ArrayList)ipAllData.get("interfaceList");
		}
	}
...
<!-- 右键菜单结束-->
  ...
  <tr align="center"> 
    <td width="6%" align="center">索引</td>
    <td width="9%" align="center">描述</td>
    <td width="9%" align="center">传输方式</td>
    <td width="9%" align="center">状态</td>
    <td width="11%" align="center">TxWords</td><!--TxWords-->
    <td width="9%" align="center">RxWords</td>
  <!--    <td colspan="2" height="23" align="center">广播数据包</td>
    <td colspan="2" height="23" align="center">多播数据包</td>  --> 
    <td  width="9%" align="center">TxFrames</td>
    <td  width="9%" align="center">RxFrames</td>
     
    <!--<td rowspan="2" width="9%" align="center">查看相关</td>-->
  </tr>
             <%
             	for(int i=0; i<interfaceList.size(); i++){
             	BrocadeInterface brocadeInterface = (BrocadeInterface)interfaceList.get(i);
             	String status = brocadeInterface.getSwFCPortOpStatus();
             	String url = "";
                 if(status.equals("up")){
            ...
            <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> height=25>
            	<td align="center" class="detail-data-body-list"><%=brocadeInterface.getSwFCPortIndex() %></td>
            	<td align="center" class="detail-data-body-list"><%=brocadeInterface.getSwFCPortIndex() %></td>
            	<td align="center" class="detail-data-body-list"><%=brocadeInterface.getSwFCPortTxType() %></td>
            	<td align="center" class="detail-data-body-list"><img src="<%=url%>"></td>
            	<td align="center" class="detail-data-body-list"><%=brocadeInterface.getSwFCPortTxWordsNum() %></td>
            	<td align="center" class="detail-data-body-list"><%=brocadeInterface.getSwFCPortRxWordsNum() %></td>
            	<td align="center" class="detail-data-body-list"><%=brocadeInterface.getSwFCPortTxFramesNum() %></td>
            	<td align="center" class="detail-data-body-list"><%=brocadeInterface.getSwFCPortRxFramesNum() %></td>
            </tr>
