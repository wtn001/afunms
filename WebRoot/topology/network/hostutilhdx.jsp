...
<table border="0" id="table1" cellpadding="0" cellspacing="0" width=100%>
					...
					<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				...
                  				<tr>
            							...
            							<table width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<div align="center"><a href="<%=rootPath%>/detail/dispatcher.jsp?id=<%=tmp%>"><font color="#397dbd">连通率</font></a></div></td>
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian.gif">
											<div align="center"><a href="<%=rootPath%>/detail/hostutilhdx.jsp?id=<%=tmp%>"><font color="#FFFFFF">流速信息</font></a></div></td>
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
  ...
  <!-- 
    ...
    &nbsp;<img src="<%=rootPath%>/resource/image/status.gif" border="0" width=15 oncontextmenu=showMenu('2','<%=index%>','<%=ifname%>')>
