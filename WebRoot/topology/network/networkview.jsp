...
function modifyIpAliasajax(ipaddress){
	...
	$.ajax({
			...
			success:function(data){
				document.getElementById("ipalias_main").innerText  = ipalias;
				window.alert("修改成功！");
			}
		});
}
...
function setClass(){
	document.getElementById('netDetailTitle-44').className='detail-data-title';
	document.getElementById('netDetailTitle-44').onmouseover="this.className='detail-data-title'";
	document.getElementById('netDetailTitle-44').onmouseout="this.className='detail-data-title'";
}
