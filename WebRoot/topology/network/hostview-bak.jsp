...
<div id="itemMenu" style="display: none";>
										               					...
										               					<tr>
										     								<td width="70%" align="left" valign="top">
										     									<table cellpadding="0" cellspacing="0" width=100% align=center>
										       										...
										       										<tr>
										       											<td height="29" align="left">&nbsp;子网掩码:</td>
										       											<td><%=host.getNetMask()%></td>
										       										</tr>
										       										<tr bgcolor="#F1F1F1">
										       											<td width="30%" height="26" align=left>&nbsp;类别:</td>
										                							...
										                							<tr>
																						...
																						<strong>You need to upgrade your Flash Player</strong>	
																							...
																							so.write("flashcontent00");
										         													...
										         													<tr>
										           														<td height="7">&nbsp;&nbsp;<img src="<%=rootPath%>/resource/image/Loading_2.gif"></td>
										         													</tr>
										     												</table>				
																						</td>
																					</tr>
  ...
  <tr align="center"> 
    ...
    <td rowspan="2"  align="center" align="center">查看详情</td>
  ...
  <!-- 
    ...
    -->
    <td   align="center" width="15%"><input type=button  name="button3" styleClass="button" value="出口流速" onclick="changeOrder('OutBandwidthUtilHdx')"></td>
    <td  align="center"  width="15%"><input type=button  name="button4" styleClass="button" value="入口流速" onclick="changeOrder('InBandwidthUtilHdx')"></td>
  </tr>
             <%
