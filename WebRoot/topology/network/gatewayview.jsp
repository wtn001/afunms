...
<%
	...
	System.out.println("=======112fffffffffffff11111111=========="+realValue+":"+avgin+":"+maxin+":"+curout+":"+avgout+":"+maxout);
	...
	System.out.println("=======112aaaaaaaaaaaaaaaaa11111111==========");
%>
<html>
	<head>
...
function setClass(){
	document.getElementById('gatewayDetailTitle-0').className='detail-data-title';
	document.getElementById('gatewayDetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('gatewayDetailTitle-0').onmouseout="this.className='detail-data-title'";
}
