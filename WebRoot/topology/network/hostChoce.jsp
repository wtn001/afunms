...
<script language="JavaScript" type="text/JavaScript">
 function query(){
	...
	var bidnum = document.getElementsByName("checkbox").length;
 	...
 	if(oids != 0)
 	{
 	 	mainForm.action = "<%=rootPath%>/network.do?action=hostchocereport&startdate="+startdate+"&todate="+todate+"&ids="+oids, "newwindow", "height=500, width=600, toolbar= no, menubar=no, scrollbars=yes, resizable=yes, location=yes, status=yes"   	      
 	 mainForm.submit();
 	}
 	else{
 	alert("请选择设备");
...
function setClass(){
	document.getElementById('compareDetailTitle-1').className='detail-data-title';
	document.getElementById('compareDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('compareDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
								...
								<table id="container-main-report" class="container-main-report">
									<tr>
										<td>
									    	...
									    	<td  class="report-data-body-title">&nbsp;&nbsp;<INPUT type="checkbox" class=noborder name="checkall" onclick="javascript:chkall()">序号</td>
									        <td  class="report-data-body-title"><strong>IP地址</strong></td>
									        <td  class="report-data-body-title"><strong>设备名称</strong></td>
									    	<td  class="report-data-body-title"><strong>操作系统</strong></td>
									   </tr>
									<%
									    	HostNode node = null;
