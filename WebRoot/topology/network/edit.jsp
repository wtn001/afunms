...
String tran1="";
String tran2="";
int version=vo.getSnmpversion();
int transfer=vo.getTransfer();
		...
		<table id="body-container" class="body-container">
			...
			<tr id='collectversion'>						
							...
							<select size=1  style='width:100px;' id='snmpversion' name='snmpversion'>
            						<option value='0' <%=v1 %>>V1</option>
            						<option value='1' <%=v2 %>>V2</option>
							...
							<select size=1 name='transfer' id='transfer' style='width:100px;'>
								            <option value='0'<%=tran1 %>>无</option>
            								<option value='1'<%=tran2 %>>上一级</option>
				...
				<tr>						
							...
							<TD nowrap width="40%" align="left">&nbsp;
							<input type="text" name="assetid" id="assetid" maxlength="50" size="20" class="formStyle" value="<%=vo.getAssetid()%>">
							</TD>
							<TD nowrap align="right" height="24" width="10%">设置机房位置&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
							<input type="text" name="location" id="location" maxlength="50" size="20" class="formStyle" value="<%=vo.getLocation()%>">
							</TD>															
						</tr>
			<!-- snow modify end -->
