		...
		while(l--){
			if(formElms[l].type=="radio"){
				...
				if(radio.name == "radio" && radio.checked==true){
	 				nodeid=radio.value;
	 				nodename = radio.parentNode.parentNode.childNodes[1].innerText;
	 				nodedescr = radio.parentNode.parentNode.childNodes[2].innerText;
 				}
			}
		}
		var pnodename = parent.opener.document.getElementById("nodename");
		var pnodeid = parent.opener.document.getElementById("nodeid");
		var pnodedescr = parent.opener.document.getElementById("nodedescr");
 		pnodename.value=nodename;
 		pnodeid.value=nodeid;
 		pnodedescr.value=nodedescr;
		window.close();
	}	 
</script>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">选择设备</td>
							  ...
							  <td style="align:center">
							  		<table style="width:50%;align:center">
							  			<tr bgcolor=gray>
							  				...
							  				<td class="report-data-body-title" width=60% bgcolor=gray>名称</td>
							  				<td class="report-data-body-title" width=20% bgcolor=gray>别名</td>
							  				<td class="report-data-body-title" width=20% bgcolor=gray>ip地址</td>
							  			</tr>
							  			<%
							  				for(int i=0;i<nodelist.size();i++)
							  				{
							  					HostNode vo = (HostNode)nodelist.get(i);
							  					if(i%2==0){
							  			%>
							  			<tr>
							  				<td class="report-data-body-list" height="20" bgcolor=#C0C0C0 align=center><input type=radio name=radio value='<%=vo.getId()%>' class=noborder ></td>
							  				<td class="report-data-body-list" height="20" bgcolor=#C0C0C0 align=center><%=vo.getAlias()%></td>
							  				<td class="report-data-body-list" height="20" bgcolor=#C0C0C0 align=center><%=vo.getSysName()%></td>
							  			...
							  			%>		
							  			<tr>
							  				<td class="report-data-body-list" height="20" align=center><input type=radio name=radio value='<%=vo.getId()%>' class=noborder ></td>
							  				<td class="report-data-body-list" height="20" align=center><%=vo.getAlias()%></td>
							  				<td class="report-data-body-list" height="20" align=center><%=vo.getSysName()%></td>
