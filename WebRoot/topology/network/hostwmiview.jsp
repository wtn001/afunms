...
function setClass(){
	document.getElementById('windowsDetailTitle-0').className='detail-data-title';
	document.getElementById('windowsDetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('windowsDetailTitle-0').onmouseout="this.className='detail-data-title'";
}
																...
																<td>
																	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ECECEC">
																		<tr align="center">
																			...
																			<td rowspan="2" align="center" align="center">
																				查看详情
																			</td>
																		</tr>
																		<tr>
