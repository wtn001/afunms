...
function setClass(){
	document.getElementById('firewallDetailTitle-10').className='detail-data-title';
	document.getElementById('firewallDetailTitle-10').onmouseover="this.className='detail-data-title'";
	document.getElementById('firewallDetailTitle-10').onmouseout="this.className='detail-data-title'";
}
...
<!-- 右键菜单结束-->
	<form id="mainForm" method="post" name="mainForm">
   	...
   	<tr>
										<td>
											<jsp:include page="/topology/includejsp/systeminfo_firewall.jsp">
