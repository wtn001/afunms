...
<%
	...
	//String[] diskItemch={"总容量","已用容量","利用率","繁忙","读KByte/s","写KByte/s"};
              ...
              <tr> 
                ...
                <table width="100%" height="1" border="0" cellpadding="0" cellspacing="0">
                    <tr align="left" bgcolor="#ECECEC"> 
                      <td width="90%" height="23">&nbsp;<b>文件系统利用率</b>
                        </td>
                    </tr>
                    <tr> 
                      <td><i> 
              ...
              <br>
                <table width="90%" cellpadding="0" cellspacing="0" style="text-align:center;">
                  <tr lign="center" height="28" style="background-color:#EEEEEE;"> 
                    <td width="20%"  class="detail-data-body-title">文件系统名</td>
            	  <% 
      ...
      <% } %>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <table width="100%" height="1" border="0" cellpadding="0" cellspacing="0">
                    <tr align="left" bgcolor="#ECECEC"> 
                      <td width="90%" height="23">&nbsp;<b>磁盘信息</b>
                        </td>
                    </tr>
            	    <tr> 
              		<td width="100%" align="center"> 
              		<br>
                		<table width="90%" cellpadding="0" cellspacing="0" style="text-align:center;">
                  			...
                  			<tr lign="center" height="28"  class="detail-data-body-title"> 
                    				<td width="10%"  class="detail-data-body-title">磁盘名</td>
                    				<td width="10%"  class="detail-data-body-title">繁忙(%)</td>
                    				<td width="10%"  class="detail-data-body-title">传输字节/秒</td>
                    				<td width="10%"  class="detail-data-body-title">读字节/秒</td>
                    				<td width="10%"  class="detail-data-body-title">写字节/秒</td>
                    				<td width="10%"  class="detail-data-body-title">平均请求队列</td>
                    				<td width="10%"  class="detail-data-body-title">平均服务队列</td>
                    				<td width="10%"  class="detail-data-body-title">等待时间(s)</td>
                    				<td width="10%"  class="detail-data-body-title">服务时间(s)</td>
                    				<td width="10%"  class="detail-data-body-title">CPU占用(%)</td>
                  			</tr>
