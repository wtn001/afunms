...
<script language="javascript">	
  ...
  var delAction = "<%=rootPath%>/network.do?action=cancelmanage";
        						...
        						<TR>
        							<TD width="50%"><B>查询:</B>
        								<SELECT name="key" style="width=100"> 
          								...
          								&nbsp;&nbsp;<b>展示样式 [<a href="<%=rootPath%>/network.do?action=monitornodelist&jp=1"><font color="#397DBD">列表</font></a> <a href="<%=rootPath%>/jianshi/list.jsp"><font color="#397DBD">图形</font></a>]</b>
          							</td>            
								<td width="50%" align='right'>
								
									<a href="#" onclick="toAdd()">添加</a>
									<a href="#" onclick="doCancelManage()">删除</a>&nbsp;&nbsp;&nbsp;
		  						</td>                       
        						</tr>
