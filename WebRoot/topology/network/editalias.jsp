				        										...
				        										<td>
				        												...
				        												<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
																			...
																			<tr > 
																				...
																				<input type="text" id="sendmobiles" name="sendmobiles" maxlength="32" size="50" value="<%=sendmobiles%>" onclick="setReceiver('sendmobiles')" readonly="readonly">&nbsp;&nbsp;<input type=button value="设置短信接收人" onclick="setReceiver('sendmobiles')"> 
																				</td>
													 						</tr>
													    						<tr style="background-color: #ECECEC;"> 
													  							<TD nowrap align="right" height="24" width="10%">邮件接收人&nbsp;</TD>       
																				<TD nowrap width="40%" colspan=3>&nbsp;
																				<input type="text" id="sendemail" name="sendemail" maxlength="32" size="50" value="<%=vo.getSendemail()%>" onclick="setReceiver('sendemail')" readonly="readonly">&nbsp;&nbsp;<input type=button value="设置邮件接收人" onclick="setReceiver('sendemail')">
																				</td>
													 						</tr> 
																			<tr>						
																			<tr>
