                								...
                								<td width="426" align="left" valign="top" class=dashLeft>
													...
													<td colspan="4" align='center'>
														<div id="msg" style="display:none"><img src="<%=rootPath%>/js/ext/lib/resources/extanim64.gif" width="32" height="32" style="margin-right: 8px;" align="middle" /><font color="#FF0000">正在执行,请稍候...</font></div>
                    										...
                    										<tr bgcolor="#F1F1F1">
                      											<td height="29" class=txtGlobal align="left" nowrap bgcolor="#EBF4F7" >&nbsp;版本:</td>
                      											<td><%=CSDVersion%></td>
                    										</tr>
                    										<tr>
					...
					<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				...
                  				<tr>
            							...
            							<table width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<div align="center"><a href="<%=rootPath%>/detail/dispatcher.jsp?id=net<%=tmp%>"><font color="#FFFFFF">连通率</font></a></div></td>
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
											<div align="center"><a href="<%=rootPath%>/detail/host_linuxutilhdx.jsp?id=<%=tmp%>"><font color="#397dbd">流速信息</font></a></div></td>
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
										...
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
											<div align="center"><a href="<%=rootPath%>/monitor.do?action=hostconfig&id=<%=tmp%>&ipaddress=<%=host.getIpAddress()%>"><font color="#397dbd">配置信息</font></a></div></td>
										<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
                ...
                <table width="1" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      ...
                      <!--
                        ...
                        -->
                        &gt;&gt;<a style="cursor:hand"  onclick="reportByMinute();"><font color="#FFFFFF">查看日报表</font></a>
                        &gt;&gt;<a style="cursor:hand"  onclick="reportByMinute()"><font color="#FFFFFF">查看月报表</font></a></font></b>
                        </td>
                    ...
                    <tr> 
                      <td colspan=2><i> 
                        <table width="742" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC" align=center><img src='<%=rootPath%>/<%=imgurl.get("ConnectUtilization").toString()%>?temp=<%=Math.random()%>'></td>
                          </tr>
                        </table>
                        </i></td>
                    </tr>
                  ...
                  <table width="1" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td width="450" height="23" background="images/yemian_16.gif">&nbsp;<b><font color="#FFFFFF">响应时间 
                        &gt;&gt;<a style="cursor:hand"  onclick="responseTimeReportByMinute();"><font color="#FFFFFF">查看日报表</font></a>
                        &gt;&gt;<a style="cursor:hand"  onclick="responseTimeReportByMinute();"><font color="#FFFFFF">查看月报表</font></a></font></b>
                        </td>
                      <td width="300" height="23" background="images/yemian_16.gif" align=right>
                      <font color="#FFFFFF"> 
                        &nbsp;&nbsp;平均:<%=str2%>&nbsp;</font>
                    ...
                    <tr> 
                      <td colspan=2><i> 
                        <table width="742" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC" align=center><img src="<%=rootPath%>/<%=imgurl.get("ResponseTime").toString()%>"></td>
                          </tr>
