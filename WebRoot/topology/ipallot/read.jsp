								...
								<td>
									<table id="content-header" class="content-header">
										<tr>
											...
											<td class="content-title">资源 >> IP/MAC资源 >> IP分配统计 >> ip分配信息</td>
									...
									<td align="center">
										<table cellspacing=5 cellpadding=1>
											<tr>
												...
												<td width=40><font color='blue'>未分配</font></td>
											...
											<tr style="background-color: #FFFFFF;">
												<%
													...
													for (int i = 0; i < 255; i++) {
														...
														if (i % tmp != 0) {
												%>
												<td align="center" class="detail-content-body" style="background-color: <%=ys%>;"><%=i%></td>
												<%
													} else {
												%>
											<tr style="background-color: #FFFFFF;">
