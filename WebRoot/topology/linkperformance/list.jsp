...
<%
	String rootPath = request.getContextPath();
  	...
  	if(nameStyle == null || nameStyle.equals("null") || nameStyle.equals("")) {
  		nameStyle = "ipAndPort";
  	}
															...
															<table>
					        									<tr>
		        													...
		        													<input type="hidden" id="sorttype" name="sorttype" value="<%=sorttype%>">
			       													<td align="center" class="body-data-title" style="width:50px;"><INPUT type="checkbox" id="checkall" name="checkall"  onclick="javascript:chkall()">序号</td>
			       													<td align="center" class="body-data-title"><a href="#" onclick="showSort('name')">名称<%=nameImg%></a>
			       														<select name="nameStyle" style="width:100px;" id="nameStyle" onchange="javascript:changeNameStyle();">
																			<option value="ipAndPort" 
																			<%if(nameStyle.equals("ipAndPort")) {
																				%>
																				selected="selected"
																			<%} %>
																			>设备ip格式</option>
																			<option value="nameAndPort"
					        										...
					        										if(list != null && list.size() > 0){
					        											for(int i = 0; i < list.size() ; i++){
					        												...
					        												<tr <%=onmouseoverstyle%>>
						       													...
						       													<td align="center" class="body-data-list"> <%=(linkPerformanceDTO.getName()) == null ? "--" : linkPerformanceDTO.getName() %></td>
						       													<td align="center" class="body-data-list"><%=linkPerformanceDTO.getStartNode() == null ? "--" : linkPerformanceDTO.getStartNode() %></td>
						       													<td align="center" class="body-data-list"><%=linkPerformanceDTO.getStratIndex() == null ? "--" : linkPerformanceDTO.getStratIndex() %></td>
						       													<td align="center" class="body-data-list"><%=linkPerformanceDTO.getEndNode() == null ? "--" : linkPerformanceDTO.getEndNode() %></td>
						       													<td align="center" class="body-data-list"><%=linkPerformanceDTO.getEndIndex() == null ? "--" : linkPerformanceDTO.getEndIndex() %></td>
						       													<td align="center" class="body-data-list">
						       														<table>
													                      				<tr>
													                      					<td align="center" width="50%"><%=linkPerformanceDTO.getUplinkSpeed() == null ? "--" : linkPerformanceDTO.getUplinkSpeed() %></td>
						       													...
						       													<td align="center" class="body-data-list">
						       														<table>
													                      				<tr>
													                      					<td align="center" width="50%"><%=linkPerformanceDTO.getDownlinkSpeed() == null ? "--" : linkPerformanceDTO.getDownlinkSpeed() %></td>
													                      					<td align="center" width="50%"><img src="<%=rootPath%>/resource/image/a_xn.gif" onclick='showDetail("<%=linkPerformanceDTO.getId()%>" )' width=15></td>
													                      				</tr>
												                      				</table>
												                      			</td>
						       													<td align="center" class="body-data-list">
						       														<table>
													                      				<tr>
													                      					<td align="center" width="50%"><%=linkPerformanceDTO.getPingValue() == null ? "--" : linkPerformanceDTO.getPingValue() %></td>
													                      					<td align="center" width="50%"><img src="<%=rootPath%>/resource/image/a_xn.gif" onclick='showDetail("<%=linkPerformanceDTO.getId()%>")' width=15></td>
													                      				</tr>
												                      				</table>
												                      			</td>
						       													<td align="center" class="body-data-list">
						       														<table>
													                      				<tr>
													                      					<td align="center" width="50%"><%=linkPerformanceDTO.getAllSpeedRate() == null ? "0" : linkPerformanceDTO.getAllSpeedRate() %></td>
													                      					<td align="center" width="50%"><img src="<%=rootPath%>/resource/image/a_xn.gif" onclick='showDetail("<%=linkPerformanceDTO.getId()%>")' width=15></td>
													                      				</tr>
												                      				</table>
												                      			</td>
