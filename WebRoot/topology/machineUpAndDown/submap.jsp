...
<frameset id="parentFrame" rows="35,*" frameborder="no" border="0" framespacing="0">
<frame src="<%=rootPath%>/topology/machineUpAndDown/topFrame.jsp?fullscreen=<%=fullScreen%>&xml=<%=fileName%>" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" title="工具栏" />
<frame src="<%=rootPath%>/topology/machineUpAndDown/showMap.jsp?fullscreen=<%=fullScreen%>&xml=<%=fileName%>" name="mainFrame" scrolling="No" noresize="noresize" id="mainFrame" title="应急关机视图" />
</frameset>
</html>