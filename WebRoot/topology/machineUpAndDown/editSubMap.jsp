				...
				<td height=250 bgcolor="#FFFFFF" valign="top">
				 <table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%" align="center">
					<TBODY>
			           ...
			           <tr>						
			                <TD style="background-color: #ECECEC;" nowrap align="right" height="24" width="20%">&nbsp;链路流速对比值</TD>				
			                <TD nowrap width="80%">
			                 &nbsp; <input type="text" name="utilhdx" size="30" class="formStyle" value="<%=vo.getUtilhdx()%>">&nbsp;
			               </TD>
			            </tr>
			            <tr>						
			                <TD style="background-color: #ECECEC;" nowrap align="right" height="24" width="20%">&nbsp;链路带宽对比值</TD>				
			                <TD nowrap width="80%">
