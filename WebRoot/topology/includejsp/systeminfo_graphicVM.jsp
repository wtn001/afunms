...
<%
	...
	String valueStr = request.getParameter("valueStr") == null ? "": request.getParameter("valueStr"); 
	//avgresponse="8889"; 
	...
	//	CreateMetersPic cmp = new CreateMetersPic();
	//	String path = ResourceCenter.getInstance().getSysPath()+ "resource\\image\\dashBoard1.png";
	//	cmp.createPic(picip, new Double(valueStr.replaceAll("%", "")), path,"1234", "avgpmemory");
	//	cmp.createChartByParam(picip , pingavg , pathPing,"连通率","pingdata"); 
//	}
			...
			<table  align=center  cellpadding=0 cellspacing="0" width=100%>
				...
				<div id="hostdisk"></div>
				 <script type="text/javascript">
	                                          ...
	                                          var so = new SWFObject("<%=rootPath%>/amchart/amcolumn.swf", "amcolumn","350", "210", "8", "#FFFFFF");
				                                  so.addVariable("path", "<%=rootPath%>/amchart/");
				                                  so.addVariable("settings_file", escape("<%=rootPath%>/amcharts_settings/VMWare_settings.xml"));
