...
<%
	...
	String  curconnectstr= request.getParameter("curconnectstr")==null?"":request.getParameter("curconnectstr"); //  
  ...
  String myip = vo.getIpAddress();  
	...
	if(orasys != null ){
		if(orasys.containsKey("CREATED_TIME"))created = (String)orasys.get("CREATED_TIME");
	}
	String stat= (String)orasys.get("STATUS");
	 //sqlserver 各种命中率图
                                 ...
                                 <!--  
									...
									-->
										<tr bgcolor="#F1F1F1">
											...
											<td width="35%" nowrap align="left"><%=opencurstr%>
											</td> 
											<td height="29" width=15%>
															&nbsp;当前会话数
											</td>
											<td width="35%" nowrap align="left"><%=curconnectstr%>
											</td>
										</tr>
										<%
											}
