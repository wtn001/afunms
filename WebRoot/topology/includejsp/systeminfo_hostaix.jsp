...
<%
	...
	try {
	    ...
	    String temp=aixColumnPic.getAmMemoryChartStr(host.getIpAddress(),memhash);
 								...
 								<td width="50%" align="left" valign="top">
									<table>
										...
										<tr bgcolor="#F1F1F1">
											...
											<td background="<%=rootPath%>/resource/<%=NodeHelper.getCurrentStatusImage(alarmlevel)%>" class="performance-status"><%=NodeHelper.getStatusDescr(alarmlevel)%></td>
										</tr>
			   							<tr >
