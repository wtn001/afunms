...
function backup()
{
	mainForm.action = "<%=rootPath%>/storey.do?action=backup";
    mainForm.submit();
    alert("备份成功!");
	window.close();
}
				...
				<tr>
					<td height="28" align="left" colspan=3>
										                	...
										                	<tr>
											                	...
											                	<td class="add-content-title">>> 备份视图 </td>
				    ...
				    <td valign="top">
	                   ...
	                   <table bgcolor="#efefef" cellSpacing="1" cellPadding="0" width="100%" border="0">
			               ...
			               <table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
    	                       ...
    	                       <td  align='center'><INPUT type="checkbox" class=noborder name=radio value="<%=vo.getIntId()%>" class=noborder ><font color='blue'><%=i+1%></font></td>    	 	
    	                       <td  align='center'><%=vo.getStoreyName()%></td>			
	                           </tr>
								<%
								    }
								    }
