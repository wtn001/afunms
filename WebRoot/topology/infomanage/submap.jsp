...
<frame src="<%=rootPath%>/topology/infomanage/topFrame.jsp?fullscreen=<%=fullScreen%>" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" title="工具栏" />
<frame src="<%=rootPath%>/topology/infomanage/showMap.jsp?fullscreen=<%=fullScreen%>" name="mainFrame" scrolling="No" noresize="noresize" id="mainFrame" title="楼层视图" />
</frameset>
</html>