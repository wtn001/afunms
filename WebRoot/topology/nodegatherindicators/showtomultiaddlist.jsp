	...
	<head>
		...
		<script language="JavaScript">
			...
			*/
			...
			function toSave()
  			{
      				mainForm.action = "<%=rootPath%>/nodeGatherIndicators.do?action=multiadd";
      				mainForm.submit();
  			}
  			
  			function toSave2()
  			{
      				mainForm.action = "<%=rootPath%>/nodeGatherIndicators.do?action=multisupplement";
      				mainForm.submit();
  			}
  			  function toMultiAdd()
  			{
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 资源 >> 采集指标一览表 >> 采集指标批量应用列表 </td>
															...
															<table>
							        							...
							        							<%
							        								...
							        								<tr>
																			...
																			<input type="button" value="补充设置" style="width:80" onclick="toSave2()">&nbsp;&nbsp;
																			<input type="button" value="当前设置" style="width:80" onclick="toSave()">&nbsp;&nbsp;
