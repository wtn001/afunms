...
<html>
	<head>
	  ...
	  function save()
	  {
	      mainForm.action = "<%=rootPath%>/nodeGatherIndicators.do?action=showChooseNodeList";
	      mainForm.submit();
	  }
							        							...
							        							<%
							        								if("multi".equals(jspFlag)){
							        									...
							        									for(int i = 0; i < nodeGatherIndicatorsList.size(); i++){
							        										NodeGatherIndicators nodeGatherIndicators = (NodeGatherIndicators)nodeGatherIndicatorsList.get(i);
							        										
							        										String dis = "";
							        										//if("multi".equals(jspFlag)){
							        										//	if(moidhash.containsKey(gatherIndicators.getName())){
							        										//	dis = "disabled";
							        										//}
							        										//}
							        										...
							        										<tr>
																    			...
																    			<td class="body-data-list" width=30% align=left>&nbsp;<%=nodeGatherIndicators.getDescription()%></td>
										        							</tr>
							        										<%
							        										}
							        									...
							        									for(int i = 0; i < gatherIndicatorsList.size(); i++){
							        										GatherIndicators gatherIndicators = (GatherIndicators)gatherIndicatorsList.get(i);
							        										...
							        										<tr>
							        											<td class="body-data-list" width=30% align=right><input type=checkbox name="checkbox" value="<%=gatherIndicators.getId()%>" <%=dis%>>&nbsp;</td>
																    			<td class="body-data-list" width=40% align=left><%=gatherIndicators.getName()%></td>
																    			<td class="body-data-list" width=30% align=left>&nbsp;<%=gatherIndicators.getDescription()%></td>
										        							</tr>
							        										<%
							        										}
