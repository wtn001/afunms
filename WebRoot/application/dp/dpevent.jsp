...
function setClass(){
	document.getElementById('dpDetailTitle-1').className='detail-data-title';
	document.getElementById('dpDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('dpDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
