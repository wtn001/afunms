...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk3 = checkinput("community","string","团体名称",30,false);
     ...
     if(chk1&&chk2&&chk3)
     {
        ...
        mainForm.action = "<%=rootPath%>/domino.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> Domino添加</td>
						...
						<tr>					
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="ipaddress" name="ipaddress" maxlength="50" size="50" class="formStyle" >
							</TD>
							<TD nowrap align="right" height="24" width="10%">团体名称&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="community" name="community" maxlength="50" size="20" class="formStyle" >
							</TD>
						</tr>
						<tr style="background-color: #ECECEC;">					
