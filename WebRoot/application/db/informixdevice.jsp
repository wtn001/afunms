...
String createtime="";
if(dbinfo!=null){
     dbconfig = (ArrayList)dbinfo.get("configList");//数据库配置信息
...
function setClass(){
	document.getElementById('inforDetailTitle-2').className='detail-data-title';
	document.getElementById('inforDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('inforDetailTitle-2').onmouseout="this.className='detail-data-title'";
}
											...
											<td>
												<table id="application-detail-data"
													...
													<tr>
														...
														<td align=center>
															<table class="application-detail-data-body" align=center>
																<tr>
																	<td align=center>
																		<table width="100%" border="0" cellpadding="0"
																			...
																			<tr>
																				<td width="100%">
																					...
																					<script type="text/javascript">
																	            var so = new SWFObject("<%=rootPath%>/flex/Informix_Grid_List.swf?ipadress=<%=vo.getIpAddress()%>&name=<%=vo.getDbName()%>", "Informix_Grid_List", "800", "500", "8", "#ffffff");
