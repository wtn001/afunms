...
Hashtable userinfo_h = (Hashtable)request.getAttribute("userinfo_h");
...
function setClass(){
	document.getElementById('oraDetailTitle-7').className='detail-data-title';
	document.getElementById('oraDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
