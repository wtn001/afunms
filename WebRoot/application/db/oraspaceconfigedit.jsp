...
<%
  ...
  Oraspaceconfig vo = (Oraspaceconfig)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
    ...
    var chk1 = checkinput("alarmvalue","string","告警值",30,false);
     ...
     if(chk1)
     {
        mainForm.action = "<%=rootPath%>/oraspace.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
					...
					<table id="container-main" class="container-main">
						<tr>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 数据库管理 >> ORACLE数据库阀值设置</td>
		    				...
		    				<td nowrap align="left">
		    					<input type="text" name="ipaddress1" maxlength="50" size="20" value="<%=ips[0]+"."+ips[1]+"."+ips[2]+"."+ips[3]+":"+sid%>" readonly="readonly">
		    					<input type="hidden" name="ipaddress"value="<%=vo.getIpaddress()%>" readonly="readonly">
		    				</td>
 	      					<td nowrap align=right>
		      					表空间名称
		      				</td>
		    				<td nowrap align="left">
		     					<input type="text" name="spacename" maxlength="50" size="20" value="<%=vo.getSpacename()%>" readonly="readonly">
		    				</td>		    		    	    
 						</tr> 
		    				<tr height=28> 	    
		    				<td nowrap align=right>
