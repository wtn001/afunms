...
<%
		...
		String mysid = "";
		String dbPage = "informixwaitingthread";
...
function setClass(){
	document.getElementById('inforDetailTitle-6').className='detail-data-title';
	document.getElementById('inforDetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('inforDetailTitle-6').onmouseout="this.className='detail-data-title'";
}
																					...
																					<table width="90%" border="0" cellpadding="3"
																						...
																						<tr bgcolor="397dbd" height=25>
																							<td class="application-detail-data-body-title" colspan="7">
																								<pre style="text-align: left;">tid     tcb         rstcb           prty   status            vp-class   name</pre>
																							</td>
																						</tr>
																						<%
																							List<String> waitingThreads = (ArrayList)informixOtherData.get("waitingThreads");
																							for(int i=0; i<waitingThreads.size(); i++){
																							
																						 %>
																						<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>
																							height=28>
																							<td class="application-detail-data-body-list" colspan="7" align="left"><pre><%=waitingThreads.get(i)%></pre></td>
																						</tr>
																						<%
																							}
																						 %>
