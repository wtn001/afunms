...
Hashtable allDb2Data = (Hashtable)ShareData.getAlldb2data();
	...
	String Lock_Timeouts = "";
	String Lock_waits = "";
	String Lock_escalations = "";
	String e_Lock_escalations = "";
	String Deadlocks_detected = "";
	String Lock_waits_Times = "";
	String Locks_held_currently = "";
	if(ipAllData!=null){
	    Lock_Timeouts = (String)ipAllData.get("Lock_Timeouts");
	    Lock_waits = (String)ipAllData.get("Lock_waits");
	    Lock_escalations = (String)ipAllData.get("Lock_escalations");
	    e_Lock_escalations = (String)ipAllData.get("e_Lock_escalations");
	    Deadlocks_detected = (String)ipAllData.get("Deadlocks_detected");
	    Lock_waits_Times = (String)ipAllData.get("Lock_waits_Times");
	    Locks_held_currently = (String)ipAllData.get("Locks_held_currently");
	}
	if(Lock_Timeouts == null || Lock_Timeouts.equals("")){
	          Lock_Timeouts = "";
	}
	if(Lock_waits == null || Lock_waits.equals("")){
	          Lock_waits = "";
	}
	if(Lock_escalations == null || Lock_escalations.equals("")){
	          Lock_escalations = "";
	}
	if(e_Lock_escalations == null || e_Lock_escalations.equals("")){
	          e_Lock_escalations = "";
	}
	if(Deadlocks_detected == null || Deadlocks_detected.equals("")){
	          Deadlocks_detected = "";
	}
	if(Lock_waits_Times == null || Lock_waits_Times.equals("")){
	          Lock_waits_Times = "";
	}
	if(Locks_held_currently == null || Locks_held_currently.equals("")){
	          Locks_held_currently = "";
	}
...
function setClass(){
	document.getElementById('db2DetailTitle-3').className='detail-data-title';
	document.getElementById('db2DetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('db2DetailTitle-3').onmouseout="this.className='detail-data-title'";
}
																					...
																					<table width="96%" align="center">
																						...
																						<%
																							for(int i=0;i<lockList.size();i++){
																								...
																								String lock_timeouts = ht.get("lock_timeouts").toString(); 
																								String lock_wait_time = ht.get("lock_wait_time").toString(); 
																								String lock_escals = ht.get("lock_escals").toString(); 
																								String x_lock_escals = ht.get("x_lock_escals").toString(); 
																								String lock_list_in_use = ht.get("lock_list_in_use").toString(); 
