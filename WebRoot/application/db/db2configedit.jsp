...
<%
  ...
  Db2spaceconfig vo = (Db2spaceconfig)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
    ...
    var chk1 = checkinput("alarmvalue","string","告警值",30,false);
     ...
     if(chk1)
     {
        mainForm.action = "<%=rootPath%>/db2config.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 数据库管理 >> DB2数据库阀值设置</td>
