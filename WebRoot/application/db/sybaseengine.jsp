...
function setClass(){
	document.getElementById('sybDetailTitle-4').className='detail-data-title';
	document.getElementById('sybDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('sybDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
																			...
																			<tr bgcolor="#FFFFFF">
																				<td align=center>
																					...
																					<table width="80%" border="0" cellpadding="3"
																						...
																						<%
                        List engineInfo = (List)sysbaseVO.getEngineInfo();
                        if (engineInfo != null && engineInfo.size()>0){
                        	for(int k=0;k<engineInfo.size();k++){
                        		TablesVO tVO = (TablesVO)engineInfo.get(k);
                       %>
																						<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>
																							height=28>
																							<td class="application-detail-data-body-list"><%=tVO.getEngine()%></td>
																							<td class="application-detail-data-body-list"><%=tVO.getStatus()%></td>
																							<td class="application-detail-data-body-list"><%=tVO.getStarttime()%></td>
																						</tr>
																						<%
                       		}
                       	}
