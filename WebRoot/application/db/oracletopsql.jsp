...
Vector sql_v = (Vector)request.getAttribute("sql_v");
Vector sql_readwrite_v = (Vector)request.getAttribute("sql_readwrite_v");
Vector sql_sort_v = (Vector)request.getAttribute("sql_sort_v");
...
function oracletoprealtime()
{    
    window.open("<%=rootPath%>/oracle.do?action=getrealtimeoratop&dbid=<%=vo.getId() %>", "oracletoprealtimeWindow", "resizable=yes, height=400, width=800, top=200, left=200"); 
}
</script>
		<script language="JavaScript" type="text/JavaScript">
var show = true;
...
function setClass(){
	document.getElementById('oraDetailTitle-6').className='detail-data-title';
	document.getElementById('oraDetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-6').onmouseout="this.className='detail-data-title'";
}
		...
		<form id="mainForm" method="post" name="mainForm">
																								...
																								<table width="100%" border="0" cellspacing="0"
																									...
																									<tr height="28" bgcolor="#ECECEC">
																										...
																										<td align=center>
																											占用内存做多的前十条sql语句
																											&nbsp;&nbsp;
																											<!-- <a href="<%=rootPath%>/oracle.do?action=getrealtimeoratop&dbid=<%=vo.getId() %>" target="blank_">[占用内存sql语句实时信息]</a> -->
																											<a href="#" onclick="oracletoprealtime()">[占用内存sql语句实时信息]</a>
																										</td>
																										<td align=center>
																											占内存读取量的比例
																										</td>
			...
			%>
																									<tr height="28" bgcolor="#FFFFFF"
																										...
																										<td class="application-detail-data-body-list" style="width:85%;word-break: break-all; word-wrap:break-word;nowrap:false;">
																											&nbsp;<%=sql_text%></td>
