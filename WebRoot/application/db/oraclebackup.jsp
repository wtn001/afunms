...
Vector backup_v = (Vector)request.getAttribute("backup_v");
...
function setClass(){
	document.getElementById('oraDetailTitle-13').className='detail-data-title';
	document.getElementById('oraDetailTitle-13').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-13').onmouseout="this.className='detail-data-title'";
}
																...
																<tr>
																	<td width="80%">
																		<table width="100%" border="0" cellspacing="0"
																			...
																			<%
				for(int i=0;i<backup_v.size();i++){
					Hashtable diskValue = (Hashtable)backup_v.get(i);
					String name = (String)diskValue.get("name");
					String starttime = (String)diskValue.get("starttime");
						String usedtime = (String)diskValue.get("usedtime");
						String status = (String)diskValue.get("status");
						String types = (String)diskValue.get("types");
						String devicetype = (String)diskValue.get("devicetype");
						String innum = (String)diskValue.get("innum");
						String outnum = (String)diskValue.get("outnum");
						String out_per_second = (String)diskValue.get("out_per_second");
