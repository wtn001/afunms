...
function setClass(){
	document.getElementById('oraDetailTitle-2').className='detail-data-title';
	document.getElementById('oraDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-2').onmouseout="this.className='detail-data-title'";
}
