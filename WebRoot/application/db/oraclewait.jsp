...
Vector waitv = (Vector)request.getAttribute("waitv");
if(waitv == null)waitv = new Vector();
...
function setClass(){
	document.getElementById('oraDetailTitle-8').className='detail-data-title';
	document.getElementById('oraDetailTitle-8').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-8').onmouseout="this.className='detail-data-title'";
}
