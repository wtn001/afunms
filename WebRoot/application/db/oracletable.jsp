...
Vector table_v = (Vector)request.getAttribute("table_v");
if(table_v == null)table_v = new Vector();
...
function setClass(){
	document.getElementById('oraDetailTitle-4').className='detail-data-title';
	document.getElementById('oraDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
		...
		<form id="mainForm" method="post" name="mainForm">
			...
			%>
																									<tr height="28" bgcolor="#FFFFFF"
																										...
																										<td class="application-detail-data-body-list"
																											align=center>
																											&nbsp;<%=df.format(Double.parseDouble(spaces))%></td>
																									</tr>
																									<%}%>
																								</table>
																							</td>
