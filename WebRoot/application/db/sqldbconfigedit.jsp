...
<%
  ...
  Sqldbconfig vo = (Sqldbconfig)request.getAttribute("vo");
  String logflag = "库文件";
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1)
     {
        mainForm.action = "<%=rootPath%>/sqldbconfig.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
...
<body id="body" class="body" onload="initmenu();">
    <form method="post" name="mainForm">
        <input type=hidden name="id" value="<%=vo.getId()%>">
          <input type=hidden name="logflag" value="<%=vo.getLogflag()%>">
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
						<tr>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="layout_title"><b>应用 >> 数据库管理 >> SQLSERVER数据库阀值设置</b></td>
		    				...
		    				<td nowrap align="left">
		     					<input type="text" name="dbname" maxlength="50" size="20" value="<%=vo.getDbname()%>" readonly="readonly">
		    				</td>		    		    	    
 						</tr> 
		    				<tr height=28> 	    
		    				<td nowrap align=right>
		    				...
		    				<td nowrap align="left">
		     					<input type="text" name="logflag1" maxlength="50" size="20" value="<%=logflag%>" readonly="readonly">
		    				</td>		    				
 						</tr> 
