					...
					<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                  				...
                  				<tr>
            							...
            							<table width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<div align="center"><a href="<%=rootPath%>/informix.do?action=informixping&id=<%=vo.getId()%>"><font color="#397dbd">连通率</font></a></div></td>
                								<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
											...
											<div align="center"><a href="<%=rootPath%>/informix.do?action=informixabout&id=<%=vo.getId()%>"><font color="#FFFFFF">概要文件信息</font></a></div></td>	
											<td width="80" height="22" background="<%=rootPath%>/resource/image/anjian_1.gif">
              ...
              <tr> 
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr align="left" bgcolor="397dbd"> 
                      <td height="23"><b><font color="#FFFFFF">&nbsp;Informix数据库服务概要文件信息&nbsp;&nbsp;</font></b></td>
                    </tr>
                    <tr bgcolor="#FFFFFF"> 
                      <td align=center><br> 
                      ...
                      <table width="90%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                       ...
                       <td width="12%"><font color="#FFFFFF"><strong>信息</strong></font></td>
                       <td width="12%"><font color="#FFFFFF"><strong>值(KB)</strong></font></td>
                       </tr>
                       <%
