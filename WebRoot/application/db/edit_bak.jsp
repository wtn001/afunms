	...
	<tr>
		...
		<td bgcolor="#ffffff" align="center" valign=top>
			<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none align=center border=1 algin="center">
				<tr>
					<td height="28" align="left" bordercolor="#397DBD" bgcolor="#397DBD" class="txtGlobalBold" colspan=3>&nbsp;&nbsp;<font color=#ffffff>应用 >> 数据库管理 >> 数据库监视添加</font></td>
				</tr>
        						<TR>
        							<TD width="50%">&nbsp;
          							</td>            
		...
		<tr >
			...
			<!--<tr>
				...
				<input type=text id="sendmobiles" name="sendmobiles" size="50" maxlength="32" value="<%=vo.getSendmobiles()%>">&nbsp;&nbsp;<input type=button value="设置短信接收人" onclick='setReceiver("sendmobiles")'>
				</td>
			</tr>-->
			<tr style="background-color: #ECECEC;">	
