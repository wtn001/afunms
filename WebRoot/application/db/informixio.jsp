...
function setClass(){
	document.getElementById('inforDetailTitle-3').className='detail-data-title';
	document.getElementById('inforDetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('inforDetailTitle-3').onmouseout="this.className='detail-data-title'";
}
