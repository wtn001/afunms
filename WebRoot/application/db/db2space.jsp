...
String avg_buffer_pool_reads_time = "";
String avg_buffer_pool_write_time = "";
String Asynchronous_pool_index_reads = "";
String Asynchronous_pool_index_writes = "";
String Buffer_pool_index_physical = "";
String Buffer_pool_index_writes = "";
String Direct_reads_time = "";
String Direct_writes_time = "";
if(ipAllData!=null){
    avg_buffer_pool_reads_time = (String)ipAllData.get("avg_buffer_pool_reads_time");
    avg_buffer_pool_write_time = (String)ipAllData.get("avg_buffer_pool_write_time");
    Asynchronous_pool_index_reads = (String)ipAllData.get("Asynchronous_pool_index_reads");
    Asynchronous_pool_index_writes = (String)ipAllData.get("Asynchronous_pool_index_writes");
    Buffer_pool_index_physical = (String)ipAllData.get("Buffer_pool_index_physical");
    Buffer_pool_index_writes = (String)ipAllData.get("Buffer_pool_index_writes");
    Direct_reads_time = (String)ipAllData.get("Direct_reads_time");
    Direct_writes_time = (String)ipAllData.get("Direct_writes_time");
}

  if(avg_buffer_pool_reads_time == null || avg_buffer_pool_reads_time.equals("null")){
       avg_buffer_pool_reads_time="";
  }if(avg_buffer_pool_write_time == null || avg_buffer_pool_write_time.equals("null")){
       avg_buffer_pool_write_time="";
  }if(Asynchronous_pool_index_reads == null || Asynchronous_pool_index_reads.equals("null")){
       Asynchronous_pool_index_reads="";
  }if(Asynchronous_pool_index_writes == null || Asynchronous_pool_index_writes.equals("null")){
       Asynchronous_pool_index_writes="";
  }if(Buffer_pool_index_physical == null || Buffer_pool_index_physical.equals("null")){
       Buffer_pool_index_physical="";
  }if(Buffer_pool_index_writes == null || Buffer_pool_index_writes.equals("null")){
       Buffer_pool_index_writes="";
  }if(Direct_reads_time == null || Direct_reads_time.equals("null")){
       Direct_reads_time="";
  }if(Direct_writes_time == null || Direct_writes_time.equals("null")){
       Direct_writes_time="";
  }
...
function setClass(){
	document.getElementById('db2DetailTitle-7').className='detail-data-title';
	document.getElementById('db2DetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('db2DetailTitle-7').onmouseout="this.className='detail-data-title'";
}
																			...
																			<td colspan=2>
																				<table id="add-content-header" class="add-content-header">
																					<tr>
																						<td align="left" width="5"><img src="<%=rootPath%>/common/images/right_t_01.jpg" width="5" height="29" /></td>
																						<td class="add-content-title">
																							<b>&nbsp;&nbsp;DB2数据库: <%=obj%>( IP:<%=vo.getIpAddress()%> )&nbsp;&nbsp;表空间信息</b>
																						</td>
																						<td align="right"><img src="<%=rootPath%>/common/images/right_t_03.jpg" width="5" height="29" /></td>
																					</tr>
																				</table>
