...
<%
  ...
  Sybspaceconfig vo = (Sybspaceconfig)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1)
     {
        mainForm.action = "<%=rootPath%>/sybaseconfig.do?action=update";
        mainForm.submit();
     }
       // mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 数据库管理 >> SYBASE数据库阀值设置</td>
