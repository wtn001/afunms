...
OracleLockInfo oracleLockInfo = (OracleLockInfo)request.getAttribute("oracleLockInfo");
...
function setClass(){
	document.getElementById('oraDetailTitle-1').className='detail-data-title';
	document.getElementById('oraDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
																		...
																		<table cellpadding="0" cellspacing="0"
																			...
																			<tr height="28" bgcolor="#FFFFFF"
																				...
																				<td
																					...
																					align=center>
																					&nbsp;<%=String.valueOf(oracleLockInfo.getDeadlockcount())%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=oracleLockInfo.getLockwaitcount()%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=oracleLockInfo.getMaxprocesscount()%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=oracleLockInfo.getProcesscount()%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=oracleLockInfo.getCurrentsessioncount()%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=oracleLockInfo.getUseablesessioncount()%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=oracleLockInfo.getUseablesessionpercent()%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=oracleLockInfo.getLockdsessioncount()%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=String.valueOf(oracleLockInfo.getRollbacks())%></td>
																				<td
																					class="application-detail-data-body-list"
																					align=center>
																					&nbsp;<%=String.valueOf(oracleLockInfo.getRollbackcommitpercent())%></td>
