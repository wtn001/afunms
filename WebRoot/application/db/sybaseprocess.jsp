...
function setClass(){
	document.getElementById('sybDetailTitle-3').className='detail-data-title';
	document.getElementById('sybDetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('sybDetailTitle-3').onmouseout="this.className='detail-data-title'";
}
																			...
																			<tr bgcolor="#FFFFFF">
																				<td align=center>
																					...
																					<table width="80%" border="0" cellpadding="3"
																						...
																						<%
                        List processlist = (List)sysbaseVO.getProcessInfo();
                        if (processlist != null && processlist.size()>0){
                        	for(int k=0;k<processlist.size();k++){
                        		TablesVO tVO = (TablesVO)processlist.get(k);
                       %>
																						<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>
																							height=28>
																							<td class="application-detail-data-body-list"><%=tVO.getSpid()%></td>
																							<td class="application-detail-data-body-list"><%=tVO.getHostname()%></td>
																							<td class="application-detail-data-body-list"><%=tVO.getProstatus()%></td>
																							<td class="application-detail-data-body-list"><%=tVO.getHostprocess()%></td>
																							<td class="application-detail-data-body-list"><%=tVO.getProgram_name()%></td>
																						</tr>
																						<%
                       		}
                       	}
