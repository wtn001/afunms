...
<script language="JavaScript">
	...
	*/
	...
	function edit()
	{
		mainForm.action="<%=rootPath%>/informixspace.do?action=ready_edit&id="+node;
        mainForm.submit();
	}
	function addalert(node)
    {
        mainForm.action = "<%=rootPath%>/informixspace.do?action=addalert&id="+node;
        mainForm.submit();
    }
    function cancelalert(node)
    {
        mainForm.action = "<%=rootPath%>/informixspace.do?action=cancelalert&id="+node;
        mainForm.submit();
    }
	function clickMenu()
	{
