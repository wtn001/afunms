...
String[] dbItems={"usedperc","usedsize","sizes","dbname"};
														...
														<td>
															<table class="application-detail-data-body">
																<tr>
																					...
																					<table cellpadding="0" cellspacing="0" width=98%>
																						<tr>
																							<td width="100%" align="center">
																								...
																								<script type="text/javascript">
																									var so = new SWFObject("<%=rootPath%>/flex/Oracle_Ping.swf?ipadress=<%=vo.getId()%>&category=SQLPing", "Oracle_Ping", "346", "250", "8", "#ffffff");
														           ...
														           <tr>
														              <td align=center>
														                <div id="bufferUtil" align="center"></div>															                
															                 <script type="text/javascript">
						                                             ...
						                                             so.write("bufferUtil");
																    	    ...
																    	    <br>
                   															<table style="width:95%" border=1 style="border:1px;border-collapse:collapse;">
																			<tr>
															                		<td width=95%>
																				<table width="95%">
														                					<tr>
                                                                                                          ...
                                                                                                          for(Iterator itr = database.keySet().iterator(); itr.hasNext();){ 
                                                                                                             ...
                                                                                                             Hashtable tablespace = (Hashtable) database.get(key); 
                                                                                                              if(tablespace!= null && tablespace.size() > 0){
																						                        ...
																						                        String[] colorStr=new String[] {"#33FF33","#FF0033","#9900FF","#33FF33","#FF0033","#9900FF","#FFFF00","#33CCFF","#003366","#33FF33","#FF0033","#FFFF00","#33CCFF","#003366","#33FF33","#FF0033","#9900FF","#FFFF00","#FF0033","#9900FF","#FFFF00","#333399","#0000FF","#A52A2A","#800080","#FFFF00","#33CCFF","#003366","#33FF33","#33FF33","#FF0033","#9900FF","#FFFF00","#33CCFF","#003366","#33FF33","#FF0033"};
																						                        ...
																						                        for(int k=0;k<dbname.length;k++){
																													...
																													//System.out.println("============334444444=="+colorStr[j]);
																			...
																			<tr>
																				...
																				<br>
																                	        			<table cellpadding="0" cellspacing="0"border="1" style="width: 95%">
												              							        			<tr> 
