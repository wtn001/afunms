...
Hashtable baseinfoHash = (Hashtable)request.getAttribute("baseinfoHash");
if(baseinfoHash == null)baseinfoHash = new Hashtable();
...
function setClass(){
	document.getElementById('oraDetailTitle-10').className='detail-data-title';
	document.getElementById('oraDetailTitle-10').onmouseover="this.className='detail-data-title'";
	document.getElementById('oraDetailTitle-10').onmouseout="this.className='detail-data-title'";
}
