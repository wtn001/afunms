...
function setClass(){
	document.getElementById('webDetailTitle-1').className='detail-data-title';
	document.getElementById('webDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('webDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
																		...
																		<table width="100%" cellspacing="0" cellpadding="0"
																			...
																			<tr>
																				<td width="100%" align="center">
																					...
																					<script type="text/javascript">
																											var so = new SWFObject("<%=rootPath%>/flex/Web_pagesize_area.swf?id=<%=queryconf.getId()%>", "Web_pagesize_area", "400", "250", "8", "#ffffff");
																		...
																		<table width="100%" cellspacing="0" cellpadding="0"
																			...
																			<tr>
																				<td width="100%" align="center">
																					...
																					<script type="text/javascript">
																											var so = new SWFObject("<%=rootPath%>/flex/Web_changerate_area.swf?id=<%=queryconf.getId()%>", "Web_changerate_area", "400", "250", "8", "#ffffff");
...
setTimeout(function(){
  ...
  mainForm.action = "<%=rootPath%>/web.do?action=sychronizeData&id=<%=queryconf.getId()%>&flag=<%=flag_1%>&page=page";
  mainForm.submit();
 });    
});
</script>
