...
<%
  ...
  List<TFTPConfig> userTFTPConfigList = (List<TFTPConfig>)request.getAttribute("tftplist");
	...
	{	
		...
		"<tr>"+
			"<td style='cursor: default; border: outset 1;' align='center'"+
				"onclick='parent.tftpedit()'>修改信息</td>"+
		"</tr>"+
		"<tr>"+
			"<td style='cursor: default; border: outset 1;' align='center'"+
				"onclick='parent.tftpdetail();'>监视信息</td>"+
		"</tr>"+
		"<tr>"+
			"<td style='cursor: default; border: outset 1;' align='center'"+
				"onclick='parent.tftpcancelmanage()'>取消监视</td>"+
		"</tr>"+
		"<tr>"+
			"<td style='cursor: default; border: outset 1;' align='center'"+
				"onclick='parent.tftpaddmanage()'>添加监视</td>"+
		"</tr>"+	
	"</table>";
		}else if(ser == "email"){
		document.getElementById('itemMenu').innerHTML="<table border='1' width='100%' height='100%' bgcolor='#F1F1F1'"+
		...
		<td align="center" valign=top bgcolor="#ababab">
		    ...
		    <tr>
					<td>
						<table cellspacing="1" cellpadding="0" width="100%">
							<tr>
								<td height="28" align="left" bordercolor="#ffffff" bgcolor="#ffffff" class="txtGlobalBold" colspan="7">&nbsp;&nbsp;<font color="#397DBD">TFTP服务</font></td>
							</tr>
			...
			%>
			       <tr bgcolor="FFFFFF" class="microsoftLook" height="25">
					...
					<td height=25 class="report-data-body-list">&nbsp;
					<img src="<%=rootPath%>/resource/image/status.gif" border="0" width=15 oncontextmenu=showMenu('tftp','2','<%=vo.getId()%>','<%=vo.getName()%>')>
					</td>
			  	</tr>
			<%	}
			}
