...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk5 = checkinput("filename","string","文件名称",30,false);
     var chk5 = checkinput("timeout","number","超时",30,false);
     ...
     if(chk1&&chk4&&chk5)
     {
        ...
        mainForm.action = "<%=rootPath%>/tftp.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> tftp添加</td>
				        						...
				        						<tr>
				        							<td>
				        								<table id="detail-content-body" class="detail-content-body">
															...
															<!--  
															<tr style="background-color: #ECECEC; display:none;">
																<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>用户名&nbsp;</TD>				
																<TD nowrap width="40%" >&nbsp;
																	<input type="text" id="username" name="username" maxlength="50" size="20" class="formStyle" value="貌似不需要username">
																</TD>
																<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>密码&nbsp;</TD>				
																<TD nowrap width="40%" colspan=3>&nbsp;
																	<input type="password" name="password" maxlength="50" size="20" class="formStyle" value="貌似不需要password">
																</TD>
															</tr>
															-->
															<tr>					
																...
																<TD nowrap width="40%">&nbsp;
																	<input type="text" name="ipaddress" maxlength="50" size="50" class="formStyle" >
																</TD>
																<TD nowrap align="right" height="24" width="10%">文件名称&nbsp;</TD>				
																<TD nowrap width="40%">&nbsp;
																	<input type="text" name="filename" value="tftpupload.txt" maxlength="50" size="20" class="formStyle" >
																</TD>
															</tr>
															...
															<!--<tr style="background-color: #ECECEC;"> 
																...
																<TD nowrap width="40%">&nbsp;
																<input type="text" readonly="readonly" id="sendmobiles" name="sendmobiles" maxlength="32" size="50" value="">&nbsp;&nbsp;<input id="sendmobilesbutton" type="button" value="设置短信接收人" onclick='setReceiver("sendmobiles");'> 
																</td>
									 						</tr>-->
									    					...
									    					<tr style="background-color: #ECECEC;"> 
																...
																<TD nowrap width="40%">&nbsp;
																<input type="text" readonly="readonly" id="sendemail" name="sendemail" maxlength="32" size="50" value="">&nbsp;&nbsp;<input id="sendemailbutton" type="button" value="设置邮件接收人" onclick='setReceiver("sendemail");'> 
																</td>
									 						</tr>  
									    					<!--<tr style="background-color: #ECECEC;"> 
									  							<TD nowrap align="right" height="24" width="10%">电话接收人&nbsp;</TD>       
																<TD nowrap width="40%">&nbsp;
																<input type="text" readonly="readonly" id="sendphone" name="sendphone" maxlength="32" size="50" value="">&nbsp;&nbsp;<input id="sendphonebutton" type="button" value="设置电话接收人" onclick='setReceiver("sendphone");'> 
																</td>
									 						</tr>-->  								
															<tr>	
