...
<%
	...
	int status = 0;
	Node node = (Node) PollingEngine.getInstance().getFtpByID(
			queryconf.getId());
	if (node != null) {
...
function setClass(){
	document.getElementById('ftpDetailTitle-1').className='detail-data-title';
	document.getElementById('ftpDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('ftpDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
...
function query()
  {  
     mainForm.action = "<%=rootPath%>/FTP.do?action=alarm";
     mainForm.submit();
  }
</script>
