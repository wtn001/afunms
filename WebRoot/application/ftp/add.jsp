...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk2 = checkinput("password","string","密码",30,false);
     ...
     if(chk1&&chk2&&chk3&&chk4&&chk5)
     {
        ...
        mainForm.action = "<%=rootPath%>/FTP.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> ftp添加</td>
				        							...
				        							<td>
				        								<table id="detail-content-body" class="detail-content-body">
															...
															<tr style="background-color: #ECECEC;">						
																...
																<TD nowrap width="40%" colspan=3>&nbsp;
																	<input type="password" name="password" maxlength="50" size="20" class="formStyle">
																</TD>
															</tr>
															<tr>					
																...
																<TD nowrap width="40%">&nbsp;
																	<input type="text" name="filename" value="ftpupload.txt" maxlength="50" size="20" class="formStyle" >
																</TD>
															</tr>
															<tr style="background-color: #ECECEC;">					
