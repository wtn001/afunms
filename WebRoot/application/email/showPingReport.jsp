...
{
	mainForm.action = "<%=rootPath%>/servicecapreport.do?action=publicdownloadPingReport&ipaddress=<%=ipaddress%>&str=1&type=mail";
	mainForm.submit();
}
function ping_excel_report()
{
	mainForm.action = "<%=rootPath%>/servicecapreport.do?action=publicdownloadPingReport&ipaddress=<%=ipaddress%>&str=0&type=mail";
	mainForm.submit();
}
function ping_pdf_report()
{
	mainForm.action = "<%=rootPath%>/servicecapreport.do?action=publicdownloadPingReport&ipaddress=<%=ipaddress%>&str=2&type=mail";
	mainForm.submit();
}
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/mail.do?action=showPingReport&ipaddress=<%=ipaddress%>&id=<%=id%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
				...
				<table id="container-main-win" class="container-main-win">
					...
					<tr>
						<td colspan="4" align="center">
							<img src="<%=rootPath%>/resource/image/jfreechart/<%=newip %>mailpingConnect.png"/>
						</td>
					</tr>
				</table>
