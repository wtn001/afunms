...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk5 = checkinput("address","string","邮箱地址",30,false);
     var chk2 = checkinput("username","string","用户名",30,false);
     var chk3 = checkinput("password","string","密码",30,false);
     var chk4 = checkinput("ipaddress","ip","IP地址",30,false);
     ...
     if(chk1&&chk2&&chk3&&chk4&&chk5&&chk6&&chk7)
     {
        ...
        mainForm.action = "<%=rootPath%>/mail.do?action=add";
        mainForm.submit();
     }  
 });	
							...
							<td class="td-container-main-add">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> Email添加</td>
								...
								<TBODY>
									...
									<tr>		
										...
										<TD nowrap width="40%" >&nbsp;
											<input type="text" id="address" name="address" maxlength="50" size="20" class="formStyle"><span>&nbsp;(如 mail.dhcc.com.cn)</span>  
										</TD>				
										<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>发送邮件地址&nbsp;@&nbsp;</TD>				
										<TD nowrap width="40%" >&nbsp;
											<input type="text" id="receiveAddress" name="receiveAddress" maxlength="50" size="20" class="formStyle"><span>&nbsp;(如 mail.dhcc.com.cn)</span>
										</TD>
									</tr>
									<tr style="background-color: #ECECEC;">						
										<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>发送用户名&nbsp;</TD>				
										<TD nowrap width="40%">&nbsp;
											<input type="text" id="username" name="username" maxlength="50" size="20" class="formStyle">
										</TD>
										<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>发送密码&nbsp;</TD>				
										<TD nowrap width="40%">&nbsp;
											<input type="password" id="password" name="password" maxlength="50" size="20" class="formStyle">
										</TD>
									</tr>
									<tr>	
										<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>IP&nbsp;</TD>				
										<TD nowrap width="40%">&nbsp;
											<input type="text" id="ipaddress" name="ipaddress" maxlength="50" size="20" class="formStyle">
										</TD>				
										<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>接收邮箱&nbsp;</TD>				
										<TD nowrap width="60%">&nbsp;
											<input type="text" id="recivemail" name="recivemail" maxlength="50" size="50" class="formStyle" value="">
										</TD>
									</tr>
									<tr style="background-color: #ECECEC;">						
										<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>超时(毫秒)&nbsp;</TD>				
										<TD nowrap width="40%" colspan=3>&nbsp;
											<input type="text" id="id" name="timeout" maxlength="50" size="20" class="formStyle">
										</TD>		
									</tr>
									<tr>					
									...
									<!--<tr > 
										...
										<TD nowrap width="40%" colspan=3>&nbsp;
										<input type="text" readonly="readonly" name="sendmobiles" id="sendmobiles" maxlength="32" size="50" value="">&nbsp;&nbsp;<input type=button value="设置短信接收人" onclick='setReceiver("sendmobiles")'> 
										</td>
			 						</tr>-->
									...
									<!-- 
										...
										<TD nowrap width="40%" colspan=3>&nbsp;
										<input type="text" readonly="readonly" name="sendemail" id="sendemail" maxlength="32" size="50" value="">&nbsp;&nbsp;<input type=button value="设置邮件接收人" onclick='setReceiver("sendemail")'>
										</td>
			 						</tr> 
			 						<tr> 
			  							<TD nowrap align="right" height="24" width="10%">电话接收人&nbsp;</TD>       
										<TD nowrap width="40%" colspan=3>&nbsp;
										<input type="text" readonly="readonly" name="sendphone" id="sendphone" maxlength="32" size="50" value="">&nbsp;&nbsp;<input type=button value="设置电话接收人" onclick='setReceiver("sendphone")'>
										</td>
			 						</tr>-->
									<tr>	
