...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     //if(chk1&&chk2&&chk3)
     {
        ...
        mainForm.action = "<%=rootPath%>/plot.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
	...
	<tr>
		...
		<td bgcolor="#ffffff" align="center" valign=top>
				...
				<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
					<TBODY>
				<tr>
					<td height="28" align="left" bordercolor="#397DBD" bgcolor="#397DBD" class="txtGlobalBold" colspan=4>&nbsp;&nbsp;<font color=#ffffff>应用 >> 服务管理 >> 添加Radar</font></td>
				</tr>
						...
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="inter" maxlength="50" size="40" class="formStyle">
							</TD>
