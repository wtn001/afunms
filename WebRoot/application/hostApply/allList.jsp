	...
	<head>
		...
		<script language="JavaScript">
			...
			function show(modifyFlag){
		        ...
		        mainForm.action = "<%=rootPath%>/hostApply.do?action=allShow&modifyFlag="+modifyFlag;
		        mainForm.submit();
		     }
		</script>
	</head>
															...
															<table id="table_asdf" class="data" >
				        										...
				        										<tr <%=onmouseoverstyle%>>
													    			...
													    			<td class="data_content center">
													    				...
													    				%>
													    				<INPUT type="checkbox"  name=checkbox value="<%=ip+":mail" %>" <%=hostApply.isEmailShow() ? "checked" : "" %>><img src='<%=emailImgPath %>'/>
													    				<%
													    					}
													    				%>
													    			</td>
