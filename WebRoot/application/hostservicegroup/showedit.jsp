...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
        	...
        	mainForm.action = "<%=rootPath%>/hostservicegroup.do?action=edit&forward=showlist";
        	mainForm.submit();
  			}
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title"> 资源 &gt;&gt; 性能监视 &gt;&gt; 主机服务监视 &gt;&gt; 编辑 </td>
				        														...
				        														<td>
				        															<table>
																						<tr>						
																							...
																							<td width="40%">&nbsp;<input type="text" id="ipaddress" readonly="readonly" value="<%=hostservicegroup.getIpaddress()%>" name="ipaddress">
																							<input type="hidden" id="nodeid"  value="<%=hostservicegroup.getNodeid()%>" name="nodeid">
																							<input type="hidden" id="groupId"  value="<%=hostservicegroup.getId()%>" name="groupId">
