...
function setClass(){
	document.getElementById('tuxedoDetailTitle-1').className='detail-data-title';
	document.getElementById('tuxedoDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('tuxedoDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
											    					...
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">可执行文件名</td>
																		 	<td class="application-detail-data-body-title">连接的队列名</td>
																			<td class="application-detail-data-body-title">组名</td>
																			<td class="application-detail-data-body-title">数字id</td>
																			<td class="application-detail-data-body-title">已处理的请求数</td>
																			<td class="application-detail-data-body-title">已处理的全部请求的参数和</td>
																			<td class="application-detail-data-body-title">正在处理的交易</td>
														           		</tr>
														           		...
														           		<% 
														           			if(serverList != null && serverList.size()>0 ){
														           				...
														           				for(int i = 0 ; i < serverList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)serverList.get(i);
														           				...
														           				%>
														           					<tr height="28">
																						...
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("RqDone")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("LoadDone")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("CurrentService")%></td>
																	           		</tr>
														           				<%
														           					}
														           				}
