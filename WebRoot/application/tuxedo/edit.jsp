													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title"> 应用 &gt;&gt; 中间件管理 &gt;&gt; Tuxedo 编辑</td>
				        											...
				        											<table cellspacing="1">
																		<tr style="background-color: #ECECEC;">						
																			...
																			<td width="40%">&nbsp;
																				...
																				<font color="red">&nbsp;必填 Tuxedo 服务器地址*</font>
																			</td>
																		</tr>	
																		<tr>
												    					...
												    					<tr style="background-color: #ECECEC;"> 
																			...
																			<TD nowrap width="40%"  colspan=3>&nbsp;
																			<input type="text" readonly="readonly" id="sendemail" name="sendemail" maxlength="32" size="50" value="<%=tuxedoConfig.getSendemail()%>">&nbsp;&nbsp;<input type=button value="设置邮件接收人" onclick='setReceiver("sendemail");'> 
																			</td>
												 						</tr> 
												 						<!--<tr> 
