...
function setClass(){
	document.getElementById('MQDetailTitle-4').className='detail-data-title';
	document.getElementById('MQDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('MQDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
