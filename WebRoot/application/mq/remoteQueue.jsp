...
function setClass(){
	document.getElementById('MQDetailTitle-3').className='detail-data-title';
	document.getElementById('MQDetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('MQDetailTitle-3').onmouseout="this.className='detail-data-title'";
}
