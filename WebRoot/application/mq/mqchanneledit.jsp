			...
			<tr>
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> MQ通道告警编辑</td>
						...
						<tr >					
							<TD nowrap align="right" height="24" width="10%">是否告警&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<select   name="sms"  class="formStyle">
								<%
									if(vo.getSms() == 0){
								%>
						...
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" name="bak" maxlength="50" size="50" class="formStyle" value="">
							</TD>
						</tr>	
						 -->			
						<tr>
