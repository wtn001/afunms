...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk3 = checkinput("managername","string","列队管理名称",30,false);
     var chk4 = checkinput("portnum","number","端口",30,false);
     ...
     if(chk1&&chk2&&chk3&&chk4)
     {
        ...
        mainForm.action = "<%=rootPath%>/mq.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> MQ添加</td>
						...
						<tr >						
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="managername"name="managername" maxlength="50" size="20" class="formStyle">
							</TD>
