...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk2 = checkinput("chlname","string","通道名称",30,false);
     var chk3 = checkinput("connipaddress","ip","连接IP",30,false);
     var chk4 = checkinput("bak","string","备注",30,false);
     ...
     if(chk1&&chk2&&chk3&&chk4)
     {
        ...
        mainForm.action = "<%=rootPath%>/mqchannel.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> MQ通道告警添加</td>
						...
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>通道名称&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="chlname" name="chlname" maxlength="50" size="20" class="formStyle" >
							</TD>
						</tr>
						<tr >					
							...
							<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>连接IP&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="connipaddress" name="connipaddress" maxlength="50" size="20" class="formStyle">
							</TD>																					
						</tr> 														
						<tr style="background-color: #ECECEC;">						
							<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>备注&nbsp;</TD>				
