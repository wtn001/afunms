...
function setClass(){
	document.getElementById('webLoginDetailTitle-1').className='detail-data-title';
	document.getElementById('webLoginDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('webLoginDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
...
function query()
  {  
     mainForm.action = "<%=rootPath%>/weblogin.do?action=alarm";
     mainForm.submit();
  }
</script>
...
setTimeout(function(){
  ...
  mainForm.action = "<%=rootPath%>/weblogin.do?action=sychronizeData&id=<%=queryconf.getId()%>&flag=<%=flag_1%>";
  mainForm.submit();
 });    
});
</script>
