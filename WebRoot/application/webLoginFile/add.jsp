...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2&&chk3)
     {
        ...
        mainForm.action = "<%=rootPath%>/weblogin.do?action=add";
        mainForm.submit();
     }  
     }else{
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> web虚拟登录添加</td>
																			...
																			<TBODY>
																				<tr >						
																					...
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="alias" name="alias" maxlength="50" size="20" class="formStyle">
																					</TD>
																				</tr>
																				<tr style="background-color: #ECECEC;">					
																					<TD nowrap align="right" height="24" width="10%">URL&nbsp;</TD>				
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="url" name="url" maxlength="100" size="50" class="formStyle" value="http://">
																					</TD>
																				</tr>
																				<tr style="">					
																				...
																				<tr style="background-color: #ECECEC;">					
																					...
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="outurl" name="outurl" maxlength="100" size="50" class="formStyle" value="http://">
																					</TD>
																				</tr>
																				...
																				<tr>					
																					...
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="name_flag" name="name_flag" maxlength="50" size="20" class="formStyle" value="">
																					</TD>
																				</tr>
																				<tr  style="background-color: #ECECEC;">					
																					<TD nowrap align="right" height="24" width="10%">用户名&nbsp;</TD>				
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="user_name" name="user_name" maxlength="50" size="20" class="formStyle" value="">
																					</TD>
																				</tr>
																				<tr>					
																					<TD nowrap align="right" height="24" width="10%">密码标识&nbsp;</TD>				
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="password_flag" name="password_flag" maxlength="50" size="20" class="formStyle" value="">
																					</TD>
																				</tr>
																				<tr  style="background-color: #ECECEC;">					
																					<TD nowrap align="right" height="24" width="10%">密&nbsp;码&nbsp;</TD>				
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="password" id="user_password" name="user_password" maxlength="50" size="20" class="formStyle" value="">
																					</TD>
																				</tr>
																				...
																				<tr>					
																					...
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="code_flag" name="code_flag" maxlength="50" size="20" class="formStyle" value="">
																					</TD>
																				</tr>
																				<tr  style="background-color: #ECECEC;">					
																					<TD nowrap align="right" height="24" width="10%">验证码&nbsp;</TD>				
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="user_code" name="user_code" maxlength="50" size="20" class="formStyle" value="">
																					</TD>
																				</tr>
																				<tr>						
																				...
																				<!--  
																				<tr>					
																					<TD nowrap align="right" height="24" width="10%">是否启用路由跟踪&nbsp;</TD>				
																					<TD nowrap width="40%">&nbsp;
																						<select   name="tracertflag"  class="formStyle">
																							<option value=0>不启动</option>
																							<option value=1>任何时候都启动</option>
																							<option value=2>超过阀值时启动</option>
																						</select>
																					</TD>															
																				</tr>
																				-->
																	                        ...
																	                        <tr>
																	                            <td align="left">    
																	                                ...
																	                                <table id="errorwordConfigTable" style="width:60%; padding:0;  background-color:#FFFFFF; position:relative; left:15px;" >
																                                        <tr>
																                                            <td colspan="7" height="50" align="center"> 
																                                                <span id='addErrorWordConfigRow' style="border: 1px solid black;margin:10px;padding:0px 3px 0px 3px;line-height:15px">增加一行</span>
																                                            </td>
																                                        </tr>
																	                                </table>
																	                            </td>
