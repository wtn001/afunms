...
function event_word_report()
{
	...
	mainForm.action = "<%=rootPath%>/resin.do?action=downloadEventReport&id=<%=tmp%>&str=0&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
function event_excel_report()
{
    var starttime = document.getElementById("mystartdate").value;
	var endtime = document.getElementById("mytodate").value;
	mainForm.action = "<%=rootPath%>/resin.do?action=downloadEventReport&id=<%=tmp%>&str=1&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
function event_pdf_report()
{
    var starttime = document.getElementById("mystartdate").value;
	var endtime = document.getElementById("mytodate").value;
	mainForm.action = "<%=rootPath%>/resin.do?action=downloadEventReport&id=<%=tmp%>&str=2&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
function query()
{
	var starttime = document.getElementById("mystartdate").value;
	var endtime = document.getElementById("mytodate").value;
	mainForm.action = "<%=rootPath%>/resin.do?action=eventReport&id=<%=tmp%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
