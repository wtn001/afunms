...
<%
	...
	Resin vo = (Resin) request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     //if(chk1&&chk2&&chk3&&chk4)
     {
        ...
        mainForm.action = "<%=rootPath%>/resin.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<TBODY>
																				...
																				<tr>
																					...
																					<TD nowrap width="40%">
																						...
																						<input type="text" name="alias" size="20"
																							class="formStyle" value="<%=vo.getAlias()%>">
																						<font color='red'>*</font>
																					</TD>
																					...
																					<TD nowrap width="40%">
																						...
																						<input type="text" name="ip_address" size="20"
																							class="formStyle" value="<%=vo.getIpAddress()%>">
																						<font color='red'>*</font>
																					</TD>
																				</tr>
																				<tr style="background-color: #ECECEC;">
																					...
																					<TD nowrap width="40%">
																						...
																						<input type="text" name="user" size="20"
																							class="formStyle" value="<%=vo.getUser()%>">
																					</TD>
																					<TD nowrap align="right" height="24" width="10%">
																						密码&nbsp;
																					</TD>
																					<TD nowrap width="40%">
																						...
																						<input type="text" name="password" size="20"
																							class="formStyle" value="<%=vo.getPassword()%>">
																					</TD>
																				</tr>
																				<tr>
																					<TD nowrap align="right" height="24">
																					...
																					<TD nowrap>
																						...
																						<input type="text" name="port" size="20"
																							class="formStyle" value="<%=vo.getPort()%>">
																						<font color='red'>*</font>
																					</TD>
																					<TD nowrap align="right" height="24" width="10%">
																						&nbsp; 版本
																				...
																				<tr style="background-color: #ECECEC;">
																					...
																					<TD nowrap width="40%">
																						&nbsp;
																						<select size=1 name='supperid'
																							style="width: 260px;">
																							<option value='0'></option>
																							<c:forEach items="${allSupper}" var="al">
																								<c:choose>
																									<c:when test="${vo.supperid eq al.su_id }">
																										<option value='${al.su_id }' selected>
																											${al.su_name }（${al.su_dept}）
																										</option>
																									</c:when>
																									<c:otherwise>
																										<option value='${al.su_id }'>
																											${al.su_name }（${al.su_dept}）
																										</option>
																									</c:otherwise>
																								</c:choose>
																				...
																				<tr style="background-color: #ECECEC;">
																					...
																					<td nowrap colspan="3" height="1">
																						...
																						<input type=text readonly="readonly"
																							...
																							name="bidtext" size="50" maxlength="32"
																							value="<%=bussName%>">
																						&nbsp;&nbsp;
																								...
																								<tr>
																									<td align="left">
																										...
																										<table id="timeConfigTable"
																											...
																											<c:forEach items="${timeGratherConfigList}"
																												var="tg" varStatus="tgindex">
																												<script type="text/javascript">
																											...
																											<tr>
																												<td colspan="7" height="50" align="center">
																													<span id="addTimeConfigRow"
																														style="border: 1px solid black; margin: 10px; padding: 0px 3px 0px 3px; cursor: hand;line-height:15px">增加一行</span>
																												</td>
																											</tr>
																										</table>
																									</td>
