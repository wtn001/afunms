...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2&&chk3&&chk4&&chk5)
     {
        ...
        mainForm.action = "<%=rootPath%>/resin.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
																				...
																				<tr>
																					...
																					<TD nowrap width="40%">
																						...
																						<input type="text" id="ip_address"
																							name="ip_address" size="20" class="formStyle">
																						<font color='red'>*</font>
																					</TD>
																				</tr>
																				<tr style="background-color: #ECECEC;">
																					...
																					<TD nowrap width="40%">
																						...
																						<input type="text" id="password" name="password"
																							size="20" class="formStyle" value="admin">
																					</TD>
																				</tr>
																				<tr>
																					<TD nowrap align="right" height="24">
																					...
																					<TD nowrap>
																						&nbsp;
																						<input type="text" id="port" name="port" size="20"
																							class="formStyle" value="8081">
																						<font color='red'>*</font>
																					</TD>
																					<TD nowrap align="right" height="24" width="10%">
																						版本&nbsp;
																				...
																				<tr style="background-color: #ECECEC;">
																					...
																					<td nowrap colspan="3" height="1">
																						<input type=text readonly="readonly"
																							...
																							name="bidtext" size="50" maxlength="32" value="">
																						&nbsp;&nbsp;
