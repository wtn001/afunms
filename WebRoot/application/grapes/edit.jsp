...
<%
  ...
  GrapesConfig vo = (GrapesConfig)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     //if(chk1&&chk2&&chk3)
     {
        ...
        mainForm.action = "<%=rootPath%>/grapes.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
				...
				<tr>
					<td height="28" align="left" bordercolor="#397DBD" bgcolor="#397DBD" class="txtGlobalBold" colspan=4>&nbsp;&nbsp;<font color=#ffffff>应用 >> 中间件管理 >> 修改MQ</font></td>
						...
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="subfilesum" maxlength="50" size="40" class="formStyle" value="<%=vo.getSubfilesum()%>">
							</TD>
