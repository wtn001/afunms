	...
	<tr>
		...
		<td bgcolor="#ffffff" align="center" valign=top>
			<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none align=center border=1 algin="center">
				<tr>
					<td height="28" align="left" bordercolor="#397DBD" bgcolor="#397DBD" class="txtGlobalBold" colspan=3>&nbsp;&nbsp;<font color=#ffffff>应用 >> 中间件管理 >> Grapes监视列表</font></td>
				</tr>
        						<TR>
        							<TD width="50%">&nbsp;
          							</td>            
...
%>
       <tr bgcolor="DEEBF7" <%=onmouseoverstyle%> class="microsoftLook">
		...
		<td height=25>&nbsp;<%=vo.getSubfilesum()%></td> 
