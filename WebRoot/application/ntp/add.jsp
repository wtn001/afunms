...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2)
     {
        ...
        mainForm.action = "<%=rootPath%>/ntp.do?action=add";
        mainForm.submit();
     }  
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> ntp添加</td>
				        												...
				        												<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
																			<TBODY>
																				...
																				<tr>					
																					...
																					<TD nowrap width="40%" colspan=3>&nbsp;
																						<input type="text" id="port" name="port" maxlength="50" size="10" class="formStyle" value="123">&nbsp;<font color='red'>*</font>
																					</TD>
																				</tr>
																				<tr style="background-color: #ECECEC;">					
