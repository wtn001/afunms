 ...
 Ext.get("process").on("click",function(){
    ...
    //var chk1 = checkinput("alias","string","名称",15,false);
     ...
     //if(chk1&&chk2&&chk3&&chk4)
     {
        ...
        mainForm.action = "<%=rootPath%>/ntp.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
				...
				<td class="td-container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> ntp编辑</td>
					...
					<TBODY>
						...
						<tr>					
							...
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" id="port" name="port" maxlength="50" size="50" class="formStyle" value="<%=vo.getPort()%>">
							</TD>
						</tr>
						<tr style="background-color: #ECECEC;">					
