...
<!-- 右键菜单结束-->
    ...
    <td  width="10%" align="center">序列索引号</td>
    <td  width="10%" align="center">缺陷名称</td>
    <td  width="10%" align="center">事件记录号</td>
    <td  width="10%" align="center">记录编码</td>
    <td  width="10%" align="center">日期</td>
    <td  width="10%" align="center">时间</td>
    <td  width="40%" align="center">时间描述</td>
  </tr>
            ...
            <%
                if(list!=null || list.size()>0){
                    ...
                    for(int i =0;i<list.size();i++){
                        hdc = (HdcMessage)list.get(i);
                        if(hdc.getEventListIndexSerialNumber()!=null && hdc.getEventListNickname()!=null
                         && hdc.getEventListREFCODE()!=null && hdc.getEventListDate()!=null && hdc.getEventListTime()!=null && hdc.getEventListDescription()!=null
                        ){
             %>
              <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
            <td  class="detail-data-body-list"><%=hdc.getEventListIndexSerialNumber()%></td>
            <td  class="detail-data-body-list"><%=hdc.getEventListNickname()%></td>
            <td  class="detail-data-body-list"><%=(i+1)%></td>
            <td  class="detail-data-body-list"><%=hdc.getEventListREFCODE()%></td>
            <td  class="detail-data-body-list"><%=hdc.getEventListDate()%></td>
            <td  class="detail-data-body-list"><%=hdc.getEventListTime()%></td>
            <td class="detail-data-body-list"><%=hdc.getEventListDescription()%></td>\
             </tr>
            <% }
            }
            }%>
