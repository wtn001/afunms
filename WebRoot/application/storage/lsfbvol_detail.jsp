...
<%
	...
	List lsfbvolList = (List)request.getAttribute("lsfbvolList");
...
function setClass(){
	document.getElementById('storageDetailTitle-4').className='detail-data-title';
	document.getElementById('storageDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('storageDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
											    				...
											    				<td>
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">Name</td>
																		 	<td class="application-detail-data-body-title">ID</td>
																			<td class="application-detail-data-body-title">accstate</td>
																			<td class="application-detail-data-body-title">datastate</td>
																			<td class="application-detail-data-body-title">configstate</td>
																			<td class="application-detail-data-body-title">deviceMTM</td>
																			<td class="application-detail-data-body-title">datatype</td>
																			<td class="application-detail-data-body-title">extpool</td>
																			<td class="application-detail-data-body-title">cap (2^30B)</td>
																			<td class="application-detail-data-body-title">cap (10^9B)</td>
																			<td class="application-detail-data-body-title">cap (blocks)</td>
														           		</tr>
														           		
														           		<% 
														           			if(lsfbvolList != null && lsfbvolList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lsfbvolList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lsfbvolList.get(i);
														           					if(per_hashtable!=null){
														           						num++;
														           				%>
														           					<tr height="28">
																	          			<td class="application-detail-data-body-list"><input type="checkbox" name="checkall" id="checkall"><%=num%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("Name")%></td>
																					 	<td class="application-detail-data-body-list"><%=per_hashtable.get("ID")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("accstate")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("datastate")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("configstate")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("deviceMTM")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("datatype")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("extpool")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("cap (2^30B)")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("cap (10^9B)")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("cap (blocks)")%></td>
																	           		</tr>
														           				<%
														           					}
														           				}
