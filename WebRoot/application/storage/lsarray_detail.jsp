...
<%
	...
	List lsarrayList = (List)request.getAttribute("lsarrayList");
											    				...
											    				<td>
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">Array</td>
																		 	<td class="application-detail-data-body-title">State</td>
																			<td class="application-detail-data-body-title">Data</td>
																			<td class="application-detail-data-body-title">RAIDtype</td>
																			<td class="application-detail-data-body-title">arsite</td>
																			<td class="application-detail-data-body-title">Rank</td>
																			<td class="application-detail-data-body-title">DA Pair</td>
																			<td class="application-detail-data-body-title">DDMcap (10^9B)</td>
														           		</tr>
														           		
														           		<% 
														           			if(lsarrayList != null && lsarrayList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lsarrayList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lsarrayList.get(i);
														           					if(per_hashtable!=null){
														           						num++;
														           				%>
														           					<tr height="28">
																	          			<td class="application-detail-data-body-list"><input type="checkbox" name="checkall" id="checkall"><%=num%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("Array")%></td>
																					 	<td class="application-detail-data-body-list"><%=per_hashtable.get("State")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("Data")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("RAIDtype")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("arsite")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("Rank")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("DA Pair")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("DDMcap (10^9B)")%></td>
																	           		</tr>
														           				<%
														           					}
														           				}
