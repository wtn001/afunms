...
<%
		...
		List lsarraysiteList = (List)request.getAttribute("lsarraysiteList");
											    				...
											    				<td>
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">dkcap (10^9B)</td>
																			<td class="application-detail-data-body-title">State</td>
																			<td class="application-detail-data-body-title">Array</td>
														           		</tr>
														           		
														           		<% 
														           			if(lsarraysiteList != null && lsarraysiteList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lsarraysiteList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lsarraysiteList.get(i);
														           				...
														           				%>
														           					<tr height="28">
																						...
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("dkcap (10^9B)")%></td>
