...
<%
	...
	List lsextpoolList = (List)request.getAttribute("lsextpoolList");
...
function setClass(){
	document.getElementById('storageDetailTitle-3').className='detail-data-title';
	document.getElementById('storageDetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('storageDetailTitle-3').onmouseout="this.className='detail-data-title'";
}
											    				...
											    				<td>
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">stgtype</td>
																			<td class="application-detail-data-body-title">rankgrp</td>
																			<td class="application-detail-data-body-title">status</td>
																			<td class="application-detail-data-body-title">availstor (2^30B)</td>
																			<td class="application-detail-data-body-title">%allocated</td>
																			<td class="application-detail-data-body-title">available</td>
																			<td class="application-detail-data-body-title">reserved</td>
																			<td class="application-detail-data-body-title">numvols</td>
														           		</tr>
														           		
														           		<% 
														           			if(lsextpoolList != null && lsextpoolList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lsextpoolList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lsextpoolList.get(i);
														           				...
														           				%>
														           					<tr height="28">
																						...
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("stgtype")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("rankgrp")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("status")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("availstor (2^30B)")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("%allocated")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("available")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("reserved")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("numvols")%></td>
																	           		</tr>
														           				<%
														           					}
														           				}
