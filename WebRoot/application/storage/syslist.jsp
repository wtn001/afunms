...
<!-- 右键菜单结束-->
    ...
    <td  width="25%" align="center">产品号</td>
    <td  width="25%" align="center">版本号</td>
    <td  width="25%" align="center">序列号</td>
  </tr>

     
            <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
            <%if(pro != null && !pro.equals("")) {%>
            <td  class="detail-data-body-list"><%=pro%></td>
            <%} else{%>
            ...
            <%} %>
             ...
             if(version != null && !version.equals("")){
              ...
              %>
            <td class="detail-data-body-list"><%=version%></td>
              <%} else{%>
               <td class="detail-data-body-list"></td>
            <%} %>
