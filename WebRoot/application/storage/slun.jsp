...
<%
	...
	String	lun=(String)request.getAttribute("lun");
	String	state=(String)request.getAttribute("state");
	String	wwn=(String)request.getAttribute("wwn");
...
function showController(id , ip){  
               window.open("<%=rootPath%>/netreport.do?action=storageSlunCon&id="+id,'mywindow','width=,height=,resizable=1');
  }
 function showSafety(id , ip){  
               window.open("<%=rootPath%>/netreport.do?action=storageSafety&id="+id,'mywindow','width=,height=,resizable=1');
  }
...
<!-- 右键菜单结束-->
    ...
    <td  width="10%" align="center">LUN端口</td>
    <td  width="30%" align="center">wwn安全</td>
    <td  width="15%" align="center">控制器状态</td>
            ...
            <td class="detail-data-body-list"><%=pointId%></td>
             ...
             if(lun != null && !lun.equals("")){
              %>
            <td class="detail-data-body-list"><%=lun%></td>
                <%
            }else{
             %>
             <td  class="detail-data-body-list"></td>
              <%} %>
             <%if(wwn != null && !wwn.equals("")) {
                  if("0".equals(wwn)){
                %>
             <td align="center" class="body-data-list">
					     <table>
							 <tr>
								<td align="center" width="50%">不可访问</td>
								<td align="center" width="50%"><img src="<%=rootPath%>/resource/image/a_xn.gif" onclick='showSafety("<%=tmp%>" , "<%=ip%>")' width=15></td>
							</tr>
						</table>
			</td>
            <%
             ...
             %>
              <td align="center" class="body-data-list">
					     <table>
							 <tr>
								<td align="center" width="50%">可访问</td>
								<td align="center" width="50%"><img src="<%=rootPath%>/resource/image/a_xn.gif" onclick='showSafety("<%=tmp%>" , "<%=ip%>")' width=15></td>
							</tr>
						</table>
			</td>
