...
<%
	...
	List lsioportList = (List)request.getAttribute("lsioportList");
											    				...
											    				<td>
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">Type</td>
																		 	<td class="application-detail-data-body-title">topo</td>
																			<td class="application-detail-data-body-title">portgrp</td>
														           		</tr>
														           		
														           		<% 
														           			if(lsioportList != null && lsioportList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lsioportList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lsioportList.get(i);
														           				...
														           				%>
														           					<tr height="28">
																						...
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("Type")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("topo")%></td>
