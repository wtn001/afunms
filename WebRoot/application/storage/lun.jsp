...
function refer(action){
 ...
 function showController(id , ip){  
               window.open("<%=rootPath%>/netreport.do?action=storageLunCon&id="+id,'mywindow','width=,height=,resizable=1');
  }
 function showSwitch(id , ip){  
               window.open("<%=rootPath%>/netreport.do?action=storageSwitch&id="+id,'mywindow','width=,height=,resizable=1');
  }
...
<!-- 右键菜单结束-->
    ...
    <td  width="25%" align="center">转换序列号</td>
    <td  width="25%" align="center">转换端口ID</td>
    <td  width="25%" align="center">转换开关</td>
    <td  width="25%" align="center">交换控制器状态</td>
  </tr>
              ...
              <td align="center" class="body-data-list">
					     <table>
							 <tr>
								...
								<td align="center" width="50%"><img src="<%=rootPath%>/resource/image/a_xn.gif" onclick='showSwitch("<%=tmp%>" , "<%=ip%>")' width=15></td>
							</tr>
						</table>
			</td>
            <%
             ...
             %>
               <td align="center" class="body-data-list">
					     <table>
							 <tr>
								<td align="center" width="50%">关闭</td>
								<td align="center" width="50%"><img src="<%=rootPath%>/resource/image/a_xn.gif" onclick='showSwitch("<%=tmp%>" , "<%=ip%>")' width=15></td>
							</tr>
						</table>
			</td>
