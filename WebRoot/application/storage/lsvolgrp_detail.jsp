...
<%
	...
	List lsvolgrpList = (List)request.getAttribute("lsvolgrpList");
											    				...
											    				<td>
											    					<table>
											    						<tr height="28">
														           		...
														           		<% 
														           			if(lsvolgrpList != null && lsvolgrpList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lsvolgrpList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lsvolgrpList.get(i);
