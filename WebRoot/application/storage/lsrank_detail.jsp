...
<%
	...
	List lsrankList = (List)request.getAttribute("lsrankList");
											    					...
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">ID</td>
																		 	<td class="application-detail-data-body-title">Group</td>
																			...
																			<td class="application-detail-data-body-title">extpoolID</td>
																			<td class="application-detail-data-body-title">stgtype</td>
														           		</tr>
														           		
														           		<% 
														           			if(lsrankList != null && lsrankList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lsrankList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lsrankList.get(i);
														           				...
														           				%>
														           					<tr height="28">
																						...
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("ID")%></td>
																					 	<td class="application-detail-data-body-list"><%=per_hashtable.get("Group")%></td>
																						...
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("extpoolID")%></td>
