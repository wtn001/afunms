...
<%
	...
	List lshostconnectList = (List)request.getAttribute("lshostconnectList");
...
function setClass(){
	document.getElementById('storageDetailTitle-7').className='detail-data-title';
	document.getElementById('storageDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('storageDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
											    				...
											    				<td>
											    					<table>
											    						<tr height="28">
																			...
																			<td class="application-detail-data-body-title">WWPN</td>
																			<td class="application-detail-data-body-title">HostType</td>
																		 	<td class="application-detail-data-body-title">Profile</td>
																			<td class="application-detail-data-body-title">portgrp</td>
																			<td class="application-detail-data-body-title">volgrpID</td>
																			<td class="application-detail-data-body-title">ESSIOport</td>
														           		</tr>
														           		
														           		<% 
														           			if(lshostconnectList != null && lshostconnectList.size()>0 ){
														           				int num = 0;
														           				for(int i = 0 ; i < lshostconnectList.size(); i++ ){
														           					Hashtable per_hashtable = (Hashtable)lshostconnectList.get(i);
														           				...
														           				%>
														           					<tr height="28">
																						...
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("WWPN")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("HostType")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("Profile")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("portgrp")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("volgrpID")%></td>
																						<td class="application-detail-data-body-list"><%=per_hashtable.get("ESSIOport")%></td>
																	           		</tr>
														           				<%
														           					}
														           				}
