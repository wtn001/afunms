...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk3 = checkinput("ip_address","ip","IP地址",30,false);
     var chk4 = checkinput("port_gateway","string","监听端口",30,false);
     
     if(chk3&&chk4)
     {
        Ext.MessageBox.wait('数据加载中，请稍后.. '); 
        mainForm.action = "<%=rootPath%>/cics.do?action=find";
        mainForm.submit();
     }  
 });	
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> CICS服务添加</td>
						...
						<tr style="background-color: #ECECEC;">						
							<TD nowrap align="right" height="24" width="10%">发现方式&nbsp;</TD>				
							<TD nowrap width="40%" colspan=3>&nbsp;
								<select name="find_type"  class="formStyle">
						...
						<tr>					
							<TD nowrap align="right" height="24" width="10%">Gateway Daemon IP地址&nbsp;</TD>				
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" name="ip_address" maxlength="50" size="50" class="formStyle" value="">
							</TD>
						</tr>
						<tr style="background-color: #ECECEC;">						
							<TD nowrap align="right" height="24" width="10%">Gateway端口&nbsp;</TD>				
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" name="port_gateway" maxlength="50" size="20" class="formStyle">
							</TD>		
						</tr>
						...
						<tr>
							...
							<br><input type="button" value="发现" style="width:50" id="process" onclick="#">&nbsp;&nbsp;
