...
<%
  ...
  PSTypeVo vo = (PSTypeVo)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk1 = checkinput("port","number","端口",30,false);
     var chk2 = checkinput("ipaddress","ip","IP地址",30,false);
     var chk3 = checkinput("portdesc","string","端口描述",15,false);
     
    if(chk1&&chk2&&chk3)
     {
        mainForm.action = "<%=rootPath%>/pstype.do?action=update";
        mainForm.submit();
     } 
    ...
    <input type=hidden name="id" value="<%=vo.getId()%>">
		...
		<table id="body-container" class="body-container">
			<tr>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >>端口编辑</td>
				...
				<TD nowrap width="40%">&nbsp;
					<input type="text" name="ipaddress" maxlength="50" size="20" class="formStyle" value="<%=vo.getIpaddress()%>" ><font color='red'>*</font>
				</TD>					
				<TD nowrap align="right" height="24" width="10%">端口&nbsp;</TD>				
				<TD nowrap width="40%">&nbsp;
					<input type="text" name="port" maxlength="50" size="20" class="formStyle" value="<%=vo.getPort()%>"><font color='red'>*</font>
				</TD>															
							
			</tr>												
			<tr>
				<TD nowrap align="right" height="24" width="10%">服务描述&nbsp;</TD>	
						
				<TD nowrap width="40%">&nbsp;
					<input type="text" name="portdesc" maxlength="50" size="20" class="formStyle" value="<%=vo.getPortdesc()%>"><font color='red'>*</font>
				</TD>
