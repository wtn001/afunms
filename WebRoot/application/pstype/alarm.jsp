...
<%
	...
	int status = 0;
	Node node = (Node) PollingEngine.getInstance().getSocketByID(
			queryconf.getId());
	String alarmmessage = "";
	if (node != null) {
...
function setClass(){
	document.getElementById('psDetailTitle-1').className='detail-data-title';
	document.getElementById('psDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('psDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
...
function query()
  {  
     mainForm.action = "<%=rootPath%>/pstype.do?action=alarm";
     mainForm.submit();
  }
