...
<%
  ...
  DHCPConfig vo = (DHCPConfig)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     //if(chk1&&chk2&&chk3&&chk4)
     {
        ...
        mainForm.action = "<%=rootPath%>/dhcp.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 服务管理 >> DHCP编辑</td>
			        												...
			        												<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
																		<TBODY>
																			<tr style="background-color: #ECECEC;">						
																				...
																				<TD nowrap width="40%">&nbsp;
																					<input type="text" name="name" maxlength="50" size="20" class="formStyle" value="<%=vo.getAlias()%>">
																				</TD>
																			...
																			<tr >	
																				<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>团体名称&nbsp;</TD>				
																				<TD nowrap width="40%">&nbsp;
																					<input type="text" name="community" maxlength="50" size="20" class="formStyle" value="<%=vo.getCommunity()%>">
																				</TD>	
																				<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>类型&nbsp;</TD>				
																				<TD nowrap width="40%">&nbsp;
																					<select   name="dhcptype"  class="formStyle">
																							<option value=<%=vo.getDhcptype()%> selected><%=vo.getDhcptype()%></option>
