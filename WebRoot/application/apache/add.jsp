...
Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2&&chk3&&chk4&&chk5)
     {
        ...
        mainForm.action = "<%=rootPath%>/apache.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
...
<!-- 这里用来定义需要显示的右键菜单 -->
	...
	<form id="mainForm" method="post" name="mainForm">
		...
		<table id="body-container" class="body-container">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> Apache监视添加</td>
			...
			<TD nowrap width="40%">&nbsp;<input type="text" id="ipaddress" name="ipaddress" size="20" class="formStyle"><font color='red'>*</font></TD>						
			</tr>
			<tr>						
			<TD nowrap align="right" height="24" width="10%">用户名&nbsp;</TD>				
			<TD nowrap width="40%">&nbsp;<input type="text" id="username" name="username" size="20" class="formStyle" value="admin"></TD>				
			...
			<tr style="background-color: #ECECEC;">
		    		<TD nowrap align="right" height="24">端口&nbsp;</TD>				
            			<TD nowrap>&nbsp;<input type="text" id="port" name="port" size="20" class="formStyle" value="80"><font color='red'>*</font></TD>
