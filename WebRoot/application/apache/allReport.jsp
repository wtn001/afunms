...
{
	mainForm.action = "<%=rootPath%>/apache.do?action=downloadAllReport&id=<%=id%>&ipaddress=<%=ipaddress%>&str=0";
	mainForm.submit();
}
function ping_excel_report()
{
	mainForm.action = "<%=rootPath%>/apache.do?action=downloadAllReport&id=<%=id%>&ipaddress=<%=ipaddress%>&str=1";
	mainForm.submit();
}
function ping_pdf_report()
{
	mainForm.action = "<%=rootPath%>/apache.do?action=downloadAllReport&id=<%=id%>&ipaddress=<%=ipaddress%>&str=2";
	mainForm.submit();
}
function query()
{
	...
	mainForm.action = "<%=rootPath%>/apache.do?action=allReport&ipaddress=<%=ipaddress%>&id=<%=id%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
