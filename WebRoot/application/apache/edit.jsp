...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     //if(chk1&&chk2&&chk3&&chk4)
     {
        ...
        mainForm.action = "<%=rootPath%>/apache.do?action=update";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
...
<!-- 这里用来定义需要显示的右键菜单 -->
   ...
   <form name="mainForm" method="post">
		...
		<table id="body-container" class="body-container">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> Apache监视编辑</td>
			...
			<TD nowrap width="40%">&nbsp;<input type="text" name="ipaddress" size="20" class="formStyle" value="<%=vo.getIpaddress()%>"><font color='red'>*</font></TD>						
			</tr>
			<tr>						
			<TD nowrap align="right" height="24" width="10%">用户名&nbsp;</TD>				
			<TD nowrap width="40%">&nbsp;<input type="text" name="username" size="20" class="formStyle" value="<%=vo.getUsername()%>"></TD>				
			...
			<tr style="background-color: #ECECEC;">
		    		<TD nowrap align="right" height="24">端口&nbsp;</TD>				
            			<TD nowrap>&nbsp;<input type="text" name="port" size="20" class="formStyle" value="<%=vo.getPort()%>"><font color='red'>*</font></TD>
			...
			<tr>
							...
							<TD nowrap width="40%" colspan=3>&nbsp;
								<select   name="flag1"  class="formStyle">
								<%
									if(vo.getFlag() == 0){
								%>
