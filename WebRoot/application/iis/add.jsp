...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2&&chk3)
     {
        ...
        mainForm.action = "<%=rootPath%>/iis.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> IIS添加</td>
						...
						<tr>					
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" ip="ipaddress" name="ipaddress" maxlength="50" size="50" class="formStyle" >
							</TD>
