...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
  			var chk = checkinput("name","string","作业组名称",200,false);
  			if(chk){
  				 Ext.MessageBox.wait('数据加载中，请稍后.. ');
        	mainForm.action = "<%=rootPath%>/jobForAS400Group.do?action=save";
        	mainForm.submit();
  			}
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title"> 应用 &gt;&gt; AS400 作业组管理 &gt;&gt; 添加 </td>
				        													...
				        													<tr>
				        														<td>
				        															<table>
																						...
																						<tr>						
																							<td align="right" height="24" width="10%">作业组名称:&nbsp;</td>				
																							    ...
																							    <!-- nielin modify begin (Phone div)*/ 2009-01-03--->
																							        <div id="formDiv" style="">         
																						                <table width="100%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none border=1 algin="center" >
																					                        ...
																					                        <tr>
																					                            <td align="center">           
																					                                <table id="jobForAS400GroupDetailTable"  style="width:90%; padding:0;  background-color:#FFFFFF;" >
																				                                        <tr>
																				                                            <td colspan="0" height="50" align="center"> 
																				                                                <span  onClick='addRow("jobForAS400GroupDetailTable");' style="border: 1px solid black;margin:10px;padding:0px 3px 0px 3px;cursor: hand;">增加一行</span>
																				                                            </td>
																				                                        </tr>
																					                                </table>
																					                            </td>
