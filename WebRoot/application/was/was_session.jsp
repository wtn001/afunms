...
function setClass(){
	document.getElementById('wasDetailTitle-2').className='detail-data-title';
	document.getElementById('wasDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('wasDetailTitle-2').onmouseout="this.className='detail-data-title'";
}
																...
																<td>
																	<table width="96%" align="center">
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (SessionManagerHst.get("ActivateNonExistSessionCount") != null) {
																			%>
																			...
																			<%
																				if (SessionManagerHst.get("CacheDiscardCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("CacheDiscardCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (SessionManagerHst.get("LiveCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("LiveCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (SessionManagerHst.get("LifeTime") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("LifeTime")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			<td width="15%" height="26" align="left" nowrap
																				class=txtGlobal>
																				&nbsp;前一个和当前访问时间戳记的时间之差（毫秒）:
																			</td>
																			<%
																				if (SessionManagerHst.get("TimeSinceLastActivated") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("TimeSinceLastActivated")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (SessionManagerHst.get("ExternalWriteSize") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("ExternalWriteSize")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (SessionManagerHst.get("CreateCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("CreateCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<td width="15%" height="26" align="left" nowrap
																				class=txtGlobal>
																				&nbsp;仅适用于AllowOverflow=false的内存中的会话:
																			</td>
																			<%
																				if (SessionManagerHst.get("NoRoomForNewSessionCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("NoRoomForNewSessionCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (SessionManagerHst.get("SessionObjectSize") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("SessionObjectSize")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (SessionManagerHst.get("ExternalWriteTime") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("ExternalWriteTime")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (SessionManagerHst.get("ExternalReadSize") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("ExternalReadSize")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (SessionManagerHst.get("AffinityBreakCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("AffinityBreakCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (SessionManagerHst.get("InvalidateCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("InvalidateCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (SessionManagerHst.get("TimeoutInvalidationCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("TimeoutInvalidationCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (SessionManagerHst.get("ActiveCount") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("ActiveCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (SessionManagerHst.get("ExternalReadTime") != null) {
																			%>
																			<td width="35%"><%=SessionManagerHst.get("ExternalReadTime")%>
																			</td>
																			<%
																				} else {
																			%>
