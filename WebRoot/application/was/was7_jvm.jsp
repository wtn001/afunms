...
function setClass(){
	document.getElementById('was7DetailTitle-3').className='detail-data-title';
	document.getElementById('was7DetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('was7DetailTitle-3').onmouseout="this.className='detail-data-title'";
}
