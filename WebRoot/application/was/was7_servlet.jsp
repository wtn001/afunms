...
function setClass(){
	document.getElementById('was7DetailTitle-2').className='detail-data-title';
	document.getElementById('was7DetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('was7DetailTitle-2').onmouseout="this.className='detail-data-title'";
}
