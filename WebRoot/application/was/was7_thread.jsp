...
function setClass(){
	document.getElementById('was7DetailTitle-5').className='detail-data-title';
	document.getElementById('was7DetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('was7DetailTitle-5').onmouseout="this.className='detail-data-title'";
}
