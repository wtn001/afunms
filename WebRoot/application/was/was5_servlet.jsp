	...
	Hashtable wasIpaddressData = null;
 	...
 	if("0".equals(runmodel)){
		  ...
		  if(wasIpaddressData != null){
		  	...
		  	hm = CommonUtil.converHashTableToHashMap(servletHashtable); 
		  }
  	}else{
  		 //采集与访问分离模式
  		 GetWasInfo wasconf = new GetWasInfo();
  		 try{
		 	hm = wasconf.executeQueryHashMap(vo.getIpaddress(),"wassession");
	 	 }catch(Exception e){
		 	e.printStackTrace();
		 }finally{
		 	 wasconf.close();
...
function setClass(){
	document.getElementById('was5DetailTitle-2').className='detail-data-title';
	document.getElementById('was5DetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('was5DetailTitle-2').onmouseout="this.className='detail-data-title'";
}
																...
																<td>
																	<table width="96%" align="center">
																		...
																		<tr>
																			...
																			<%
																				if (hm.get("invalidateCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("invalidateCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (hm.get("lifeTime") != null) {
																			%>
																			<td width="35%"><%=hm.get("lifeTime")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (hm.get("liveCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("liveCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (hm.get("timeoutInvalidationCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("timeoutInvalidationCount")%>
																			</td>
																			<%
																				} else {
																			%>
