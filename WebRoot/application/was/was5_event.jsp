...
<script language="javascript">	
  ...
  function doQuery()
  {  
     mainForm.action = "<%=rootPath%>/was.do?action=event&flag=<%=flag_1%>";
     mainForm.submit();
  }
...
function setClass(){
	document.getElementById('was5DetailTitle-7').className='detail-data-title';
	document.getElementById('was5DetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('was5DetailTitle-7').onmouseout="this.className='detail-data-title'";
}
