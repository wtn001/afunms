...
<%
	...
	if("0".equals(runmodel)){
		  ...
		  if(wasIpaddressData != null){
		  	...
		  	hm = CommonUtil.converHashTableToHashMap(transHashtable); 
		  }
  	}else{
  		 //采集与访问分离模式
  		 GetWasInfo wasconf = new GetWasInfo();
  		 try{
		 	hm = wasconf.executeQueryHashMap(vo.getIpaddress(),"wastrans");
	 	 }catch(Exception e){
		 	e.printStackTrace();
		 }finally{
		 	 wasconf.close();
...
function setClass(){
	document.getElementById('was7DetailTitle-6').className='detail-data-title';
	document.getElementById('was7DetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('was7DetailTitle-6').onmouseout="this.className='detail-data-title'";
}
																...
																<td>
																	<table width="96%" align="center">
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (hm.get("activeCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("activeCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (hm.get("committedCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("committedCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (hm.get("globalBegunCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("globalBegunCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (hm.get("globalTimeoutCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("globalTimeoutCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (hm.get("globalTranTime") != null) {
																			%>
																			<td width="35%"><%=hm.get("globalTranTime")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (hm.get("localActiveCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("localActiveCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (hm.get("localBegunCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("localBegunCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (hm.get("localRolledbackCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("localRolledbackCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (hm.get("localTimeoutCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("localTimeoutCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (hm.get("localTranTime") != null) {
																			%>
																			<td width="35%"><%=hm.get("localTranTime")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (hm.get("rolledbackCount") != null) {
																			%>
																			<td width="35%"><%=hm.get("rolledbackCount")%>
																			</td>
																			<%
																				} else {
																			%>
