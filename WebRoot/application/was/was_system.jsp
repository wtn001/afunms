...
function setClass(){
	document.getElementById('wasDetailTitle-3').className='detail-data-title';
	document.getElementById('wasDetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('wasDetailTitle-3').onmouseout="this.className='detail-data-title'";
}
																...
																<td>
																	<table width="96%" align="center">
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (SystemMetricsHst.get("FreeMemory") != null) {
																			%>
																			<td width="35%"><%=SystemMetricsHst.get("FreeMemory")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (SystemMetricsHst.get("CPUUsageSinceServerStarted") != null) {
																			%>
																			<td width="35%"><%=cpu_percent%>%
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (SystemMetricsHst.get("CPUUsageSinceLastMeasurement") != null) {
																			%>
																			<td width="35%"><%=SystemMetricsHst.get("CPUUsageSinceLastMeasurement")%>%
																			</td>
																			<%
																				} else {
																			%>
