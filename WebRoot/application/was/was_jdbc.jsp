...
function setClass(){
	document.getElementById('wasDetailTitle-1').className='detail-data-title';
	document.getElementById('wasDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('wasDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
																...
																<td>
																	<table width="96%" align="center">
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (JDBCProviderHst.get("FreePoolSize") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("FreePoolSize")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("UseTime") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("UseTime")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (JDBCProviderHst.get("PrepStmtCacheDiscardCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst
										.get("PrepStmtCacheDiscardCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("ReturnCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("ReturnCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (JDBCProviderHst.get("AllocateCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("AllocateCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("FaultCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("FaultCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			<td width="15%" height="26" align="left" nowrap
																				class=txtGlobal>
																				&nbsp;特定连接池ManagedConnection对象数:
																			</td>
																			<%
																				if (JDBCProviderHst.get("ManagedConnectionCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("ManagedConnectionCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("WaitingThreadCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("WaitingThreadCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (JDBCProviderHst.get("JDBCTime") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("JDBCTime")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("PercentMaxed") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("PercentMaxed")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (JDBCProviderHst.get("WaitTime") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("WaitTime")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("CreateCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("CreateCount")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			<td width="15%" height="26" align="left" nowrap
																				class=txtGlobal>
																				&nbsp;用于特定连接池的Connection对象数:
																			</td>
																			<%
																				if (JDBCProviderHst.get("ConnectionHandleCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("ConnectionHandleCount")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("PercentUsed") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("PercentUsed")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (JDBCProviderHst.get("PoolSize") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("PoolSize")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JDBCProviderHst.get("CloseCount") != null) {
																			%>
																			<td width="35%"><%=JDBCProviderHst.get("CloseCount")%>
																			</td>
																			<%
																				} else {
																			%>
