...
function setClass(){
	document.getElementById('was5DetailTitle-4').className='detail-data-title';
	document.getElementById('was5DetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('was5DetailTitle-4').onmouseout="this.className='detail-data-title'";
}
