...
function setClass(){
	document.getElementById('was5DetailTitle-6').className='detail-data-title';
	document.getElementById('was5DetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('was5DetailTitle-6').onmouseout="this.className='detail-data-title'";
}
