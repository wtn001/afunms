															...
															<tr>
																<td>
																	<table width="96%" align="center">
																		<tr bgcolor="#F1F1F1">
																			<td width="25%" height="26" align="left"
																				class="application-detail-data-body-list">
																				&nbsp;JVM已运行的时间数(秒):
																			</td>
																			<%
																				if (JvmHst.get("UpTime") != null) {
																			%>
																			<td width="25%"
																				class="application-detail-data-body-list"><%=JvmHst.get("UpTime")%>
																			</td>
																			<%
																				} else {
																			%>
																			<td width="25%"
																				class="application-detail-data-body-list"></td>
																			<%
																				}
																			%>
																			<td width="25%" height="26" align="left"
																			...
																			<%
																				if (JvmHst.get("ProcessCpuUsage") != null) {
																			%>
																			<td width="25%"
																				class="application-detail-data-body-list"><%=JvmHst.get("ProcessCpuUsage")%>%
																			</td> 
																			<%
																				} else {
																			%>
																		...
																		<tr>
																			...
																			<%
																				if (JvmHst.get("HeapSize") != null) {
																			%>
																			<td width="25%"
																				class="application-detail-data-body-list"><%=JvmHst.get("HeapSize")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JvmHst.get("UsedMemory") != null) {
																			%>
																			<td width="25%"
																				class="application-detail-data-body-list"><%=JvmHst.get("UsedMemory")%>
																			</td>
																			<%
																				} else {
																			%>
																		...
																		<tr bgcolor="#F1F1F1">
																			...
																			<%
																				if (JvmHst.get("FreeMemory") != null) {
																			%>
																			<td width="25%"
																				class="application-detail-data-body-list"><%=JvmHst.get("FreeMemory")%>
																			</td>
																			<%
																				} else {
																			%>
																			...
																			<%
																				if (JvmHst.get("memPer") != null) {
																			%>
																			<td width="25%"
																				class="application-detail-data-body-list"><%=JvmHst.get("memPer")%>%
																			</td>
																			<%
																				} else {
																			%>
