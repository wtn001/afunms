...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk3 = checkinput("portnum","string","文件名称",30,false);
     ...
     if(chk1&&chk2&&chk3)
     {
        ...
        mainForm.action = "<%=rootPath%>/was.do?action=add";
        mainForm.submit();
     }  
       // mainForm.submit();
 });	
		...
		<table id="body-container" class="body-container">
			<tr>
				...
				<td class="td-container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> WAS添加</td>
					...
					<!--	<tr>						
							<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>节点名称&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="nodename" name="nodename" maxlength="50" size="20" class="formStyle"><font color="red">（V6必填）</font>
							</TD>
							<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>服务名称&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="servername" name="servername" maxlength="50" size="20" class="formStyle" ><font color="red">（V6必填）</font>
							</TD>
						</tr>
					-->
						...
						<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>端口&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" id="portnum" name="portnum" maxlength="50" size="20" class="formStyle">
							</TD>
							<TD nowrap align="right" height="24" width="10%">版本&nbsp;</TD>				
