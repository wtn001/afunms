...
<%
    ...
    if("0".equals(runmodel)){
		  ...
		  if(wasIpaddressData != null && wasIpaddressData.containsKey("systemDatahst")){
...
function setClass(){
	document.getElementById('was5DetailTitle-0').className='detail-data-title';
	document.getElementById('was5DetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('was5DetailTitle-0').onmouseout="this.className='detail-data-title'";
}
	...
	<form method="post" name="mainForm">
		...
		<table id="body-container" class="body-container">
			<tr>
				...
				<td width=15% valign=top><jsp:include page="/include/was5toolbar.jsp"><jsp:param value="<%=vo.getId()%>" name="id" />
					</jsp:include>
				</td>
			</tr>
		</table>
