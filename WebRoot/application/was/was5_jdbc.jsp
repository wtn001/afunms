...
function setClass(){
	document.getElementById('was5DetailTitle-1').className='detail-data-title';
	document.getElementById('was5DetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('was5DetailTitle-1').onmouseout="this.className='detail-data-title'";
}
