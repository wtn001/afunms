...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/dbtype.do?action=add";
            mainForm.submit();
     }
       // mainForm.submit();
 });	
...
<body id="body" class="body" onload="initmenu();">
	...
	<form id="mainForm" method="post" name="mainForm">
		...
		<table id="body-container" class="body-container">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 数据库管理 >> 数据库类型添加</td>
			...
			<TD nowrap width="40%">&nbsp;<input type="text" name="dbtype" size="20" class="formStyle"><font color='red'>*</font></TD>															
			<TD nowrap align="right" height="24">类型描述&nbsp;</TD>				
			<TD nowrap width="40%">&nbsp;<input type="text" name="dbdesc" size="20" class="formStyle"><font color='red'>*</font></TD>						
			</tr>      										                 										                      								
