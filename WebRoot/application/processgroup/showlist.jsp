											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title">&nbsp;资源 >> 性能监视 >> 进程监视列表 </td>
		        									...
		        									<tr>
		        										<td>
		        											<table>
		        												...
		        												<%
					        									    if(list!=null&& list.size()>0){
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									            ...
					        									            %>
					        									      <tr>
																<td align="center" class="body-data-list"><INPUT
																	type="checkbox" value="<%=processGroup.getId()%>"
																	name="checkbox" id="checkbox"><%=i + 1%></td>
																...
																<td align="center" class="body-data-list"><input
																	type="hidden" id="id" name="id" value="<%=processGroup.getId()%>">
																	<img class="img"
