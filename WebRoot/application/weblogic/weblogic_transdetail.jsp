...
<%
	...
	if(hash!=null){
	    ...
	    transdatalist = (List)hash.get("transValue");
	...
	<tr>
		...
		<td class="td-container-main">
									...
									<tr>
										<td>
											<jsp:include page="/topology/includejsp/middleware_weblogic.jsp">
												...
												<jsp:param name="id" value="<%= weblogicconf.getId()%>"/>
												<jsp:param name="name" value="<%= weblogicconf.getAlias()%>"/>
                   ...
                   <tr bgcolor="#ECECEC" height="28">
					 ...
					 <td align=center>提交交易总数</td>
					 <td align=center>回滚交易总数</td>
					 <td align=center>启发交易总数</td>
					 <td align=center>启发交易总数</td>
					 <td align=center>启发回滚交易总数</td>
					 <td align=center>启发混合交易总数</td>
					 <td align=center>启发危险交易总数</td>
                </tr>
			<%
				for(int i=0;i<transdatalist.size();i++){
					WeblogicTrans vo=(WeblogicTrans)transdatalist.get(i);
          ...
          <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> height="28">
			<td align=center class="application-detail-data-body-list" style="width:5%;word-break: break-all; word-wrap:break-word;nowrap:false;"><%=i+1%></td>         
            		<td align=center class="application-detail-data-body-list" style="width:30%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeResourceName()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionTotalCount()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionCommittedTotalCount()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionRolledBackTotalCount()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionHeuristicsTotalCount()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionHeuristicCommitTotalCount()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionHeuristicRollbackTotalCount()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionHeuristicMixedTotalCount()%></td>
            		<td align=center class="application-detail-data-body-list" style="width:8%;word-break: break-all; word-wrap:break-word;nowrap:false;">&nbsp;<%=vo.getTransactionResourceRuntimeTransactionHeuristicHazardTotalCount()%></td>
          </tr>
          <%}%>
                  </table>           
				</td>
				...
				<td width=15% valign=top>
															<jsp:include page="/include/weblogictoolbar.jsp">
															    ...
															    <jsp:param name="ip" value="<%= weblogicconf.getIpAddress()%>"/> 
															</jsp:include>
														</td>
			</tr>
		</table>
