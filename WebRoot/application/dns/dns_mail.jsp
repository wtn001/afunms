...
function setClass(){
	document.getElementById('dnsDetailTitle-3').className='detail-data-title';
	document.getElementById('dnsDetailTitle-3').onmouseover="this.className='detail-data-title'";
	document.getElementById('dnsDetailTitle-3').onmouseout="this.className='detail-data-title'";
		}
