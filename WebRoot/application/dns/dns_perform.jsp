...
<%
	...
	if(hash!=null){
		...
		if(hash.containsKey("primary")){
			primary=(String)hash.get("primary");
		}
		if(hash.containsKey("responsible")){
			responsible=(String)hash.get("responsible");
		}
		if(hash.containsKey("serial")){
			serial=(String)hash.get("serial");
		}
		if(hash.containsKey("refresh")){
			refresh=(String)hash.get("refresh");
		}
		if(hash.containsKey("retry")){
			retry=(String)hash.get("retry");
		}
		if(hash.containsKey("expire")){
			expire=(String)hash.get("expire");
		}
		if(hash.containsKey("dfault")){
			dfault=(String)hash.get("dfault");
		}
		if(hash.containsKey("time")){
			time=(String)hash.get("time");
		}
	}
...
function setClass(){
	document.getElementById('dnsDetailTitle-2').className='detail-data-title';
	document.getElementById('dnsDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('dnsDetailTitle-2').onmouseout="this.className='detail-data-title'";
		}
