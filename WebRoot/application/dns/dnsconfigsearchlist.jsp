...
<script language="javascript">	
  ...
  function toDelete()
  {
     mainForm.action = "<%=rootPath%>/dns.do?action=delete";
     mainForm.submit();
  }
	...
	<tr>
		...
		<td bgcolor="#ffffff" align="center" valign=top>
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none  border=1 algin="center">
				<tr>
					<td height="28" align="left" bordercolor="#397DBD" bgcolor="#397DBD" class="txtGlobalBold" colspan=3>&nbsp;&nbsp;<font color=#ffffff>应用 >> 服务列表 >> DNS服务列表</font></td>
				</tr> 				
				<tr>
					...
					<td colspan="2">
						<table cellspacing="1" cellpadding="0" width="100%">
	  						<tr class="microsoftLook0" height=28>
      								...
      								<th width='25%'>DNS主机</th>
      								<th width='10%'>DNS接口</th>
      								<th width='25%'>域名</th>
      								<th width='10%'>状态</th>        
      								<th width='10%'>是否监控</th>
      								<th width='10%'>操作</th>
			...
			%>
   										<tr bgcolor="DEEBF7" <%=onmouseoverstyle%> height=25>  
    											...
    											<td  align='center' ><%=vo.getHostip()%></td>
    											<td  align='center' ><%= vo.getHostinter()%></td>
    											<td  align='center'><%=vo.getDns()%></td>
    											<td  align='center'>
    											<%if(state==null)
    											{ %>
