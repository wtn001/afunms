													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">应用 >> 中间件管理 >> DNS编辑</td>
					...
					<TBODY>
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" name="hostip" maxlength="50" size="50" class="formStyle" value=<%=vo.getHostip()%>><font color="#ccccff">主机IP 例如202.106.0.20</font>
							</TD>
						</tr>
						<tr>					
							<TD nowrap align="right" height="24" width="10%">DNS接口&nbsp;&nbsp;&nbsp;&nbsp;</TD>				
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" name="hostinter" maxlength="50" size="20" class="formStyle" value="<%=vo.getHostinter()%>">
							</TD>
						</tr>
						<tr style="background-color: #ECECEC;">						
							<TD nowrap align="right" height="24" width="10%">域名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>				
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" name="dns" maxlength="50" size="50" class="formStyle" value="<%=vo.getDns()%>"><font color="#ccccff">例如.www.baidu.com</font>
							</TD>		
						</tr>
						<tr >						
							<TD nowrap align="right" height="24" width="10%">域名IP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>				
							<TD nowrap width="40%" colspan=3>&nbsp;
								<input type="text" name="dnsip" maxlength="50" size="50" class="formStyle" value="<%=vo.getDnsip()%>"><font color="#ccccff">www.baidu.com的IP 例如.202.106.0.0</font>
							</TD>		
						</tr>
						<tr  style="background-color: #ECECEC;">					
