...
<%
	...
	if(hash!=null){
		...
		if(hash.containsKey("cache")){
			cache=(List)hash.get("cache");
		}
...
function setClass(){
	document.getElementById('dnsDetailTitle-5').className='detail-data-title';
	document.getElementById('dnsDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('dnsDetailTitle-5').onmouseout="this.className='detail-data-title'";
		}
