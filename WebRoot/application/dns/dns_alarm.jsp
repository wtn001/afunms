...
function query()
  {  
  	 var id=<%=id%>
     mainForm.action = "<%=rootPath%>/dns.do?action=alarm&id="+id+"&flag=<%=flag%>";
     mainForm.submit();
  }
</script>
<script type="text/javascript">
function setClass(){
	document.getElementById('dnsDetailTitle-6').className='detail-data-title';
	document.getElementById('dnsDetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('dnsDetailTitle-6').onmouseout="this.className='detail-data-title'";
		}
</script>
<script type="text/javascript">
function event(){
