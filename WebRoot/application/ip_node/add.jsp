...
<script language="javascript">
  function toAdd()
  {
     ...
     if(chk1&&chk2)
     {
        mainForm.action = "<%=rootPath%>/ipnode.do?action=add";
        mainForm.submit();
     }
  }
...
<table id="body-container" class="body-container">
	<tr>
		...
		<table width="95%" border=0 cellpadding=0 cellspacing=0>
			...
			<tr>
				...
				<td height=300 bgcolor="#FFFFFF" valign="top"><br>
				 <table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
					<TBODY>
						<tr>
							<td nowrap align="left" colspan="4" height="24">定制节点--添加</td>
						</tr>
						<tr>
			...
			<TD nowrap width="40%">&nbsp;<input type="text" name="ip" size="30" class="formStyle"><font color="red">&nbsp;*</font></TD>															
