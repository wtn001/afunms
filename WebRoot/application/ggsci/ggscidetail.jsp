...
<%@page import="com.afunms.application.model.GgsciConfig"%>
...
<%
  ...
  GgsciConfig vo  = (GgsciConfig)request.getAttribute("vo");    
...
System.out.println(starttime1 + "--" + totime1);  
...
System.out.println(pingconavg + "--picip");
...
function setClass(){
	document.getElementById('ggsciDetailTitle-0').className='detail-data-title';
	document.getElementById('ggsciDetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('ggsciDetailTitle-0').onmouseout="this.className='detail-data-title'";
}
...
setInterval(gzmajax,60000);
	...
	<body id="body" class="body" onload="initmenu();">
		<form id="mainForm" method="post" name="mainForm">
			...
			<input type=hidden name="flag" id="flag" value="<%=flag_1 %>">
			 ...
			 <jsp:include page="/topology/includejsp/detail_content_footer.jsp"/>
																						...
																						<TBODY>
																							...
																							<%
																			                  if(returnHash != null && returnHash.size()>0){
																			                  		Vector v = (Vector)returnHash.get("ggsci");
																			                  		Hashtable ggsci = new Hashtable();
																			                    	for(int i=0;i<v.size();i++){
																			                    		ggsci = new Hashtable();
																			                    		ggsci = (Hashtable)v.get(i);
																		                  %>
																							<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>
																								...
																								<td class="application-detail-data-body-list"
																									align=center>
																									&nbsp;<%=ggsci.get("programName")%></td>
																								<td class="application-detail-data-body-list"
																									align=center>
																									&nbsp;<%=ggsci.get("status1")%></td>
																								<td class="application-detail-data-body-list"
																									align=center>
																									&nbsp;<%=ggsci.get("group1")%></td>
																								<td class="application-detail-data-body-list"
																									align=center>
																									&nbsp;<%=ggsci.get("lagAtChkpt")%></td>
																								<td class="application-detail-data-body-list"
																									align=center>
																									&nbsp;<%=ggsci.get("timeSinceChkpt")%></td>
																							</tr>
																							<%
																				          			}
																				          		}
					...
					<td  width=13% valign=top align=right>
							<jsp:include page="/include/dptoolbar.jsp">
								...
								<jsp:param value="ggsci" name="subtype"/>
							</jsp:include>
