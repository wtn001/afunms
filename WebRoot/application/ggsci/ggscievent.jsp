...
function setClass(){
	document.getElementById('ggsciDetailTitle-1').className='detail-data-title';
	document.getElementById('ggsciDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('ggsciDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
