...
<%
	...
	JBossConfig queryconf = (JBossConfig) request.getAttribute("jBossConfig");
...
function setClass(){
	document.getElementById('JBOSSDetailTitle-1').className='detail-data-title';
	document.getElementById('JBOSSDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('JBOSSDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
...
function show_graph(){
      mainForm.action = "<%=rootPath%>/jboss.do?action=detail";
      mainForm.submit();
} 
function query()
  {  
     mainForm.action = "<%=rootPath%>/jboss.do?action=alarm";
     mainForm.submit();
  }
</script>
		...
		<form id="mainForm" method="post" name="mainForm">
			...
			<table id="body-container" class="body-container">
				<tr>
					...
					<td width=15% valign=top><jsp:include page="/include/jbosstoolbar.jsp"><jsp:param value="<%=queryconf.getId() %>" name="id" />
