...
<%
	...
	Environment environment = (Environment) request
...
$.ajax({
			type:"GET",
			dataType:"json",
			url:"<%=rootPath%>/performancePanelAjaxManager.ajax?action=emcEnvironment&id=<%=host.getIpAddress()%>&flag="+flag,
			success:function(data){
															...
															<tr>
												      		   <td valign=top align="left">
																			 <div class="limitWidth">
	                                                                              ...
	                                                                              <ul class="sideNav" >
	                                                                                     <li ><a href="#" onclick="perList('<%="array" %>');">&nbsp;&nbsp;阵列电源</a>
		                                                                                 </li>
		                                                                                  <li ><a href="#" onclick="perList('<%="memory" %>');">&nbsp;&nbsp;存储模块电源</a>
		                                                                                 </li>
		                                                                                  <li ><a href="#" onclick="perList('<%="memtmp" %>');">&nbsp;&nbsp;存储入口温度</a>
		                                                                                 </li>
		                                                                                  <li ><a href="#" onclick="perList('<%="bakPower" %>');">&nbsp;&nbsp;SPS备用电源</a>
		                                                                                 </li>
	                                                                               </ul>
	                                                                          </div>
												                 </td>
												              ...
												              <td>
												                ...
												                <table cellspacing="0" cellpadding="0" width="width:100%" bgcolor="#FFFFFF" border=1  class="detail-data-body">
												                    <tr align="center" height=28 class="microsoftLook0">
    									                                 ...
    									                                 <th width='30%' align="center">平均功率(瓦特)</th>
								                                    </tr>
								                                    ...
								                                    <%
								                                      ...
								                                      Array vo = null;
								                                      if(environment != null){
								                                        vo = (Array)environment.getArray();
								                                      }
								                                      if(vo!= null){
								                                     %>
								                                    <tr align="center" height=28 class="microsoftLook">
    									                                 <td width='10%' align="center"><%=1 %></td>
    									                                 <td width='30%' align="center"><%=vo.getStatus() %></td>
    									                                 <td width='30%' align="center"><%=vo.getPresentWatts() %>&nbsp;&nbsp;&nbsp;<img src="/afunms/resource/image/a_xn.gif" onclick='arrayenvwt()'  ></td>
    									                                 <td width='30%' align="center"><%=vo.getAveragewatts()%>&nbsp;&nbsp;&nbsp;<img src="/afunms/resource/image/a_xn.gif" onclick='arrayenvavgwt()'  ></td>
								                                    </tr>
								                                   <% 
								                                   }
								                                   %>
