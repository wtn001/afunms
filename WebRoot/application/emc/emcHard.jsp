												              ...
												              <td>
												                ...
												                <table cellspacing="0" cellpadding="0" width="width:100%" bgcolor="#FFFFFF" border=0  class="detail-data-body">
								                                    <%
								                                     ...
								                                     %>
								                                    <tr >						
																			<td align="right" height="29" width="20%">名称:&nbsp;</td>				
																			<td width="80%" colspan=3>&nbsp;
																				<%=voo.getName() %>
																			</td>
																	</tr>
																	<tr  style="background-color: #ECECEC;">						
																			<td align="right" height="29" width="20%">存储器(SP)状态:&nbsp;</td>				
																			<td width="80%" colspan=3>&nbsp;
																	...
																	<tr >						
																			<td align="right" height="29" width="20%">电源状态:&nbsp;</td>				
																			<td width="80%" colspan=3>&nbsp;
																	...
																	<tr style="background-color: #ECECEC;">						
																			<td align="right" height="29" width="20%">备用电源(SPS)状态:&nbsp;</td>				
																			<td width="80%" colspan=3>&nbsp;
																				<%//if(voo.getSpStateStr() != null){out.print(voo.getSpStateStr().trim().replace("{","").replace("}","").replace("=","->"));} %>
																			     <table >
																			       <% 
																	...
																	<tr >						
																			<td align="right" height="29" width="15%">缆线连接(Cabling)状态:&nbsp;</td>				
