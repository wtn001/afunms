...
<%
	...
	List<RaidGroup> raidgroup = (List<RaidGroup>) request
			.getAttribute("raid");
...
$.ajax({
			type:"GET",
			dataType:"json",
			url:"<%=rootPath%>/performancePanelAjaxManager.ajax?action=emcRaid&ip=<%=host.getIpAddress()%>&flag="+flag+"&nodeid=<%=tmp%>",
			success:function(data){
												      		   ...
												      		   <td valign=top align="left">
								                                      ...
								                                      if(raidgroup!= null && raidgroup.size()>0){
								                                        for(int i=0;i<raidgroup.size();i++){
								                                          vo1 = (RaidGroup)raidgroup.get(i);
								                                     %>
	                                                                                     <li ><a href="#" onclick="perList('<%=vo1.getRid() %>');">Raid-<%=vo1.getRid() %></a>
		                                                                                 </li>
		                                                                                <%}} %>
	                                                                               </ul>
	                                                                          </div>
												              ...
												              <td>
												                ...
												                <table cellspacing="0" cellpadding="0" width="width:100%" bgcolor="#FFFFFF" border=1  class="detail-data-body">
												                    <tr align="center" height=28 class="microsoftLook0">
    									                                 ...
    									                                 <th width='30%' align="center">磁盘最大数量</th>
    									                                 <th width='30%' align="center">LUN最大数量</th>
								                                    </tr>
								                                    ...
								                                    <%
								                                      ...
								                                      if(raidgroup!= null && raidgroup.size()>0){
								                                        for(int i=0;i<raidgroup.size();i++){
								                                          vo = (RaidGroup)raidgroup.get(i);
								                                     %>
								                                    <tr align="center" height=28 class="microsoftLook">
    									                                 <td width='10%' align="center"><%=i+1 %></td>
    									                                 <td width='10%' align="center"><%=vo.getRid() %></td>
    									                                 <td width='20%' align="center"><%=vo.getType() %></td>
    									                                 <td width='30%' align="center"><%=vo.getMaxNumDisk()%></td>
    									                                 <td width='30%' align="center"><%=vo.getMaxNumLun() %></td>
								                                    </tr>
								                                   <% 
								                                   }
								                                   }
