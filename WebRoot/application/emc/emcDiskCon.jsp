...
$.ajax({
			type:"GET",
			dataType:"json",
			url:"<%=rootPath%>/performancePanelAjaxManager.ajax?action=emcDiskCon&ip=<%=host.getIpAddress()%>&flag="+flag+"&nodeid=<%=tmp%>",
			success:function(data){
				...
				<tr>
				 <td width="20%" height="26" align="left" nowrap  class=txtGlobal>&nbsp;<font color=black>设备标签:</font>
                         ...
                         <td width="20%" height="26" align=left valign=middle nowrap class=txtGlobal>&nbsp;<font color=black>IP地址:<%=host.getIpAddress()%></font>
												              ...
												              <td>
												                ...
												                <table cellspacing="0" cellpadding="0" width="width:100%" bgcolor="#FFFFFF" border=1  class="detail-data-body">
												                    <tr align="center" height=28 class="microsoftLook0">
												                         ...
												                         <th width='20%' align="center">序列号</th>
    									                                
    									                                 <th width='15%' align="center">版本号</th>
    									                                 <th width='15%' align="center">容量</th>
    									                                  <th width='15%' align="center">RAID组编号</th>
								                                    ...
								                                    <tr align="center" height=28 class="microsoftLook">
    									                                <th width='10%'  align="center"><%=h%></th>
    									                                 <th width='20%' align="center"><%=vo.getSerialNumber() %></th>
    									                           
    									                                 <th width='15%' align="center"><%=vo.getRevision() %></th>
    									                                 <th width='15%' align="center"><%=vo.getCapacity() %></th>
    									                                  <th width='15%' align="center"><%=vo.getRaidGroupID() %></th>
    									                                         <th width='25%' align="center"><%=vo.getRid() %></th>
								                                    </tr>
								                                   <% 
								                                   }
								                                   }
							...
							<td class="td-container-main-tool" width='15%' ><jsp:include page="/include/toolbar.jsp"><jsp:param value="<%=host.getIpAddress()%>" name="ipaddress"/>
