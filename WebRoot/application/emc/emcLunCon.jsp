...
<%@page import="com.afunms.emc.model.Lun"%>
...
$.ajax({
			type:"GET",
			dataType:"json",
			url:"<%=rootPath%>/performancePanelAjaxManager.ajax?action=emcLunCon&ip=<%=host.getIpAddress()%>&flag="+flag+"&nodeid=<%=tmp%>",
			success:function(data){
