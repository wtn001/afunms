...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/ipEncryption.do?action=add";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
				        									...
				        									<tr>
				        										<td>
																	...
																	<tr style="background-color: #ECECEC;">						
																		...
																		<TD nowrap width="40%">&nbsp;<input type="text" id="name" name="addzt" size="30" class="formStyle"><font color="red">&nbsp;*</font></TD>															
																	</tr>
																	<tr>
		    															<TD nowrap align="right" height="24">描述&nbsp;</TD>				
																		<TD nowrap  colspan="3">&nbsp;<textarea id="descr" name="descr" cols="100" rows="5" class="formStyle"></textarea></TD>
																	</tr> 	
																	<tr>
																		<TD nowrap align="right" height="24">备注&nbsp;</TD>				
																		<TD nowrap width="40%">&nbsp;<input type="text" name="bak" size="60" class="formStyle"></TD>	
																	</tr>	
