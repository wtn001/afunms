...
//		var roomid = document.getElementById("roomid");
  ...
  //   {
        ...
        //msg.style.display="block";
         mainForm.action = "<%=rootPath%>/ipEncryption.do?action=update&id=<%=vo.getId()%>";
         mainForm.submit();
//     }  
       // mainForm.submit();
 });	
			...
			<tr>
				...
				<td class="td-container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">IP管理 >> 配置管理 >> 纵向加密编辑</td>
					...
					<TBODY>
						...
						<tr >						
							<TD nowrap align="right" height="24" width="40%">纵向加密定义：&nbsp;</TD>				
							<TD nowrap width="50%">&nbsp;
								<input type="text" name="name" id="cabinetname" maxlength="50" size="20" class="formStyle" value="<%=vo.getName() %>" >
								</TD>						
						</tr>
						<tr >						
							<TD nowrap align="right" height="80" width="40%">纵向加密描述：&nbsp;</TD>				
							<TD nowrap width="50%">&nbsp;
							<textarea rows="3" cols="50" name="descr" value="<%=vo.getDescr() %>" lang="100">
							<%=vo.getDescr() %>
                            </textarea>
								</TD>						
						</tr>
						<tr >						
							...
							<TD nowrap width="100%">&nbsp;
                            <textarea rows="3" cols="50" name="bak" value="<%=vo.getBak() %>" lang="50" >
                            <%=vo.getBak() %>
                            </textarea>
								</TD>						
						</tr>
