			...
			<tr>
				...
				<td class="td-container-main">
					...
					<TBODY>
						...
						<tr >						
							<TD nowrap align="right" height="24" width="10%">骨干点定义：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="backbone_begin" id="cabinetname" maxlength="50" size="20" class="formStyle" >
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;到
														
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="backbone_end" id="unumbers" maxlength="50" size="20" class="formStyle">
						</tr>
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							<TD nowrap align="right" height="24" width="10%">loopback地址定义：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="loopback_begin" id="nodename" maxlength="50" size="20" class="formStyle">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;到
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="loopback_end" id="nodedescr" maxlength="50" size="20" class="formStyle">
								</TD>															
						</tr>
						<tr  id='community_tr'>				
							<TD nowrap align="right" height="24" width="10%">PE互联地址定义：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="pe_begin" id="contactname" maxlength="50" size="20" class="formStyle">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;到
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="pe_end" id="contactphone" maxlength="50" size="20" class="formStyle">
								</TD>															
						</tr>
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							<TD nowrap align="right" height="24" width="20%">PE-CE地址定义：&nbsp;</TD>				
							<TD nowrap width="30%" >&nbsp;
								<input type="text" name="pe_ce_begin" id="contactemail" maxlength="50" size="20" class="formStyle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; 到 
							</TD>			
							<TD nowrap width="30%" >&nbsp;
								<input type="text" name="pe_ce_end" id="businessName" maxlength="50" size="20" class="formStyle">
							</TD>																			
						</tr>
