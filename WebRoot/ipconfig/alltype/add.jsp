...
{  
 ...
 Ext.get("process").on("click",function(){
     var chk1 = checkinput("backbone_name","string","骨干点名称",50,false);
     var chk4 = checkinput("loopback_begin","string","loopback地址定义",15,false);
     var chk5 = checkinput("loopback_end","string","loopback地址定义",15,false);
     var chk6 = checkinput("pe_begin","string","PE互联地址定义",15,false);
     var chk7 = checkinput("pe_end","string","PE互联地址定义",15,false);
     var chk8 = checkinput("pe_ce_begin","string","PE_CE地址定义",15,false);
     var chk9 = checkinput("pe_ce_end","string","PE_CE互址定义",15,false);
     var chk10 = checkinput("bussiness_begin","string","业务地址定义",15,false);
     var chk11 = checkinput("bussiness_end","string","业务地址定义",15,false);
			...
			<tr>
				...
				<td class="td-container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">IP管理 >> 配置管理 >> IP定义</td>
					...
					<TBODY>
						...
						<tr >						
							<TD nowrap align="right" height="24" width="10%">骨干点名称：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="backbone_name" id="" maxlength="50" size="20" class="formStyle" ></TD>
						</tr>
						<!--  
						<tr >						
							<TD nowrap align="right" height="24" width="10%">所属平面：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
								<select name='select' class="formStyle" style='width:125px;'>
								    <option value=1>---请选择---</option>
								    <option value=2>一平面</option>
								    <option value=3>二平面</option>
								</select>
								</TD>
						</tr>
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							<TD nowrap align="right" height="24" width="10%">骨干点地址定义：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
						...
						-->
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							<TD nowrap align="right" height="24" width="10%">loopback地址定义：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
						...
						<tr  id='community_tr'>				
							<TD nowrap align="right" height="24" width="10%">PE互联地址定义：&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
						...
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							<TD nowrap align="right" height="24" width="20%">PE-CE地址定义：&nbsp;</TD>				
							<TD nowrap width="30%" >&nbsp;
								<input type="text" name="pe_ce_begin" id="pe_ce_begin" maxlength="50" size="20" class="formStyle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; 到 
							</TD>			
							<TD nowrap width="30%" >&nbsp;
						...
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							<TD nowrap align="right" height="24" width="20%">业务地址段定义：&nbsp;</TD>				
							<TD nowrap width="30%" >&nbsp;
								<input type="text" name="bussiness_begin" id="bussiness_begin" maxlength="50" size="20" class="formStyle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; 到 
							</TD>			
							<TD nowrap width="30%" >&nbsp;
