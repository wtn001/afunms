											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> IP管理 >> 配置管理 >> IP定义 >> loopback地址查看 </td>
													...
													<tr>
														<td>
															<table>
																<tr>
													    			<td align=right>
													    			  <a href="<%=rootPath%>/ipfield.do?action=createdoc1&id=1" >
														...
														<td>
															<table>
																<tr>
													    			...
													    			<td class="body-data-title">loopback地址</td>
							        							...
							        							<%
							        								if(list != null && list.size() > 0) {
							        									for(int i = 0; i < list.size(); i++){
																          ...
																          <%if(vo.getType() == 0){
																           %>
																            <td class="body-data-list" align="center"  ><%=vo.getLoopback()%></td>
																	    	<td class="body-data-list"  align="center">可用</td>
											        						   <%}else{ %>
											        						<td class="body-data-list" align="center" bgcolor="#c0c0c0" ><%=vo.getLoopback()%></td>
