											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> IP管理 >> IP分配 >> PE互联地址分配表 </td>
															...
															<table>
																<tr>
																	<td class="body-data-title" style="text-align: right;">
																	  <a href="<%=rootPath%>/ipfield.do?action=createdocPe" >
																	          ...
																	          <%
																	              ...
																	              if(field.size()!=0 && field != null){
																	                for(int j=0;j<field.size();j++){
																	                    f = (field)field.get(j);
																	                    pestorageDao lpd = new pestorageDao();
																	           //          System.out.println("@@@@@@@@@@@@@@@@@@"+"select * from ip_pe"+" where field_id = "+f.getId());
																	                    List loop = lpd.loadAll(" where field_id = "+f.getId());
																	           //          System.out.println("############"+loop.size());
																	                    lp = (pestorage)loop.get(0);
																	                    
																	           %>
																	           <tr>
																	               <td align="center" class="body-data-list" ><%=f.getName() %></td>
																	               <td align="center" class="body-data-list" ><%=lp.getBackbone1() %>/30</td>
																	               <td align="center" class="body-data-list" ><%=lp.getBackbone2() %>/30</td>
																	          </tr>
																	          <%
																	                }
																	                }
