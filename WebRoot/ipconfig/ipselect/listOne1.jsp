...
<%
	...
	System.out.println(loopback.size()+"----------------------------------------"+pe.size()+"----------------------------"+pe_ce.size());
%>
<%
...
<div>
       ...
       <%
        ...
        <td style="align:center" width="30%"> 
          ...
          <td style="align:center" width="30%"> 
             <p class="fl">
               <label><input name="routeCount" type="text" class="keywords" id="routeCount" maxlength="50" value="<%=loop.getGateway() %>" readonly  /> </label>
	         </p>
	      </td> 
	    </tr>
       <%
