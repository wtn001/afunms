 ...
 Ext.get("process").on("click",function(){
  	 //alert($('#collecttype').val()+'eee');
        ...
        //msg.style.display="block";
         mainForm.action = "<%=rootPath%>/ipfield.do?action=updateStation&id=<%=f.getId()%>";
         mainForm.submit();
				...
				<td class="td-container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">IP管理 >> IP查询 >> 修改场站</td>
					...
					<TBODY>
						...
						<tr>
							...
							<TD nowrap width="40%">&nbsp;<input type="text" name="name" size="40" value="<%=f.getName() %>" class="formStyle"><font color="red">&nbsp;*</font></TD>
							...
							<TD nowrap>
								 <select id="type" size=1 name='station' style='width:125px;' onchange="unionSelect();">
													 <option value=''>--请选择--</option>
																				...
																				%>
																			<option value=<%=vo.getId()%> <%if( (vo.getId()+"").equals(f.getRunning()) ){ %>selected<% }%>><%=vo.getName()%></option>
																			<%
																						}
																					}
																			%>
						...
						<tr>
							<td nowrap colspan="4" height="1" bgcolor="#8EADD5"></td>
															...
															<tr>
																...
																<br><input type="button" value="修改" style="width:100" id="process" onclick="#">&nbsp;&nbsp;
