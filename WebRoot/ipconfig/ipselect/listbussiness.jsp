											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> IP管理 >> IP分配 >> 业务地址分配表 </td>
																	          ...
																	          <%
																	              ...
																	              //System.out.println("------------------>"+field.size());
																	                for(int j=0;j<field.size();j++){
																	                    f = (field)field.get(j);
																	                    loopbackstorageDao lpd = new loopbackstorageDao();
																	              //      System.out.println("@@@@@@@@@@@@@@@@@@"+"select * from ip_field"+" where field_id = "+f.getId());
																	           ...
																	           %>
																	           <tr>
																	               <td align="center" class="body-data-list" ><a
																			             href="<%=rootPath%>/ipfield.do?action=bussinessOne&id=<%=f.getId() %>"><%=f.getName() %>
																		               </a></td>
																	               <td align="center" class="body-data-list" >
																		                <a
																			             href="<%=rootPath%>/ipfield.do?action=busBackbone&backbone_id=<%=all.getId()%>">查看
																		               </a>
																	               </td>
																	          </tr>
																	          <%
