																				...
																				<table id="content-header" class="content-header">
																					<tr>
																						<td class="content-title" align='center'
																							height="29" style="text-align: center;"><b>设备快照</b>
																						</td>
																					<tr>
																				</table>
																			</td>
																				...
																				<table width="100%">
																					...
																					<tr>
																						<td align="center"><img
																							...
																							<br> <a href="#"
																							onClick="showTree('<%=midpath%>');">中间件(<%=midsize%>)
																						</a></td>
																						<td align="center"><img
																							...
																							<a href="#"
																							onClick="showTree('<%=servicepath%>');">服务(<%=servicesize%>)
																						</a></td>
																						<td align="center"><img
												...
												<tr>
													<td>
														...
														<table>
															<tr>
																<%
																sdf	qweqweqweqweqwqweqwe}//是否换新航结束
																																														}
																%>
																<%
																	//第二块显示开始
