...
<html>
	<head>
		...
		<link href="<%=rootPath%>/tool/webTelnet/telnetStyle.css" rel="stylesheet" type="text/css">
		<script type="text/javascript" src="<%=rootPath%>/tool/webTelnet/jquery-1.8.2.min.js"></script>
