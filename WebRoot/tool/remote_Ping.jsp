...
.body{
background-image: url(<%=rootPath%>/resource/image/bg4.jpg);
TEXT-ALIGN: center; 
}
...
<script language="javascript" src="<%=rootPath%>/js/tool.js"/>
             						...
             						<td>
              							<table id="win-content-header" class="win-content-header">
				              				<tr>
				                				...
				                				<td class="win-content-title">&nbsp;SNMP RemotePing &gt;&gt;&nbsp;</td>
						       					...
						       					<td>
													<table bgcolor="#ECECEC">
														<tr align="left" > 
															...
															<td height="28" align="left"><input type="button" value="测 试" id="sub"/></td>
														 </tr>
													</table>
								       			</td>
											</tr>
...
$("#sub").click(function(){
			...
			var remoteIpAddress = $('#serveripinput').val();
