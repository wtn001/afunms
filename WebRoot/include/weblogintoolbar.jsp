								...
								<td>
									<table class="tool-bar-body-list">
										<tr>
											<td>
												<ul>
													<li><img src="<%=rootPath%>/resource/image/toolbar/ping.gif">&nbsp;<a href="javascript:void(null)" onClick='window.open("<%=rootPath%>/weblogin.do?action=isOK&id=<%=id%>","oneping", "height=200, width= 500, top=300, left=100")'>可用性检测</a></li>
										...
										<tr>
											<td>
												<ul>
													...
													<a href="javascript:void(null)" onClick='window.open("<%=rootPath%>/nodeGatherIndicators.do?action=list&nodeid=<%=nodeid%>&type=service&subtype=weblogin","oneping", "height=600, width= 1000, top=300, left=100,scrollbars=yes")'>性能监视项配置</a></li>
													<li><img src="<%=rootPath%>/resource/image/toolbar/jszbfzpz.gif">&nbsp;
													<a href="javascript:void(null)" onClick='window.open("<%=rootPath%>/alarmIndicatorsNode.do?action=list&nodeid=<%=nodeid%>&type=service&subtype=weblogin","oneping", "height=600, width= 1000, top=300, left=100,scrollbars=yes")'>指标阀值配置</a></li>
												</ul>
											</td>
										</tr>
									</table>
