...
Ext.onReady(function()
		...
		setTimeout(function(){
		  ...
		  mainForm.action = "<%=rootPath%>/apache.do?action=sychronizeData&id=<%=id%>&flag=<%=flag%>";
		  mainForm.submit();
		 });    
		});
</script>
									...
									<ul>
										<li>
											...
											<a href="javascript:void(null)"
												onClick='window.open("<%=rootPath%>/apache.do?action=isOK&id=<%=id%>","oneping", "height=200, width= 500, top=300, left=100")'>可用性检测</a>
										</li>
										<li>
											<img
								...
								<td>
									<ul>
										<li>
											...
											&nbsp;
											<a href="#"
												onclick='window.open("<%=rootPath%>/apache.do?action=showPingReport&ipaddress=<%=ipaddress%>&id=<%=id%>" ,"portScanWindow","width=900,height=450,left=120,top=100 ,scrollbars=yes,resizable=yes")'>可用性报表</a>
										</li>
										<li>
											<img src="<%=rootPath%>/resource/image/menu/ywbb.gif">
											&nbsp;
											<a href="#"
												onclick='window.open("<%=rootPath%>/apache.do?action=allReport&ipaddress=<%=ipaddress%>&id=<%=id%>","portScanWindow","width=900,height=450,left=120,top=100 ,scrollbars=yes,resizable=yes")'>综合报表</a>
										</li>
										<li>
											<img src="<%=rootPath%>/resource/image/menu/ywbb.gif">
											&nbsp;
											<a href="#"
												onclick='window.open("<%=rootPath%>/apache.do?action=eventReport&ipaddress=<%=ipaddress%>&id=<%=id%>","portScanWindow","width=900,height=450,left=120,top=100,scrollbars=yes,resizable=yes")'>事件报表</a>
										</li>
									</ul>
								</td>
							</tr>
