								...
								<td>
									<table class="tool-bar-body-list">
										<tr>
											<td>
												<ul>
													<li><img src="<%=rootPath%>/resource/image/menu/ywbb.gif">&nbsp;<a href="#" onClick='window.open("<%=rootPath%>/tomcat.do?action=showPingReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>","onetelnet", "height=0, width= 0, top=0, left= 0")'>可用性报表</a></li>
													<li><img src="<%=rootPath%>/resource/image/menu/ywbb.gif">&nbsp;<a href="#" onClick='window.open("<%=rootPath%>/tomcat.do?action=configReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>","onetelnet", "height=500, width= 700, top=300, left= 100")'>配置报表</a></li>
													<li><img src="<%=rootPath%>/resource/image/menu/ywbb.gif">&nbsp;<a href="#" onClick='window.open("<%=rootPath%>/tomcat.do?action=perReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>","oneping", "height=600, width= 800, top=300, left=100")'>性能报表</a></li>
													<li><img src="<%=rootPath%>/resource/image/menu/ywbb.gif">&nbsp;<a href="#" onClick='window.open("<%=rootPath%>/tomcat.do?action=allReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>","oneping", "height=700, width= 900, top=300, left=100")'>综合报表</a></li>
													<li><img src="<%=rootPath%>/resource/image/menu/ywbb.gif">&nbsp;<a href="#" onClick='window.open("<%=rootPath%>/tomcat.do?action=eventReport&ipaddress=<%=ipaddress%>&id=<%=nodeid%>","oneping", "height=500, width= 800, top=300, left=100")'>事件报表</a></li>
												</ul>
											</td>
										</tr>
									</table>
