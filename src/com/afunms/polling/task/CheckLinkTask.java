...
//									if (flag == 1)break;
						...
						if(!flags)start_oututilhdx="0";
						flags=isNumberic(end_inutilhdx);
						if(!flags)end_inutilhdx="0";
						flags=isNumberic(start_inutilhdx);
						if(!flags)start_inutilhdx="0";
						flags=isNumberic(end_oututilhdx);
						if(!flags)end_oututilhdx="0";
						...
						if(!flags)start_inutilhdxperc="0";
						flags=isNumberic(end_oututilhdxperc);
						if(!flags)end_oututilhdxperc="0";
						try {
...
//						System.out.println("starOper----->"+starOper);
						...
						String content = "链路" + lr.getStartIp() + ":" + startif + "_"
								+ lr.getEndIp() + ":" + endif;
						String target = "";
						String alarmMessage = "";
