...
public class DateE extends DateInformation {
	...
	public Calendar getFirstDayOfWeek() {
		Calendar first = new GregorianCalendar(calendar.get(Calendar.YEAR),
	...
	/*
	 * 得到本月第一天的字符串可继承。public String getFirstDayOfMonth() public String
	 * getFirstDayOfMonth() { SimpleDateFormat theDate = new
	 * SimpleDateFormat("yyyy-MM-01"); String dateString =
	 * theDate.format(calendar.getTime()); return dateString; }
	 */

	public String getLastOfMonth() {// 得到本月最后一天字符串。
		Calendar temp = new GregorianCalendar(calendar.get(Calendar.YEAR),
				calendar.get(Calendar.MONTH),
				calendar.get(Calendar.DAY_OF_MONTH));
	...
	public String[] getDaysOfMonth() {
		int count = getIntervalInOneMonth(calendar.get(Calendar.YEAR),
	...
	public int getDaysCount() {
		return getIntervalInOneMonth(calendar.get(Calendar.YEAR),
				calendar.get(Calendar.MONTH) + 1);
	}
