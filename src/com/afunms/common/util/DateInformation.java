...
/**
 * detail:日期类 创建日期：(2003-3-27 15:30:41)
 * 
 * @author:zhoulf
 */
...
public class DateInformation {
	...
	public DateInformation() {
		//根据指定时区获得Calender抽象类的实例
		calendar = Calendar.getInstance(TimeZone.getTimeZone("GMT+8"));
		//创建tralTime对象，以表示分配它的时间（精确到毫秒）
		Date trialTime = new Date();
		//根据指定的Date对象设置此calendar的时间
		calendar.setTime(trialTime);
	}

	/**
	 * 判断现在时间是上午还是下午的方法
	 * @return 返回0表示上午，1表示下午
	 */
	public int getAMPM() {
	...
	/**
	 * 得到本月第一天。。 创建日期：(2003-12-2 13:47:15)
	 * 
	...
	/**
	 * 根据传入的偏移量算出与当前日期偏差的日期 创建日期：(2003-8-8 15:25:34)
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * 计算当前时间所在月有多少天。 创建日期：(2003-12-2 15:53:08)
	 * 
	 * @return int
	 * @param param
	 *            java.lang.String
	...
	/**
	 * 得到本月最后一天。 创建日期：(2003-12-2 13:50:12)
	 * 
	 * @return java.lang.String
	 * @param Interval
	 *            int
	...
	public static void main(String args[]) {
		...
		/*
		 * p("dateofweek: " + db.getDayOfWeek()); p("date: " +
		 * db.getDayOfMonth()); p("year: " + db.getYear()); p("month: " +
		 * db.getMonth());
		 * 
		 * p("date: " + db.getDate()); p("Day: " + db.getDay()); p("DayOfYear: "
		 * + db.getDayOfYear()); p("WeekOfYear: " + db.getWeekOfYear());
		 * p("era: " + db.getEra()); p("ampm: " + db.getAMPM()); p("DST: " +
		 * db.getDSTOffset()); p(db.getIntervalDate(- db.getDayOfWeek()));
		 * p(db.getIntervalDate(- db.getDayOfWeek()+7));
		 * 
		 * p(db.getFirstDayOfMonth()); p(Integer.toString(db.getDayOfMonth()));
		 * p(Integer.toString(db.getIntervalInOneMonth()));
		 * p(Integer.toString(db.getYear())); p(db.getCurrentTime());
		 */
		p("time: " + db.getTime());
	...
	/**
	 * 取得当前时间。 创建日期：(2003-12-30 14:58:43)
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * 此处插入方法描述。 创建日期：(2004-1-8 19:02:56)
	 * 
	 * @return java.lang.String
	...
	/**
	 * 计算与当前时间的偏移时间。 创建日期：(2003-12-30 14:45:13)
	 * 
	 * @return java.lang.String
	 * @param starttime
	 *            int
	...
	/**
	 * 根据传入的日期计算出本周的所有天的日期 创建日期：(2004-2-10 10:10:34)
	 * 
	 * @return java.lang.String[] 本周的所有天的日期
	 * @param param
	 *            java.lang.String 传入的日期
	 */
	public String[] getAllDayOfWeek(String date) {
		...
		for (int i = 0; i < 7; i++) {
			...
			weeks[i] = (cal.getTime().getYear() + 1900) + "-"
	...
	/**
	 * 根据传入的日期计算出本周的最后一天的日期 创建日期：(2003-12-2 13:47:15)
	 * 
	...
	/**
	 * 根据传入的日期计算出本周的第一天的日期 创建日期：(2003-12-2 13:47:15)
	 * 
	...
	/**
	 * 根据传入的年月算出某年的某月共有多少天。 创建日期：(2003-12-2 15:53:08)
	 * 
	 * @return int
	 * @param param
	 *            java.lang.String
	...
	public int getIntervalInOneMonth(int year, int month) {
		...
		/*
		 * Calendar cal1 = new GregorianCalendar(); cal1.setTime(new
		 * Date(year-1900,month-1,0)); cal1.add(cal1.DATE,1);
		 * System.out.println(cal1.getTime());
		 */
		Calendar cal = new GregorianCalendar();
	...
	public String getLastDayOfMonth(String year, String month) {
		...
		// returnVal =
		// date.substring(0,date.lastIndexOf("-")+1)+String.valueOf(i);
