...
public class StorageEMCManager extends BaseManager implements ManagerInterface{
	...
	public String execute(String action) {
		...
		if("system".equals(action)){
			...
			return raidGroup();
		}else if("hardware".equals(action)){
			return hardware();
		}else if("diskCon".equals(action)){
			return diskCon();
		}else if("lunCon".equals(action)){
			return lunCon();
		}else if(action.equals("diskPer")){
			return diskPer();
		}else if(action.equals("lunPer")){
			return lunPer();
		}else if(action.equals("environment")){
			return environment();
		}else if(action.equals("event")){
			return event();
		}else if(action.equals("eventdelete")){
			return eventdelete();
...
//				}
	...
	public String system(){
		...
		try {
		    ...
		    if(ipAllData != null){
		    	agent = (Agent) ipAllData.get("system");
		    }else{
		...
		request.setAttribute("id", tmp);
		request.setAttribute("manager", manager);
		request.setAttribute("system", agent);
	    return "/application/emc/emcSystem.jsp";
	}
...
//		    ipAllData = null;
		    if(ipAllData != null){
		    	raid = (List<RaidGroup>) ipAllData.get("raid");
		    }else{
		    	raidDao dao = new raidDao();
		    	try{
		    		raid = (List<RaidGroup>)dao.query(tmp);
		    	}catch(Exception e){
		    		e.printStackTrace();
		    	}finally{
		    		dao.close();
	    ...
	    return "/application/emc/emcRaid.jsp";
	}
...
//		    ipAllData = null;
//		    if(ipAllData != null){
//		    	hardware = (List) ipAllData.get("hardwarestatus");
//		    }else{
//		    	hardware = new Crus();
//		    	Crus c = new Crus();
		    	hardDao dao = new hardDao();
		    	try{
		    		list = dao.queryList(tmp);
		    	}catch(Exception e){
		    		e.printStackTrace();
		    	}finally{
		    		dao.close();
...
//		    }
		...
		request.setAttribute("list", list);
	    return "/application/emc/emcHard.jsp";
	}
	
	public String diskCon(){
		Hashtable returnHash=new Hashtable();
		Vector vector = new Vector();
		Vector vector1 = new Vector();
		List list = new ArrayList();
...
//		    ipAllData = null;
		    if(ipAllData != null){
		    	disklist = (List<Disk>) ipAllData.get("disk");
		    }else{
		    	diskConDao dao = new diskConDao();
		    	try{
		    		disklist = dao.query(tmp);
		    	}catch(Exception e){
		    		e.printStackTrace();
		    	}finally{
		    		dao.close();
		...
		request.setAttribute("id", tmp);
		request.setAttribute("manager", manager);
		request.setAttribute("disk", disklist);
	    return "/application/emc/emcDiskCon.jsp";
	}
	
	
	public String lunCon(){
		Hashtable returnHash=new Hashtable();
		Vector vector = new Vector();
		Vector vector1 = new Vector();
		List list = new ArrayList();
		...
		try {
		    ...
		    ipAllData = (Hashtable) ShareData.getEmcdata().get(ip);
//		    System.out.println(ipAllData.containsKey("lunconfig")+"########################"+ipAllData);
//		    ipAllData = null;
		    if(ipAllData != null){
		    	raid = (List<Lun>) ipAllData.get("lunconfig");
		    }else{
		...
		request.setAttribute("id", tmp);
		request.setAttribute("manager", manager);
		request.setAttribute("lun", raid);
	    return "/application/emc/emcLunCon.jsp";
	}
	...
	public String diskPer(){
		...
		try {
		    ...
		    ipAllData = (Hashtable) ShareData.getEmcdata().get(ip);
		    System.out.println(ipAllData.containsKey("disk")+"########################");
		    if(ipAllData != null){
		    	disklist = (List<Disk>) ipAllData.get("disk");
		    }
		}
		...
		request.setAttribute("manager", manager);
		request.setAttribute("disk", disklist);
	    return "/application/emc/emcDiskPer.jsp";
	}
	
	
	
	public String lunPer(){
		Hashtable returnHash=new Hashtable();
		Vector vector = new Vector();
		Vector vector1 = new Vector();
		List list = new ArrayList();
		...
		try {
		    ...
		    ipAllData = (Hashtable) ShareData.getEmcdata().get(ip);
		    System.out.println(ipAllData.containsKey("lunconfig")+"########################");
		    if(ipAllData != null){
		    	raid = (List<Lun>) ipAllData.get("lunconfig");
		    }
		}
		...
		request.setAttribute("manager", manager);
		request.setAttribute("lun", raid);
	    return "/application/emc/emcLunPer.jsp";
	}
	...
	public String environment(){
		...
		try {
		    ...
		    ipAllData = (Hashtable) ShareData.getEmcdata().get(ip);
		    System.out.println(ipAllData.containsKey("environment")+"########################");
		    if(ipAllData != null){
		    	environment = (Environment) ipAllData.get("environment");
		    }
		}
		catch (Exception e) {
			e.printStackTrace();
	    ...
	    return "/application/emc/emcEnvironment.jsp";
	}
...
//    	System.out.println("--sql------------------select * from system_eventlist  where nodeid = "+host.getId()+" and recordtime = '"+t_time+"'" );
    	List list = el.loadAll(" where nodeid = "+host.getId()+" and recordtime  <'"+t_time+" 23:59:00' and recordtime > '"+t_time+" 00:00:00'");
//    	SysLogger.info(host.getIpAddress()+"======"+host.getCategory());
    	request.setAttribute("list", list);
    	request.setAttribute("startdate", b_time);
		request.setAttribute("todate", t_time);
	    return "/application/emc/emcEvent.jsp";
	}
