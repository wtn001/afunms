...
//						}
						...
						pinghash = hostmanager.getCategory(id, "SQLPing", "ConnectUtilization",
							starttime, totime);
					} else if (typevo.getDbtype().equalsIgnoreCase("db2")) {
						pinghash = hostmanager.getCategory(id, "DB2Ping", "ConnectUtilization",
							starttime, totime);
					} else if (typevo.getDbtype().equalsIgnoreCase("sybase")) {
						pinghash = hostmanager.getCategory(id, "SYSPing", "ConnectUtilization",
							starttime, totime);
					} else if (typevo.getDbtype().equalsIgnoreCase("informix")) {
						pinghash = hostmanager.getCategory(id, "INFORMIXPing", "ConnectUtilization",
							starttime, totime);
					} else if (typevo.getDbtype().equalsIgnoreCase("mysql")) {// HONGLI
						pinghash = hostmanager.getCategory(id, "MYPing", "ConnectUtilization",
							starttime, totime);
					}
				} catch (Exception e) {
					SysLogger.error("", e);
	...
	private String downloadoraselfreport() {
		...
		try {
			...
			// }
			// ====end
			Hashtable pinghash = hostmanager.getCategory( sid, "ORAPing", "ConnectUtilization", starttime,
				totime);
			// Hashtable ConnectUtilizationhash =
			// hostmanager.getCategory(ip,"Ping","ConnectUtilization",starttime,totime);
			p_draw_line(pinghash, "", newip + "ConnectUtilization", 740, 120);
	...
	private String downloaddb2selfreport() {
		...
		try {
			...
			String remoteip = request.getRemoteAddr();
			String newip = doip(ip);
			Hashtable pinghash = hostmanager.getCategory(vo.getId()+"", "DB2Ping", "ConnectUtilization", starttime, totime);
			// Hashtable ConnectUtilizationhash =
			// hostmanager.getCategory(ip,"Ping","ConnectUtilization",starttime,totime);
			p_draw_line(pinghash, "", newip + "ConnectUtilization", 740, 120);
			String pingconavg = "";
	...
	private String downloadsqlselfreport() {
		...
		try {
			...
			String remoteip = request.getRemoteAddr();
			String newip = doip(ip);
			Hashtable pinghash = hostmanager.getCategory(vo.getId()+"", "SQLPing", "ConnectUtilization", starttime, totime);
			p_draw_line(pinghash, "", newip + "ConnectUtilization", 740, 120);
			String pingconavg = "";
			if (pinghash.get("avgpingcon") != null)
				pingconavg = (String) pinghash.get("avgpingcon");
	...
	private String downloadsybaseselfreport() {
		...
		try {
			...
			String remoteip = request.getRemoteAddr();
			String newip = doip(ip);
			Hashtable pinghash = hostmanager.getCategory(vo.getId()+"", "SYSPing", "ConnectUtilization", starttime, totime);
			// Hashtable ConnectUtilizationhash =
			// hostmanager.getCategory(ip,"Ping","ConnectUtilization",starttime,totime);
			p_draw_line(pinghash, "", newip + "ConnectUtilization", 740, 120);
			String pingconavg = "";
	...
	public String downloadmysqlselfreport() {
		...
		try {
			...
			I_HostCollectData hostmanager = new HostCollectDataManager();
			try {
				ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "MYPing", "ConnectUtilization",
					starttime, totime);
			} catch (Exception ex) {
				ex.printStackTrace();
			}
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					Hashtable ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "ORAPing", "ConnectUtilization",
						starttime, totime);
					String pingconavg = "";
					if (ConnectUtilizationhash.get("avgpingcon") != null)
						pingconavg = (String) ConnectUtilizationhash.get("avgpingcon");
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					Hashtable ConnectUtilizationhash = hostmanager.getCategory(sid, "ORAPing",
						"ConnectUtilization", starttime, totime);
					// String pingconavg ="";
					if (ConnectUtilizationhash.get("avgpingcon") != null) {
						pingconavg = (String) ConnectUtilizationhash.get("avgpingcon");
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					Hashtable ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "DB2Ping", "ConnectUtilization",
						starttime, totime);
					String pingconavg = "";
					if (ConnectUtilizationhash.get("avgpingcon") != null)
						pingconavg = (String) ConnectUtilizationhash.get("avgpingcon");
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					Hashtable ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "SQLPing", "ConnectUtilization",
						starttime, totime);
					String pingconavg = "";
					if (ConnectUtilizationhash.get("avgpingcon") != null)
						pingconavg = (String) ConnectUtilizationhash.get("avgpingcon");
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					I_HostCollectData hostmanager = new HostCollectDataManager();
					try {
						ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "SQLPing",
							"ConnectUtilization", starttime, totime);
					} catch (Exception ex) {
						ex.printStackTrace();
					}
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					Hashtable ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "SYSPing", "ConnectUtilization",
						starttime, totime);
					String pingconavg = "";
					if (ConnectUtilizationhash.get("avgpingcon") != null)
						pingconavg = (String) ConnectUtilizationhash.get("avgpingcon");
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					I_HostCollectData hostmanager = new HostCollectDataManager();
					try {
						ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "SYSPing",
							"ConnectUtilization", starttime, totime);
					} catch (Exception ex) {
						ex.printStackTrace();
					}
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					I_HostCollectData hostmanager = new HostCollectDataManager();
					try {
						ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "INFORMIXPing",
							"ConnectUtilization", starttime, totime);
					} catch (Exception ex) {
						ex.printStackTrace();
					}
		...
		try {
			...
			if (ids != null && ids.length > 0) {
				for (int i = 0; i < ids.length; i++) {
					...
					I_HostCollectData hostmanager = new HostCollectDataManager();
					try {
						ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "MYPing",
							"ConnectUtilization", starttime, totime);
					} catch (Exception ex) {
						ex.printStackTrace();
					}
	...
	private String downloadinforselfreport() {
		...
		try {
			...
			Hashtable pinghash = hostmanager.getCategory(vo.getId()+"", "INFORMIXPing", "ConnectUtilization", starttime, totime);
			// Hashtable ConnectUtilizationhash =
			// hostmanager.getCategory(ip,"Ping","ConnectUtilization",starttime,totime);
			p_draw_line(pinghash, "", newip + "ConnectUtilization", 740, 120);
			String pingconavg = "";
	...
	public String createSServerPingReport() {
		...
		try {
			...
			I_HostCollectData hostmanager = new HostCollectDataManager();
			try {
				ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "SQLPing", "ConnectUtilization",
					starttime, totime);
			} catch (Exception ex) {
				ex.printStackTrace();
			}
	...
	public String createDB2PingReport() {
		...
		try {
			...
			I_HostCollectData hostmanager = new HostCollectDataManager();
			try {
				ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "DB2Ping", "ConnectUtilization",
					starttime, totime);
			} catch (Exception ex) {
				ex.printStackTrace();
			}
	...
	public String createSybasePingReport() {
		...
		try {
			...
			I_HostCollectData hostmanager = new HostCollectDataManager();
			try {
				ConnectUtilizationhash = hostmanager.getCategory(vo.getId()+"", "SYSPing", "ConnectUtilization",
					starttime, totime);
			} catch (Exception ex) {
				ex.printStackTrace();
			}
